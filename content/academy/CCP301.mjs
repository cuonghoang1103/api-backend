/**
 * CCP301 — Luật cạnh tranh và bảo vệ quyền lợi người tiêu dùng.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — khối Công nghệ Truyền thông, semester 7. Lessons are not written yet.|||Môn trong khung chương trình FPTU — khối Công nghệ Truyền thông, kỳ 7. Bài giảng chưa được dựng.',
    description: 'Môn <strong>CCP301 — Luật cạnh tranh và bảo vệ quyền lợi người tiêu dùng</strong> thuộc khung chương trình khối Công nghệ Truyền thông, kỳ 7.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
