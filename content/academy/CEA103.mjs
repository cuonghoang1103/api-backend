/**
 * CEA103 — Computer Organization and Architecture.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Khoa học Máy tính, semester 1. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Khoa học Máy tính, kỳ 1. Bài giảng chưa được dựng.',
    description: 'Môn <strong>CEA103 — Computer Organization and Architecture</strong> thuộc khung chương trình ngành Khoa học Máy tính, kỳ 1.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
