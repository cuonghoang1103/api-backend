/**
 * CME501 — Microeconomics (taught in Chinese).
...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>CME501 — Microeconomics (taught in Chinese)</strong> thuộc khung chương trình ngành Ngôn ngữ Trung, kỳ 7.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
