/**
 * CSB201 — Celebrity, Social Media Influencers and Brand Performance.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — khối Công nghệ Truyền thông, semester 4. Lessons are not written yet.|||Môn trong khung chương trình FPTU — khối Công nghệ Truyền thông, kỳ 4. Bài giảng chưa được dựng.',
    description: 'Môn <strong>CSB201 — Celebrity, Social Media Influencers and Brand Performance</strong> thuộc khung chương trình khối Công nghệ Truyền thông, kỳ 4.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
    whatYouLearn: 'Chưa có nội dung. Xem giáo trình chính thức trên FLM (flm.fpt.edu.vn) để biết chuẩn đầu ra của môn.',
    requirements: 'Xem điều kiện tiên quyết trong khung chương trình khối Công nghệ Truyền thông trên FLM.',
  },
  sections: [],
};
