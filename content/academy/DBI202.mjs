...
<table>
  <thead><tr><th>Component</th><th>Type</th><th>Parts</th><th>Weight</th><th>Completion</th><th>Duration</th><th>Question type</th></tr></thead>
  <tbody>
    <tr><td>Assignment</td><td>on-going</td><td>1</td><td>20%</td><td>&gt; 0</td><td>28 slots</td><td>&mdash;</td></tr>
    <tr><td>Lab</td><td>on-going</td><td>5</td><td>10%</td><td>&gt; 0</td><td>90&#39;/each</td><td>&mdash;</td></tr>
    <tr><td>Practical Exam</td><td>on-going</td><td>1</td><td>30%</td><td>&gt; 0</td><td><strong>85&#39;</strong></td><td>&mdash;</td></tr>
    <tr><td>Progress test</td><td>on-going</td><td>2</td><td>10%</td><td>&gt; 0</td><td>30&#39;/each</td><td><strong>Multiple choice, marked by computer</strong></td></tr>
    <tr><td>Final exam</td><td>final exam</td><td>1</td><td>30%</td><td><strong>&ge; 4</strong></td><td><strong>60&#39;</strong></td><td>not stated</td></tr>
  </tbody>
</table>
<p><strong>The syllabus gives a question type only for the Progress Tests</strong> (&ldquo;Multiple choices; Marked by Computer&hellip;&rdquo;, the cell itself is truncated in the official export). It publishes no question count for anything, and says nothing about the final exam's format.</p>
<div class="callout warn">Three gates, not two. (1) Attend ≥ 80% of slots to be allowed to sit the final. (2) <strong>All four on-going components have completion criterion &gt; 0</strong> &mdash; a zero on the Assignment, on any Lab, on the Practical Exam or on a Progress Test fails the subject by itself. (3) Final exam ≥ <strong>4.0</strong> and weighted average ≥ <strong>5.0</strong>. Note where the marks are: <strong>60% of the grade (Assignment + Labs + PE) is you writing SQL</strong>. Memorising syntax is not enough — you must query fluently. The labs and the SQL practice track are your rehearsal; lesson 9.1 is the PE playbook.</div>
</div>
<div class="ml-vi">
...
<table>
  <thead><tr><th>Thành phần</th><th>Loại</th><th>Số phần</th><th>Trọng số</th><th>Điều kiện hoàn thành</th><th>Thời lượng</th><th>Dạng câu hỏi</th></tr></thead>
  <tbody>
    <tr><td>Assignment</td><td>on-going</td><td>1</td><td>20%</td><td>&gt; 0</td><td>28 slot</td><td>&mdash;</td></tr>
    <tr><td>Lab</td><td>on-going</td><td>5</td><td>10%</td><td>&gt; 0</td><td>90&#39;/bài</td><td>&mdash;</td></tr>
    <tr><td>Thi thực hành (PE)</td><td>on-going</td><td>1</td><td>30%</td><td>&gt; 0</td><td><strong>85&#39;</strong></td><td>&mdash;</td></tr>
    <tr><td>Progress test</td><td>on-going</td><td>2</td><td>10%</td><td>&gt; 0</td><td>30&#39;/bài</td><td><strong>Trắc nghiệm, máy chấm</strong></td></tr>
    <tr><td>Thi cuối kỳ</td><td>final exam</td><td>1</td><td>30%</td><td><strong>&ge; 4</strong></td><td><strong>60&#39;</strong></td><td>không nêu</td></tr>
  </tbody>
</table>
<p><strong>Syllabus chỉ nêu dạng câu hỏi cho Progress Test</strong> (&ldquo;Multiple choices; Marked by Computer&hellip;&rdquo;, chính ô này bị cắt trong bản xuất chính thức). Nó không công bố số câu cho bất kỳ cột nào, và không nói gì về format bài thi cuối kỳ.</p>
<div class="callout warn">Ba cửa, không phải hai. (1) Dự ≥ 80% số slot mới được thi cuối kỳ. (2) <strong>Cả bốn thành phần quá trình đều có điều kiện hoàn thành &gt; 0</strong> — một điểm 0 ở Assignment, ở một bài Lab, ở PE hay một Progress Test là tự nó đánh trượt môn. (3) Thi cuối ≥ <strong>4,0</strong> và trung bình có trọng số ≥ <strong>5,0</strong>. Để ý điểm nằm ở đâu: <strong>60% điểm môn (Assignment + Lab + PE) là bạn viết SQL</strong>. Thuộc cú pháp là chưa đủ — phải truy vấn thành thạo. Các lab và track luyện SQL là buổi diễn tập; bài 9.1 là giáo án luyện PE.</div>
</div>
`,
        },
        {
...
<p class="lead">DBI202 lists 30 constructive questions across its seven CLOs. The syllabus does <em>not</em> say the assessments are drawn from them &mdash; the Progress Tests are described only as computer-marked multiple choice &mdash; but they are the clearest published statement of what you are expected to be able to explain, which makes them the best revision checklist available. A full-mark answer is short, uses the correct term, and gives an example.</p>
...
<p class="lead">DBI202 liệt kê 30 câu hỏi kiến tạo trải trên bảy CLO. Syllabus <em>không</em> nói các bài đánh giá rút ra từ đó — Progress Test chỉ được mô tả là trắc nghiệm máy chấm — nhưng đây là phát biểu rõ nhất được công bố về những gì bạn phải giải thích được, nên nó là bản danh sách ôn tập tốt nhất bạn có. Câu trả lời trọn điểm thì ngắn, dùng đúng thuật ngữ, và có một ví dụ.</p>
...
`,
    ...
    /* END-SECTIONS-MARKER */
    {
      ...
      "description": "Hai cột nặng nhất, 30% mỗi cột: PE (thi thực hành SQL, 85 phút, điều kiện >0) và FE (thi cuối kỳ, 60 phút, phải đạt ≥4/10). Syllabus chỉ nêu dạng trắc nghiệm cho Progress Test, KHÔNG cho FE — hai bài dưới phân biệt rõ số liệu chính thức với phần suy ra.",
      "lessons": [
        {
          "title": "PE — Practical Exam (85 min, 30%)|||PE — Thi thực hành (85 phút, 30%)",
          "slug": "dbi202-final-exam-pe",
          "type": "article",
          "description": "Số liệu thật của syllabus cho PE: 85 phút, 30%, điều kiện >0. Đề gồm những gì, cách xoay 85 phút, và trỏ sang giáo án đầy đủ ở bài 9.1.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Assessment · PE</span>\n<h2>PE — Practical Exam (85 minutes, 30% of the subject)</h2>\n<p class=\"lead\">The syllabus's own numbers: the DBI202 Practical Exam is an <strong>on-going</strong> assessment, <strong>1 part</strong>, <strong>85 minutes</strong>, worth <strong>30%</strong>, completion criterion <strong>&gt; 0</strong> &mdash; a zero on it fails the subject by itself. It is the single heaviest component, tied with the final exam, and it is the only one that tests whether you can actually write SQL.</p>\n<div class=\"callout warn\"><span class=\"badge\">What the syllabus does not publish</span> No problem bank, no marking scheme, no list of permitted resources. Take those from your lecturer. Everything below comes from the course content and from the one tool the syllabus names: <strong>Microsoft SQL Server</strong>.</div>\n<h3>Where to prepare properly</h3>\n<p>This course already has a full PE playbook &mdash; <strong>lesson 9.1</strong>, with the ten query patterns that cover almost every practical task, in the order to attempt them. Work through that lesson rather than this page; this one only states the official numbers and the shape of the exam.</p>\n<h3>What 85 minutes of SQL usually contains</h3>\n<table>\n<thead><tr><th>Task</th><th>Lesson</th><th>Note</th></tr></thead>\n<tbody>\n<tr><td>Create tables from a given schema, with keys and constraints</td><td>5.1, 5.2, 5.3</td><td>named constraints, correct data types, FK order matters</td></tr>\n<tr><td>Insert sample rows, then UPDATE / DELETE under a condition</td><td>6.5</td><td>quick marks &mdash; do them early</td></tr>\n<tr><td>Multi-table SELECT with joins, filtering and ORDER BY</td><td>6.1, 6.2</td><td>the bulk of the paper</td></tr>\n<tr><td>GROUP BY with HAVING, and a nested query</td><td>6.3, 6.4</td><td>where marks are usually lost &mdash; WHERE filters rows, HAVING filters groups</td></tr>\n<tr><td>A view, a stored procedure or a function; sometimes a trigger or cursor</td><td>7.2, 7.3, 7.4</td><td>the last task; a trigger that rejects bad data with ROLLBACK is a classic</td></tr>\n</tbody>\n</table>\n<h3>How to work the 85 minutes</h3>\n<ul>\n<li><b>Read the whole paper first</b> and create the schema before anything else &mdash; every later query depends on it existing and holding rows.</li>\n<li><b>Run every statement as you write it.</b> SQL fails loudly; an untested query at the end is a query you will not have time to fix.</li>\n<li><b>Bank the easy marks in order:</b> DDL &rarr; inserts &rarr; simple SELECT &rarr; joins &rarr; aggregation &rarr; programmability.</li>\n<li><b>Watch the NULL traps</b> from lesson 6.4: <code>NOT IN</code> with a NULL in the subquery returns nothing, and <code>COUNT(col)</code> skips NULLs while <code>COUNT(*)</code> does not.</li>\n<li><b>Watch WHERE vs ON in outer joins</b> (lesson 6.2) &mdash; a condition on the right table moved into WHERE silently turns a LEFT JOIN into an INNER JOIN.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Sample</span> The ten query patterns and their worked examples are in lesson 9.1. A wider practical prompt bank will be added in the exam room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Đánh giá · PE</span>\n<h2>PE — Thi thực hành (85 phút, 30% điểm môn)</h2>\n<p class=\"lead\">Số liệu của chính syllabus: Practical Exam của DBI202 là đánh giá <strong>on-going</strong>, <strong>1 phần</strong>, <strong>85 phút</strong>, trọng số <strong>30%</strong>, điều kiện hoàn thành <strong>&gt; 0</strong> &mdash; bị 0 điểm ở đây là tự nó đánh trượt môn. Đây là thành phần nặng nhất, ngang bài thi cuối kỳ, và là cột duy nhất kiểm tra bạn có thực sự viết được SQL hay không.</p>\n<div class=\"callout warn\"><span class=\"badge\">Cái syllabus không công bố</span> Không ngân hàng đề, không thang chấm, không danh sách tài liệu được mang vào. Những thứ đó hỏi giảng viên. Mọi thứ dưới đây suy ra từ nội dung môn và từ công cụ duy nhất syllabus nêu tên: <strong>Microsoft SQL Server</strong>.</div>\n<h3>Luyện ở đâu cho đúng</h3>\n<p>Khóa học đã có sẵn giáo án PE đầy đủ &mdash; <strong>bài 9.1</strong>, với mười mẫu truy vấn phủ gần như mọi đề thực hành, xếp theo thứ tự nên làm. Hãy học bài đó thay vì đọc trang này; trang này chỉ nêu số liệu chính thức và hình dạng bài thi.</p>\n<h3>85 phút SQL thường gồm những gì</h3>\n<table>\n<thead><tr><th>Phần việc</th><th>Bài</th><th>Ghi chú</th></tr></thead>\n<tbody>\n<tr><td>Tạo bảng từ lược đồ cho sẵn, kèm khoá và ràng buộc</td><td>5.1, 5.2, 5.3</td><td>ràng buộc có tên, đúng kiểu dữ liệu, thứ tự khoá ngoại rất quan trọng</td></tr>\n<tr><td>Chèn dữ liệu mẫu, rồi UPDATE / DELETE theo điều kiện</td><td>6.5</td><td>điểm nhanh &mdash; làm sớm</td></tr>\n<tr><td>SELECT nhiều bảng có join, lọc và ORDER BY</td><td>6.1, 6.2</td><td>phần lớn của đề</td></tr>\n<tr><td>GROUP BY kèm HAVING, và một truy vấn lồng</td><td>6.3, 6.4</td><td>chỗ hay mất điểm &mdash; WHERE lọc DÒNG, HAVING lọc NHÓM</td></tr>\n<tr><td>Một view, một stored procedure hoặc function; đôi khi một trigger hay cursor</td><td>7.2, 7.3, 7.4</td><td>phần cuối; trigger từ chối dữ liệu sai bằng ROLLBACK là dạng kinh điển</td></tr>\n</tbody>\n</table>\n<h3>Xoay 85 phút thế nào</h3>\n<ul>\n<li><b>Đọc hết đề trước</b> và tạo lược đồ trước mọi thứ khác &mdash; mọi truy vấn sau đều phụ thuộc vào việc bảng đã tồn tại và có dữ liệu.</li>\n<li><b>Chạy từng câu lệnh ngay khi viết.</b> SQL báo lỗi rất rõ; một truy vấn chưa chạy thử để tới cuối là truy vấn bạn sẽ không kịp sửa.</li>\n<li><b>Gom điểm dễ theo thứ tự:</b> DDL &rarr; chèn dữ liệu &rarr; SELECT đơn giản &rarr; join &rarr; tổng hợp &rarr; lập trình (view/proc/trigger).</li>\n<li><b>Coi chừng bẫy NULL</b> ở bài 6.4: <code>NOT IN</code> mà truy vấn con có NULL thì trả về rỗng, và <code>COUNT(cột)</code> bỏ qua NULL trong khi <code>COUNT(*)</code> thì không.</li>\n<li><b>Coi chừng WHERE vs ON trong phép nối ngoài</b> (bài 6.2) &mdash; một điều kiện trên bảng phải mà chuyển vào WHERE sẽ âm thầm biến LEFT JOIN thành INNER JOIN.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Đề mẫu</span> Mười mẫu truy vấn kèm ví dụ có lời giải nằm ở bài 9.1. Ngân hàng đề thực hành rộng hơn sẽ được thêm ở trang phòng thi.</div>\n</div>"
        },
        {
