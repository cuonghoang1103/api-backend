/**
 * EEM201 — Introduction to Entertainment and Event Management.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — khối Quản trị Kinh doanh, semester 2. Lessons are not written yet.|||Môn trong khung chương trình FPTU — khối Quản trị Kinh doanh, kỳ 2. Bài giảng chưa được dựng.',
    description: 'Môn <strong>EEM201 — Introduction to Entertainment and Event Management</strong> thuộc khung chương trình khối Quản trị Kinh doanh, kỳ 2.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
