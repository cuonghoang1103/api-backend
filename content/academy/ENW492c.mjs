...
<p class="note">The syllabus note that awards the bonus is cut off in the published export, so the exact amount is not printed there; the identical note in sibling FPT syllabi is <b>1 point</b>, and that is the value used below. Confirm it with your instructor.</p>
...
<p class="note">Ghi chú trao điểm thưởng trong syllabus bị cắt ở bản xuất công bố nên không in ra con số cụ thể; ghi chú y hệt ở các syllabus FPT cùng đợt ghi <b>1 điểm</b>, và đó là giá trị dùng bên dưới. Hãy xác nhận lại với giảng viên.</p>
...
<div class="pitfall">Over-relying on AI to write for you means you never build the skill the exam tests. The PE is a <strong>timed, on-campus</strong> exam (~100 minutes, MCQ + short answers + writing) with no AI assistant beside you — the syllabus does not say whether you write on paper or on a computer, only that you sit it at campus. If the tool did your thinking all semester, you will be helpless when it is taken away.</div>
</div>
<div class="ml-vi">
...
<div class="pitfall">Lệ thuộc AI viết hộ nghĩa là bạn không bao giờ xây được kỹ năng mà bài thi kiểm tra. PE là bài thi <strong>bấm giờ, tại campus</strong> (~100 phút, trắc nghiệm + trả lời ngắn + bài viết) và không có trợ lý AI bên cạnh — syllabus không nói bạn viết trên giấy hay trên máy, chỉ nói bạn thi tại campus. Nếu công cụ tư duy hộ bạn cả kỳ, bạn sẽ bất lực khi nó bị lấy đi.</div>
</div>`,
        },
        {
          ...
          quiz: {
            ...
            questions: [
              ...
              { question: 'Over-relying on AI to draft essays is risky because the final exam is… (beyond-syllabus)|||Lệ thuộc AI soạn luận rủi ro vì bài thi cuối là… (ngoài giáo trình)', options: ['open-book with AI allowed|||mở sách, cho dùng AI', 'a timed on-campus exam with no AI assistant, worth 100%|||bài thi bấm giờ tại campus không có trợ lý AI, chiếm 100%', 'a group project|||đồ án nhóm', 'multiple choice only|||chỉ trắc nghiệm'], correctIndex: 1, points: 1 },
            ],
          },
        },
      ],
    ...
    {
      "title": "Final Exam — one PE, 100% of the grade|||Thi cuối kỳ — một bài PE duy nhất, 100% điểm",
      "description": "ENW492c chỉ có MỘT bài thi: Final exam PE, 100%, ~100 phút, gồm trắc nghiệm + trả lời ngắn + bài viết. KHÔNG có bài FE riêng. Cấu trúc, cách phân bổ thời gian và luyện từng phần.",
      "lessons": [
        {
          "title": "The PE — the only exam in ENW492c (100%, ~100 minutes)|||Bài PE — bài thi duy nhất của ENW492c (100%, ~100 phút)",
          "slug": "enw492c-final-exam-pe",
          "type": "article",
          "description": "Cấu trúc thật của bài thi theo syllabus: MCQ + short answers + Writing, ~100 phút, 100% điểm, mốc PE ≥ 4 và FR = min(10, PE + Bonus) ≥ 5. Kèm kế hoạch chia thời gian.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · PE</span>\n<h2>One exam, three parts, 100% of the grade</h2>\n<p class=\"lead\">The syllabus (sylID 12645) lists <strong>exactly one assessment</strong> for ENW492c: <em>Final exam PE &mdash; 100% &mdash; completion criterion 4 &mdash; ~100' &mdash; question type: MCQ, short answers, Writing</em>. There is no separate multiple-choice &ldquo;FE&rdquo;, and there is no on-going component. Everything rides on this one sitting.</p>\n<table>\n<thead><tr><th>Field (as printed in the syllabus)</th><th>Value</th></tr></thead>\n<tbody>\n<tr><td>Category / Type</td><td>Final exam PE &mdash; Final exam</td></tr>\n<tr><td>Weight</td><td><strong>100%</strong></td></tr>\n<tr><td>Completion criterion</td><td><strong>4</strong></td></tr>\n<tr><td>Duration</td><td><strong>~100 minutes</strong></td></tr>\n<tr><td>CLOs covered</td><td>All LOs (CLO1&ndash;CLO5)</td></tr>\n<tr><td>Question type</td><td><strong>MCQ, short answers, Writing</strong></td></tr>\n<tr><td>Number of questions</td><td>The column begins &ldquo;5-10 MCQ&hellip;&rdquo; and is cut off in the published export &mdash; so expect a small MCQ block, not a long one, with most of the time going to the short answers and the writing task.</td></tr>\n</tbody>\n</table>\n<div class=\"formula\"><span class=\"lbl\">PASS</span> PE &ge; 4 <b>AND</b> FR = min(10, PE + Bonus) &ge; 5 &nbsp;&middot;&nbsp; and you may only sit it once all five MOOCs are certified</div>\n<div class=\"callout warn\"><strong>Correction.</strong> An earlier version of this section said the final was &ldquo;PE (a practical exam) and FE (multiple choice)&rdquo; and described the PE as a generic report-writing task. The syllabus has one exam containing all three question types. Prepare for all three, not for an essay alone.</div>\n\n<h3>A time plan for ~100 minutes</h3>\n<table>\n<thead><tr><th>Part</th><th>Suggested time</th><th>What it tests</th><th>Practise in</th></tr></thead>\n<tbody>\n<tr><td>MCQ (roughly 5&ndash;10 items)</td><td>10&ndash;12 min</td><td>CLO1 grammar: verb tenses, conjunctions, sentence types, commas, parallel structure</td><td>1.1, 1.2, Quiz 1, and the MCQ set in the next lesson</td></tr>\n<tr><td>Short answers</td><td>25&ndash;30 min</td><td>CLO2&ndash;CLO4: thesis statements, essay-type structure, plagiarism and paraphrase, source evaluation, citation and reporting language</td><td>2.1, 2.2, 3.1, 3.2, 4.1, 4.2 and the CLO prompts in 6.1</td></tr>\n<tr><td>Writing task</td><td>50&ndash;55 min (10 plan &middot; 35 write &middot; 8 revise)</td><td>CLO2&ndash;CLO3 and CLO5: a complete, argued piece with a clear thesis, developed body paragraphs and a conclusion</td><td>2.1, 3.1, 5.1, 5.2, the capstone checklist</td></tr>\n<tr><td>Reserve</td><td>5 min</td><td>Re-reading, fixing fragments and agreement errors &mdash; the cheapest marks in the paper</td><td>1.2</td></tr>\n</tbody>\n</table>\n\n<h3>How to prepare each part</h3>\n<ul>\n<li><strong>MCQ:</strong> the grammar items are the only part you can make near-automatic. Drill tense choice, comma rules, parallelism and fragment detection until they are instant.</li>\n<li><strong>Short answers:</strong> answer in two to four sentences &mdash; a definition plus an example. Long paragraphs waste the time the writing task needs.</li>\n<li><strong>Writing:</strong> spend the first ten minutes on a thesis and a three-point outline. A clear, ordinary essay with a defensible thesis beats an ambitious one that runs out of time mid-argument.</li>\n<li><strong>Before anything:</strong> finish the five MOOCs with certificates. Without them you are not admitted to the exam &mdash; and the on-time bonus is what turns a 4.5 into a pass.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Not published</span> The syllabus does not print a marking rubric, the exact number of short-answer items, or the writing prompt genre. What is certain is the three question types, the ~100 minutes and the 100% weight. Confirm the rest with your instructor rather than assuming a format.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · PE</span>\n<h2>Một bài thi, ba phần, 100% điểm</h2>\n<p class=\"lead\">Syllabus (sylID 12645) liệt kê <strong>đúng một thành phần đánh giá</strong> cho ENW492c: <em>Final exam PE &mdash; 100% &mdash; mốc hoàn thành 4 &mdash; ~100 phút &mdash; dạng câu hỏi: MCQ, short answers, Writing</em>. Không có bài &ldquo;FE&rdquo; trắc nghiệm riêng, cũng không có thành phần on-going nào. Tất cả nằm ở một buổi thi này.</p>\n<table>\n<thead><tr><th>Trường (đúng như syllabus in)</th><th>Giá trị</th></tr></thead>\n<tbody>\n<tr><td>Loại</td><td>Final exam PE &mdash; thi cuối kỳ</td></tr>\n<tr><td>Trọng số</td><td><strong>100%</strong></td></tr>\n<tr><td>Mốc hoàn thành</td><td><strong>4</strong></td></tr>\n<tr><td>Thời lượng</td><td><strong>~100 phút</strong></td></tr>\n<tr><td>CLO phủ</td><td>Tất cả (CLO1&ndash;CLO5)</td></tr>\n<tr><td>Dạng câu hỏi</td><td><strong>Trắc nghiệm, trả lời ngắn, bài viết</strong></td></tr>\n<tr><td>Số câu</td><td>Cột này bắt đầu bằng &ldquo;5-10 MCQ&hellip;&rdquo; và bị cắt trong bản xuất công bố &mdash; nên hãy chờ một cụm trắc nghiệm nhỏ, không dài, phần lớn thời gian dành cho trả lời ngắn và bài viết.</td></tr>\n</tbody>\n</table>\n<div class=\"formula\"><span class=\"lbl\">ĐẬU</span> PE &ge; 4 <b>VÀ</b> FR = min(10, PE + Bonus) &ge; 5 &nbsp;&middot;&nbsp; và chỉ được thi khi đã có chứng chỉ đủ 5 MOOC</div>\n<div class=\"callout warn\"><strong>Đính chính.</strong> Bản trước của mục này nói thi cuối kỳ gồm &ldquo;PE (thi thực hành) và FE (trắc nghiệm)&rdquo;, và mô tả PE như một bài viết báo cáo chung chung. Syllabus chỉ có một bài thi chứa cả ba dạng câu hỏi. Hãy luyện cả ba, đừng chỉ luyện viết luận.</div>\n\n<h3>Kế hoạch chia ~100 phút</h3>\n<table>\n<thead><tr><th>Phần</th><th>Thời gian gợi ý</th><th>Kiểm tra gì</th><th>Luyện ở</th></tr></thead>\n<tbody>\n<tr><td>Trắc nghiệm (khoảng 5&ndash;10 câu)</td><td>10&ndash;12 phút</td><td>CLO1 ngữ pháp: thì động từ, liên từ, kiểu câu, dấu phẩy, cấu trúc song song</td><td>1.1, 1.2, Quiz 1 và bộ MCQ ở bài kế tiếp</td></tr>\n<tr><td>Trả lời ngắn</td><td>25&ndash;30 phút</td><td>CLO2&ndash;CLO4: luận đề, cấu trúc từng kiểu bài, đạo văn &amp; diễn giải, đánh giá nguồn, trích dẫn và ngôn ngữ thuật lại</td><td>2.1, 2.2, 3.1, 3.2, 4.1, 4.2 và bộ câu hỏi theo CLO ở 6.1</td></tr>\n<tr><td>Bài viết</td><td>50&ndash;55 phút (10 lập dàn &middot; 35 viết &middot; 8 soát)</td><td>CLO2&ndash;CLO3 và CLO5: một bài hoàn chỉnh có luận đề rõ, thân bài triển khai và kết luận</td><td>2.1, 3.1, 5.1, 5.2, checklist capstone</td></tr>\n<tr><td>Dự phòng</td><td>5 phút</td><td>Đọc lại, sửa câu cụt và lỗi hoà hợp &mdash; những điểm rẻ nhất trong cả bài</td><td>1.2</td></tr>\n</tbody>\n</table>\n\n<h3>Chuẩn bị từng phần thế nào</h3>\n<ul>\n<li><strong>Trắc nghiệm:</strong> đây là phần duy nhất có thể luyện tới mức tự động. Luyện chọn thì, quy tắc dấu phẩy, cấu trúc song song và nhận diện câu cụt cho tới khi phản xạ.</li>\n<li><strong>Trả lời ngắn:</strong> trả lời bằng hai đến bốn câu &mdash; một định nghĩa kèm một ví dụ. Viết dài ở đây là ăn mất thời gian của bài viết.</li>\n<li><strong>Bài viết:</strong> dành mười phút đầu cho luận đề và dàn ý ba ý. Một bài rõ ràng, bình thường, có luận đề bảo vệ được thắng một bài tham vọng nhưng hết giờ giữa chừng.</li>\n<li><strong>Trước tất cả:</strong> hoàn thành năm MOOC và lấy chứng chỉ. Không có chúng thì không được vào phòng thi &mdash; và điểm thưởng đúng hạn chính là thứ biến 4.5 thành đậu.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Không được công bố</span> Syllabus không in rubric chấm, số câu trả lời ngắn cụ thể, hay thể loại đề bài viết. Thứ chắc chắn là ba dạng câu hỏi, ~100 phút và trọng số 100%. Phần còn lại hãy hỏi giảng viên thay vì đoán một format.</div>\n</div>"
        },
        {
          "title": "PE Part 1 — the MCQ block: what it tests and how to drill it|||Phần 1 của PE — cụm trắc nghiệm: kiểm tra gì và luyện thế nào",
          "slug": "enw492c-final-exam-fe",
          "type": "article",
          "description": "Cụm MCQ (~5–10 câu) của bài PE kiểm tra ngữ pháp CLO1: thì, liên từ, kiểu câu, dấu phẩy, song song. Chiến thuật làm bài + bộ câu luyện.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · PE, part 1</span>\n<h2>The MCQ block &mdash; small, fast, and the easiest marks in the paper</h2>\n<p class=\"lead\">ENW492c has <strong>no separate multiple-choice exam</strong>. The MCQs are the <em>first block of the single PE</em>; the syllabus' question-count column begins &ldquo;5-10 MCQ&hellip;&rdquo;, so this is a short section &mdash; worth finishing in about ten minutes so the writing task keeps its time.</p>\n<h3>What the MCQs test (CLO1)</h3>\n<ul>\n<li><strong>Verb tenses</strong> in academic writing: present simple for claims and general truths, present perfect for research-to-date, past simple for a completed study, modals for hedged claims &mdash; and tense consistency inside a paragraph.</li>\n<li><strong>Conjunctions and connectors</strong>: coordinating, subordinating and correlative; the comma that goes with each.</li>\n<li><strong>Sentence types</strong>: simple, compound, complex, compound-complex &mdash; and spotting run-ons, comma splices and fragments.</li>\n<li><strong>Commas and parallel structure</strong> in lists and paired constructions.</li>\n</ul>\n<h3>Technique</h3>\n<ul>\n<li>Read the whole sentence before looking at the options &mdash; decide what you would write, then find it.</li>\n<li>Eliminate options that break a rule you can name (a comma splice, a broken parallel), rather than choosing what &ldquo;sounds right&rdquo;.</li>\n<li>Do not leave an item blank: the exam has a completion criterion of 4, and a guess costs nothing.</li>\n<li>Flag at most one hard item and move on &mdash; the writing task pays far more per minute.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Practice</span> The items below are practice questions in the format of this block. Real past-exam questions will be added later in the exam room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · PE, phần 1</span>\n<h2>Cụm trắc nghiệm &mdash; ngắn, nhanh, và là điểm dễ nhất cả bài</h2>\n<p class=\"lead\">ENW492c <strong>không có bài thi trắc nghiệm riêng</strong>. Trắc nghiệm là <em>cụm đầu tiên trong chính bài PE duy nhất</em>; cột số câu của syllabus bắt đầu bằng &ldquo;5-10 MCQ&hellip;&rdquo;, nên đây là phần ngắn &mdash; nên xong trong khoảng mười phút để bài viết giữ đủ thời gian.</p>\n<h3>Trắc nghiệm kiểm tra gì (CLO1)</h3>\n<ul>\n<li><strong>Thì động từ</strong> trong văn học thuật: hiện tại đơn cho khẳng định và chân lý chung, hiện tại hoàn thành cho nghiên cứu tới nay, quá khứ đơn cho một nghiên cứu đã kết thúc, động từ khuyết thiếu cho khẳng định dè dặt &mdash; và sự nhất quán thì trong một đoạn.</li>\n<li><strong>Liên từ và từ nối</strong>: đẳng lập, phụ thuộc, tương liên; dấu phẩy đi kèm từng loại.</li>\n<li><strong>Kiểu câu</strong>: đơn, ghép, phức, ghép-phức &mdash; và nhận diện câu dính, lỗi dấu phẩy nối, câu cụt.</li>\n<li><strong>Dấu phẩy và cấu trúc song song</strong> trong danh sách và các cặp đối xứng.</li>\n</ul>\n<h3>Kỹ thuật làm</h3>\n<ul>\n<li>Đọc hết câu trước khi nhìn phương án &mdash; tự quyết định bạn sẽ viết gì, rồi tìm phương án đó.</li>\n<li>Loại phương án vi phạm một quy tắc bạn gọi được tên (dấu phẩy nối, mất song song), thay vì chọn theo cảm giác &ldquo;nghe xuôi&rdquo;.</li>\n<li>Đừng bỏ trống câu nào: bài thi có mốc hoàn thành 4, và đoán thì không mất gì.</li>\n<li>Chỉ đánh dấu tối đa một câu khó rồi đi tiếp &mdash; bài viết trả điểm trên mỗi phút cao hơn nhiều.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Luyện tập</span> Các câu dưới đây là câu luyện theo đúng dạng của cụm này. Đề thi thật sẽ được thêm sau, trong trang phòng thi.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
                "id": "q1",
                "points": 1,
                "question": "For your thesis statement (a general claim), the best tense is usually…|||Cho luận đề (một khẳng định chung), thì tốt nhất thường là…",
                "options": [
              ...
              },
              {
                "id": "q2",
                "points": 1,
                "question": "Which sentence correctly joins two independent clauses?|||Câu nào nối đúng hai mệnh đề độc lập?",
                "options": [
                  "Phones distract, students fail.",
                  "Phones distract students fail.",
                  "Phones distract, so students fail.",
                  "Phones distract; but students fail."
                ],
                "correctIndex": 2
              },
              {
                "id": "q3",
                "points": 1,
                "question": "\"Although the study was large, it was short.\" is a… sentence.|||\"Although the study was large, it was short.\" là câu…",
                "options": [
                  "simple|||đơn",
                  "compound|||ghép",
                  "complex|||phức",
              ...
              },
              {
                "id": "q4",
                "points": 1,
                "question": "Which list uses correct parallel structure?|||Danh sách nào dùng đúng cấu trúc song song?",
                "options": [
                  "clear, well-researched, and it has structure",
                  "clear, well-researched, and well-structured",
                  "clearly, research, and structure",
                  "clear, researching, and to structure"
                ],
                "correctIndex": 1
              },
              {
                "id": "q5",
                "points": 1,
                "question": "A comma splice is fixed by all of these EXCEPT…|||Comma splice được sửa bằng mọi cách sau NGOẠI TRỪ…",
                "options": [
                  "a period|||dấu chấm",
                  "a semicolon|||dấu chấm phẩy",
                  "a FANBOYS conjunction|||liên từ FANBOYS",
                  "adding another comma|||thêm một dấu phẩy nữa"
                ],
                "correctIndex": 3
              },
              {
                "id": "q6",
                "points": 1,
                "question": "When citing research that still holds true today, native academics often keep the reporting verb in… (beyond-syllabus)|||Khi trích nghiên cứu vẫn đúng hôm nay, người bản ngữ thường giữ động từ tường thuật ở… (ngoài giáo trình)",
                "options": [
                  "past simple to sound formal|||quá khứ đơn cho trang trọng",
                  "present simple, because the argument still stands|||hiện tại đơn, vì lập luận vẫn đứng vững",
                  "future tense|||thì tương lai",
                  "no verb at all|||không động từ"
                ],
                "correctIndex": 1
              }
            ]
