...
export default {
  ...
  course: {
    ...
    shortDescription: 'How to do research and write academically — research questions, literature review, APA/IEEE citation & plagiarism, IMRaD, coherent paragraphs, argument, data collection & ethics, academic style. Bilingual, with examples & quizzes.|||Cách làm nghiên cứu và viết học thuật — câu hỏi nghiên cứu, tổng quan tài liệu, trích dẫn APA/IEEE & đạo văn, IMRaD, đoạn văn mạch lạc, lập luận, thu thập dữ liệu & đạo đức, văn phong. Song ngữ, có ví dụ & quiz.',
