/**
 * EPL201 — Ethics, Privacy & Legal Issues in IMC.
...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>EPL201 — Ethics, Privacy &amp; Legal Issues in IMC</strong> thuộc khung chương trình khối Công nghệ Truyền thông, kỳ 3.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
