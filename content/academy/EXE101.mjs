...
export default {
  ...
  course: {
    ...
    requirements: 'Không có môn tiên quyết. Cần: một đội 4-6 người và BẮT BUỘC gồm ít nhất 2 chuyên ngành khác nhau (yêu cầu của syllabus, không phải khuyến khích), một tài khoản Google (Forms/Slides), một công cụ thiết kế (Canva) và tinh thần dám thử — dám sai — sửa nhanh. Nên có laptop và truy cập được kho tài liệu Y Combinator (ycombinator.com/library).',
...
<div class="callout"><span class="badge">★ Ngoài giáo trình</span> <b>Vì sao FPT dạy môn này.</b> Kể cả bạn không bao giờ mở công ty, vòng lặp EXE — <em>tìm vấn đề thật → thử rẻ → quyết định dựa trên bằng chứng</em> — chính là cách một product engineer, PM hay tư vấn giỏi làm việc. Bạn đang học một PHƯƠNG PHÁP RA QUYẾT ĐỊNH chuyên nghiệp, không chỉ "cách mở công ty". <em>Góc nhìn này không nằm trong syllabus nhưng là lý do kỹ năng này chuyển được sang nghề khác.</em></div>
        ...
        {
          title: '0.2 — How you are graded: 5 on-going components, no final exam|||0.2 — Cách tính điểm: 5 thành phần on-going, không thi cuối kỳ',
          slug: 'exe101-thang-diem',
          type: 'article',
          description: 'Bảng thang điểm đầy đủ theo syllabus: Constructivism Presentations 15% + 3 Group Assignment checkpoint + Presentation (Checkpoint 4) 40%. Mỗi thành phần có mốc hoàn thành 5.',
          content: `
<div class="ml-en">
...
<table>
<thead><tr><th>Component (syllabus name)</th><th>Weight</th><th>Completion</th><th>Duration</th><th>CLO</th><th>Form / what you submit</th></tr></thead>
<tbody>
<tr><td>Constructivism Presentations</td><td><strong>15%</strong></td><td><strong>5</strong></td><td>15'</td><td>All</td><td>Oral presentation — you answer the syllabus' constructive questions (HCM1.1–HCM7.4)</td></tr>
<tr><td>Group Assignment 1 — Checkpoint 1</td><td><strong>10%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO1, CLO2</td><td>Oral presentation — team + idea + why-this-problem</td></tr>
<tr><td>Group Assignment 2 — Checkpoint 2</td><td><strong>20%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO3</td><td>Oral presentation — customer interviews + market research</td></tr>
<tr><td>Group Assignment 3 — Checkpoint 3</td><td><strong>15%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO4</td><td>Oral presentation — MVP + business model</td></tr>
<tr><td>Presentation — Checkpoint 4</td><td><strong>40%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO5</td><td>Oral presentation — Demo Day pitch deck + demo</td></tr>
</tbody>
</table>

<div class="kv-grid">
<div class="kv"><span class="k">Scale</span><span class="v">10</span></div>
<div class="kv"><span class="k">Pass</span><span class="v">≥ 5 on EVERY component, and final average ≥ 5.0</span></div>
...
<div class="callout warn"><strong>Every component has a completion criterion of 5.</strong> The syllabus does not only ask for an average of 5 — each of the five rows above carries a completion criterion of <strong>5</strong>. A 3 on Checkpoint 1 is not repaired by a 9 on the final pitch. The <em>15% Constructivism Presentations</em> are the row students most often ignore: they are not "weekly progress pitches", they are 15-minute oral answers to the 28 constructive questions listed in the syllabus (HCM1.1–HCM7.4). See the lesson "Constructivism Presentations — the 28 questions" in the Assessment section.</div>
...
<table>
<thead><tr><th>Thành phần (tên trong syllabus)</th><th>Trọng số</th><th>Mốc hoàn thành</th><th>Thời lượng</th><th>CLO</th><th>Hình thức / nộp gì</th></tr></thead>
<tbody>
<tr><td>Constructivism Presentations</td><td><strong>15%</strong></td><td><strong>5</strong></td><td>15'</td><td>Tất cả</td><td>Thuyết trình miệng — trả lời bộ câu hỏi kiến tạo của syllabus (HCM1.1–HCM7.4)</td></tr>
<tr><td>Bài nhóm 1 — Checkpoint 1</td><td><strong>10%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO1, CLO2</td><td>Thuyết trình miệng — đội + ý tưởng + vì sao vấn đề này</td></tr>
<tr><td>Bài nhóm 2 — Checkpoint 2</td><td><strong>20%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO3</td><td>Thuyết trình miệng — phỏng vấn khách hàng + nghiên cứu thị trường</td></tr>
<tr><td>Bài nhóm 3 — Checkpoint 3</td><td><strong>15%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO4</td><td>Thuyết trình miệng — MVP + mô hình kinh doanh</td></tr>
<tr><td>Presentation — Checkpoint 4</td><td><strong>40%</strong></td><td><strong>5</strong></td><td>10'–30'</td><td>CLO5</td><td>Thuyết trình miệng — pitch deck Demo Day + demo</td></tr>
</tbody>
</table>

<div class="kv-grid">
<div class="kv"><span class="k">Thang</span><span class="v">10</span></div>
<div class="kv"><span class="k">Qua môn</span><span class="v">≥ 5 ở TỪNG thành phần, và điểm tổng ≥ 5.0</span></div>
...
<div class="callout warn"><strong>Mỗi thành phần đều có mốc hoàn thành là 5.</strong> Syllabus không chỉ đòi điểm trung bình 5 — cả năm dòng trên đều có mốc hoàn thành <strong>5</strong>. Được 3 ở Checkpoint 1 thì điểm 9 ở pitch cuối không cứu được. Dòng <em>Constructivism Presentations 15%</em> là dòng sinh viên hay bỏ qua nhất: nó KHÔNG phải "pitch tiến độ hàng tuần", mà là phần trả lời miệng 15 phút cho 28 câu hỏi kiến tạo liệt kê trong syllabus (HCM1.1–HCM7.4). Xem bài "Constructivism Presentations — 28 câu hỏi" ở mục Đánh giá.</div>
...
<div class="callout warn"><strong>The syllabus rule you cannot negotiate:</strong> "Students are grouped into teams of 4 to 6. <em>Each team must be formed from at least 2 different majors.</em>" This is a requirement, not a suggestion — a single-major team does not satisfy the subject's team formation rule.</div>

<h3>Choosing co-founders — what actually matters</h3>
<ul>
<li><strong>At least two different majors</strong> — required by the syllabus, and it is also why the split below works: someone who builds, someone who sells.</li>
...
<div class="callout warn"><strong>Quy tắc của syllabus không thương lượng được:</strong> "Sinh viên được chia thành đội 4 đến 6 người. <em>Mỗi đội bắt buộc phải gồm ít nhất 2 chuyên ngành khác nhau.</em>" Đây là yêu cầu, không phải gợi ý — đội chỉ có một chuyên ngành là chưa đạt quy định lập đội của môn.</div>

<h3>Chọn đồng sáng lập — điều gì thực sự quan trọng</h3>
<ul>
<li><strong>Ít nhất hai chuyên ngành khác nhau</strong> — syllabus bắt buộc, và cũng chính là lý do cách chia vai bên dưới chạy được: có người xây, có người bán.</li>
...
<div class="callout"><span class="badge">★ Ngoài giáo trình</span> <b>Hiệu ứng mạng là hào nước tối thượng.</b> Một chợ mà mỗi người dùng mới làm sản phẩm giá trị hơn cho mọi người (thêm người mua → thêm người bán → thêm người mua) trở nên rất khó bị thay thế. Nếu ý tưởng của bạn có tính chất này, hãy nói ra — đó là câu chuyện phòng thủ dài hạn mạnh nhất bạn có thể kể. <em>Ý tưởng chiến lược sâu nhất ngoài syllabus.</em></div>
    ...
    {
      "title": "Assessment — Constructivism Presentations & the four checkpoints|||Đánh giá — Constructivism Presentations & bốn checkpoint",
      "description": "EXE101 KHÔNG có thi cuối kỳ. Năm thành phần on-going, mỗi thành phần mốc hoàn thành 5: Constructivism Presentations 15% (28 câu hỏi kiến tạo) + Checkpoint 1/2/3 (10/20/15%) + Presentation Checkpoint 4 40%.",
      "lessons": [
        {
          "title": "Constructivism Presentations (15%) — the 28 constructive questions|||Constructivism Presentations (15%) — 28 câu hỏi kiến tạo",
          "slug": "exe101-final-exam-pe",
          "type": "article",
          "description": "EXE101 không có bài thi nào. Thành phần 15% này là phần trả lời miệng 15 phút cho 28 câu hỏi kiến tạo HCM1.1–HCM7.4 của syllabus — liệt kê đầy đủ ở đây, kèm bài học chuẩn bị cho từng câu.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Assessment · Constructivism Presentations</span>\n<h2>EXE101 has no exam &mdash; this 15% is oral, and it has a published question list</h2>\n<p class=\"lead\">The syllabus (sylID 10358) lists <strong>five assessment components, all on-going oral presentations</strong>, and <strong>no final exam of any kind</strong>. The first of them, <em>Constructivism Presentations</em>, is worth <strong>15%</strong>, runs <strong>15 minutes</strong>, covers <strong>all CLOs</strong> and has a completion criterion of <strong>5</strong>. What makes it unusual is that the syllabus prints the exact questions: <strong>28 constructive questions, HCM1.1&ndash;HCM7.4</strong>, one block per week. They are reproduced in full below.</p>\n<div class=\"callout warn\"><strong>Correction.</strong> An earlier version of this page described a written &ldquo;PE&rdquo; essay exam and a computer-graded &ldquo;FE&rdquo;. EXE101 has neither. Lesson 0.2 was right all along: the subject is 100% continuous, oral, team assessment.</div>\n\n<h3>How a 15-minute constructive answer is built</h3>\n<ol>\n<li><strong>Answer in one sentence first</strong> (~20s) &mdash; take a position, do not warm up.</li>\n<li><strong>Give the reasoning</strong> (~3 min) &mdash; two or three reasons, in order of strength.</li>\n<li><strong>Ground it in your own startup</strong> (~5 min) &mdash; what your team did, saw or measured. This is the part that separates a 5 from a 9: the question is generic, the evidence must be yours.</li>\n<li><strong>Name the counter-case</strong> (~2 min) &mdash; when your answer would be wrong.</li>\n<li><strong>Close and take questions</strong> (~5 min).</li>\n</ol>\n\n<h3>The 28 constructive questions, with the lesson that prepares each</h3>\n<table>\n<thead><tr><th>#</th><th>Week</th><th>Question</th><th>Prepare with</th></tr></thead>\n<tbody>\n<tr><td>HCM1.1</td><td>1</td><td>What are your first few thoughts on entrepreneurship?</td><td>1.2</td></tr>\n<tr><td>HCM1.2</td><td>1</td><td>Why is entrepreneurship important for our economy?</td><td>1.1, 1.2</td></tr>\n<tr><td>HCM1.3</td><td>1</td><td>From your experience, your network, your known startup &mdash; why did the founder start his/her company?</td><td>1.2</td></tr>\n<tr><td>HCM1.4</td><td>1</td><td>What makes a successful entrepreneur?</td><td>1.2</td></tr>\n<tr><td>HCM2.1</td><td>2</td><td>Should I work first or just start a company?</td><td>1.2 (own reasoning required)</td></tr>\n<tr><td>HCM2.2</td><td>2</td><td>Why did you choose your team members? Any criteria? How do you structure the team and divide the work?</td><td>2.1, 2.2</td></tr>\n<tr><td>HCM2.3</td><td>2</td><td>Which factors will decide the success of a startup? List three.</td><td>1.1, 2.1</td></tr>\n<tr><td>HCM2.4</td><td>2</td><td>Why does your idea need to be 10x?</td><td>1.1, 3.1</td></tr>\n<tr><td>HCM3.1</td><td>3</td><td>What are the similarities between a startup and an SME?</td><td>1.1</td></tr>\n<tr><td>HCM3.2</td><td>3</td><td>What are the key differences between a startup and an SME?</td><td>1.1</td></tr>\n<tr><td>HCM3.3</td><td>3</td><td>Why are customer interview questions different from research-paper interview questions?</td><td>4.1 (The Mom Test)</td></tr>\n<tr><td>HCM3.4</td><td>3</td><td>Do you prefer a small market or a big market? Why?</td><td>3.2, 5.2</td></tr>\n<tr><td>HCM4.1</td><td>4</td><td>What is a product-market fit?</td><td>4.2</td></tr>\n<tr><td>HCM4.2</td><td>4</td><td>Why should you go for a mini-launch rather than a big launch?</td><td>6.2</td></tr>\n<tr><td>HCM4.3</td><td>4</td><td>How will you compete with other startups?</td><td>5.2</td></tr>\n<tr><td>HCM4.4</td><td>4</td><td>How will you compete with large companies?</td><td>5.2</td></tr>\n<tr><td>HCM5.1</td><td>5</td><td>What are your defence strategies after launching?</td><td>5.2, 8.2</td></tr>\n<tr><td>HCM5.2</td><td>5</td><td>What is a business model?</td><td>7.1</td></tr>\n<tr><td>HCM5.3</td><td>5</td><td>What are sources of revenue?</td><td>7.2</td></tr>\n<tr><td>HCM5.4</td><td>5</td><td>What are the key cost drivers?</td><td>7.2</td></tr>\n<tr><td>HCM6.1</td><td>6</td><td>How long should a round of funding last?</td><td>8.1</td></tr>\n<tr><td>HCM6.2</td><td>6</td><td>When is a good time to raise money?</td><td>8.1</td></tr>\n<tr><td>HCM6.3</td><td>6</td><td>Why lean startup?</td><td>6.1, 6.2</td></tr>\n<tr><td>HCM6.4</td><td>6</td><td>How should you start the pitch?</td><td>9.1, 9.2</td></tr>\n<tr><td>HCM7.1</td><td>7</td><td>Why are loss-making startups valued highly?</td><td>8.1 (own reasoning required)</td></tr>\n<tr><td>HCM7.2</td><td>7</td><td>Should startups pay dividends?</td><td>8.1 (own reasoning required)</td></tr>\n<tr><td>HCM7.3</td><td>7</td><td>What is the difference between a model and a real thing?</td><td>6.1, 7.1</td></tr>\n<tr><td>HCM7.4</td><td>7</td><td>When is the best time and the worst time to raise money?</td><td>8.1</td></tr>\n</tbody>\n</table>\n\n<div class=\"pitfall\"><strong>The cheapest way to lose this 15%:</strong> answering the generic question generically. Every one of the 28 can be answered from your own team's week: your team choice for HCM2.2, your interviews for HCM3.3, your mini-launch for HCM4.2, your cost sheet for HCM5.4. Keep a one-page log each week and the answers write themselves.</div>\n<div class=\"callout ok\"><strong>Remember the gate:</strong> this component's completion criterion is <strong>5</strong>, like every other component. It cannot be averaged away by a strong Checkpoint 4.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Đánh giá · Constructivism Presentations</span>\n<h2>EXE101 không có bài thi &mdash; 15% này là nói miệng, và có sẵn danh sách câu hỏi</h2>\n<p class=\"lead\">Syllabus (sylID 10358) liệt kê <strong>năm thành phần đánh giá, tất cả đều là thuyết trình miệng on-going</strong>, và <strong>không có bài thi cuối kỳ nào</strong>. Thành phần đầu tiên, <em>Constructivism Presentations</em>, chiếm <strong>15%</strong>, kéo dài <strong>15 phút</strong>, phủ <strong>tất cả CLO</strong> và có mốc hoàn thành <strong>5</strong>. Điều đặc biệt: syllabus in sẵn đúng bộ câu hỏi &mdash; <strong>28 câu hỏi kiến tạo, HCM1.1&ndash;HCM7.4</strong>, mỗi tuần một cụm. Chép đầy đủ bên dưới.</p>\n<div class=\"callout warn\"><strong>Đính chính.</strong> Bản trước của trang này mô tả một bài &ldquo;PE&rdquo; viết luận và một bài &ldquo;FE&rdquo; trắc nghiệm máy chấm. EXE101 không có cả hai. Bài 0.2 nói đúng từ đầu: môn này 100% đánh giá liên tục, nói miệng, theo nhóm.</div>\n\n<h3>Một câu trả lời kiến tạo 15 phút dựng thế nào</h3>\n<ol>\n<li><strong>Trả lời trong một câu trước đã</strong> (~20 giây) &mdash; chọn quan điểm, đừng dạo đầu.</li>\n<li><strong>Đưa lập luận</strong> (~3 phút) &mdash; hai ba lý do, xếp theo độ mạnh.</li>\n<li><strong>Neo vào chính startup của bạn</strong> (~5 phút) &mdash; đội bạn đã làm gì, thấy gì, đo được gì. Đây là phần phân biệt điểm 5 và điểm 9: câu hỏi thì chung, bằng chứng bắt buộc phải là của bạn.</li>\n<li><strong>Nêu trường hợp ngược lại</strong> (~2 phút) &mdash; khi nào câu trả lời của bạn sẽ sai.</li>\n<li><strong>Chốt và nhận câu hỏi</strong> (~5 phút).</li>\n</ol>\n\n<h3>28 câu hỏi kiến tạo, kèm bài học chuẩn bị</h3>\n<table>\n<thead><tr><th>#</th><th>Tuần</th><th>Câu hỏi</th><th>Chuẩn bị bằng</th></tr></thead>\n<tbody>\n<tr><td>HCM1.1</td><td>1</td><td>Những suy nghĩ đầu tiên của bạn về khởi nghiệp là gì?</td><td>1.2</td></tr>\n<tr><td>HCM1.2</td><td>1</td><td>Vì sao khởi nghiệp quan trọng với nền kinh tế?</td><td>1.1, 1.2</td></tr>\n<tr><td>HCM1.3</td><td>1</td><td>Từ trải nghiệm, quan hệ, hoặc một startup bạn biết &mdash; vì sao nhà sáng lập đó khởi nghiệp?</td><td>1.2</td></tr>\n<tr><td>HCM1.4</td><td>1</td><td>Điều gì làm nên một nhà khởi nghiệp thành công?</td><td>1.2</td></tr>\n<tr><td>HCM2.1</td><td>2</td><td>Nên đi làm trước hay lập công ty luôn?</td><td>1.2 (phải tự lập luận)</td></tr>\n<tr><td>HCM2.2</td><td>2</td><td>Vì sao bạn chọn những thành viên này? Theo tiêu chí gì? Đội cấu trúc và chia việc thế nào?</td><td>2.1, 2.2</td></tr>\n<tr><td>HCM2.3</td><td>2</td><td>Những yếu tố nào quyết định thành công của một startup? Nêu ba yếu tố.</td><td>1.1, 2.1</td></tr>\n<tr><td>HCM2.4</td><td>2</td><td>Vì sao ý tưởng của bạn cần tốt hơn 10 lần?</td><td>1.1, 3.1</td></tr>\n<tr><td>HCM3.1</td><td>3</td><td>Startup và SME giống nhau ở điểm nào?</td><td>1.1</td></tr>\n<tr><td>HCM3.2</td><td>3</td><td>Khác biệt cốt lõi giữa startup và SME là gì?</td><td>1.1</td></tr>\n<tr><td>HCM3.3</td><td>3</td><td>Vì sao câu hỏi phỏng vấn khách hàng khác câu hỏi phỏng vấn nghiên cứu?</td><td>4.1 (The Mom Test)</td></tr>\n<tr><td>HCM3.4</td><td>3</td><td>Bạn thích thị trường nhỏ hay thị trường lớn? Vì sao?</td><td>3.2, 5.2</td></tr>\n<tr><td>HCM4.1</td><td>4</td><td>Product-market fit là gì?</td><td>4.2</td></tr>\n<tr><td>HCM4.2</td><td>4</td><td>Vì sao nên mini-launch thay vì launch lớn?</td><td>6.2</td></tr>\n<tr><td>HCM4.3</td><td>4</td><td>Bạn sẽ cạnh tranh với các startup khác thế nào?</td><td>5.2</td></tr>\n<tr><td>HCM4.4</td><td>4</td><td>Bạn sẽ cạnh tranh với công ty lớn thế nào?</td><td>5.2</td></tr>\n<tr><td>HCM5.1</td><td>5</td><td>Chiến lược phòng thủ sau khi launch của bạn là gì?</td><td>5.2, 8.2</td></tr>\n<tr><td>HCM5.2</td><td>5</td><td>Mô hình kinh doanh là gì?</td><td>7.1</td></tr>\n<tr><td>HCM5.3</td><td>5</td><td>Các nguồn doanh thu là gì?</td><td>7.2</td></tr>\n<tr><td>HCM5.4</td><td>5</td><td>Các yếu tố chi phí chính là gì?</td><td>7.2</td></tr>\n<tr><td>HCM6.1</td><td>6</td><td>Một vòng gọi vốn nên đủ dùng trong bao lâu?</td><td>8.1</td></tr>\n<tr><td>HCM6.2</td><td>6</td><td>Khi nào là thời điểm tốt để gọi vốn?</td><td>8.1</td></tr>\n<tr><td>HCM6.3</td><td>6</td><td>Vì sao lean startup?</td><td>6.1, 6.2</td></tr>\n<tr><td>HCM6.4</td><td>6</td><td>Nên mở đầu bài pitch thế nào?</td><td>9.1, 9.2</td></tr>\n<tr><td>HCM7.1</td><td>7</td><td>Vì sao startup đang lỗ lại được định giá cao?</td><td>8.1 (phải tự lập luận)</td></tr>\n<tr><td>HCM7.2</td><td>7</td><td>Startup có nên chia cổ tức không?</td><td>8.1 (phải tự lập luận)</td></tr>\n<tr><td>HCM7.3</td><td>7</td><td>Khác biệt giữa một mô hình và thứ thật là gì?</td><td>6.1, 7.1</td></tr>\n<tr><td>HCM7.4</td><td>7</td><td>Thời điểm tốt nhất và tệ nhất để gọi vốn là khi nào?</td><td>8.1</td></tr>\n</tbody>\n</table>\n\n<div class=\"pitfall\"><strong>Cách mất 15% này rẻ nhất:</strong> trả lời câu hỏi chung bằng nội dung chung. Cả 28 câu đều có thể trả lời từ chính tuần làm việc của đội bạn: cách chọn đội cho HCM2.2, các cuộc phỏng vấn cho HCM3.3, lần mini-launch cho HCM4.2, bảng chi phí cho HCM5.4. Giữ một trang nhật ký mỗi tuần thì câu trả lời tự viết ra.</div>\n<div class=\"callout ok\"><strong>Nhớ cái cổng:</strong> thành phần này có mốc hoàn thành <strong>5</strong>, giống mọi thành phần khác. Không thể lấy điểm cao ở Checkpoint 4 bù xuống.</div>\n</div>"
        },
        {
          "title": "The four checkpoints (10 / 20 / 15 / 40%) — what each is graded on|||Bốn checkpoint (10 / 20 / 15 / 40%) — mỗi cái chấm cái gì",
          "slug": "exe101-final-exam-fe",
          "type": "article",
          "description": "Bốn Group Assignment / Presentation checkpoint: trọng số, CLO, thời lượng 10–30 phút, mốc hoàn thành 5 mỗi cái, và bài học nào chuẩn bị cho cái nào. Kèm quiz tự kiểm.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Assessment · Checkpoints 1&ndash;4</span>\n<h2>Four oral checkpoints &mdash; 85% of the grade</h2>\n<p class=\"lead\">After the Constructivism Presentations (15%), the remaining 85% is four <strong>oral presentations</strong> of <strong>10&ndash;30 minutes</strong> each. Every one of them has a completion criterion of <strong>5</strong>. There is no written exam anywhere in EXE101.</p>\n<table>\n<thead><tr><th>Component (syllabus name)</th><th>Weight</th><th>Completion</th><th>Duration</th><th>CLO</th><th>What it must show</th><th>Prepare with</th></tr></thead>\n<tbody>\n<tr><td>Group Assignment 1 (Checkpoint 1)</td><td><strong>10%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO1, CLO2</td><td>Key aspects of your startup; the right team, formed from at least 2 majors, with roles and working agreement</td><td>1.1, 1.2, 2.1, 2.2, 3.1</td></tr>\n<tr><td>Group Assignment 2 (Checkpoint 2)</td><td><strong>20%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO3</td><td>Surveys and market research: real interviews, an unbiased questionnaire, sample size, competitors, TAM/SAM/SOM</td><td>3.2, 4.1, 4.2, 5.1, 5.2</td></tr>\n<tr><td>Group Assignment 3 (Checkpoint 3)</td><td><strong>15%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO4</td><td>The right product and a reasonable business model: MVP built and shown, revenue and cost structure</td><td>6.1, 6.2, 7.1, 7.2</td></tr>\n<tr><td>Presentation (Checkpoint 4)</td><td><strong>40%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO5</td><td>A preliminary pitch deck and a convincing presentation &mdash; session 18 &ldquo;introduce your startup&rdquo; (week 10)</td><td>9.1, 9.2, 9.3</td></tr>\n</tbody>\n</table>\n\n<div class=\"callout\"><strong>What the syllabus does <em>not</em> publish:</strong> a per-checkpoint rubric or a required slide list. The mapping above follows the CLO attached to each row in the assessment table plus the weekly session titles &mdash; treat it as the reliable skeleton and confirm the exact deliverable with your instructor at the start of the term.</div>\n\n<h3>Rules that apply to all four</h3>\n<ul>\n<li><strong>Attendance &ge; 80%</strong> of coaching sessions, seminars and mentoring &mdash; a hard gate.</li>\n<li><strong>Teams of 4&ndash;6 from at least 2 different majors</strong> &mdash; a syllabus requirement, not a preference.</li>\n<li><strong>Every component must reach 5.</strong> A weak Checkpoint 2 is not rescued by a strong Checkpoint 4.</li>\n<li>Mentoring sessions (1 compulsory pair plus up to 3 optional) exist precisely to de-risk the next checkpoint &mdash; bring evidence, not slides.</li>\n</ul>\n\n<div class=\"callout\"><span class=\"badge\">Self-check</span> The quiz below reviews core ideas from the course. It is practice, not an exam &mdash; EXE101 has none.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Đánh giá · Checkpoint 1&ndash;4</span>\n<h2>Bốn checkpoint nói miệng &mdash; 85% điểm</h2>\n<p class=\"lead\">Sau Constructivism Presentations (15%), 85% còn lại là bốn buổi <strong>thuyết trình miệng</strong> mỗi buổi <strong>10&ndash;30 phút</strong>. Mỗi buổi đều có mốc hoàn thành <strong>5</strong>. EXE101 không có bài thi viết nào.</p>\n<table>\n<thead><tr><th>Thành phần (tên syllabus)</th><th>Trọng số</th><th>Mốc</th><th>Thời lượng</th><th>CLO</th><th>Phải cho thấy gì</th><th>Chuẩn bị bằng</th></tr></thead>\n<tbody>\n<tr><td>Group Assignment 1 (Checkpoint 1)</td><td><strong>10%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO1, CLO2</td><td>Các khía cạnh cốt lõi của startup; đội đúng người, gồm ít nhất 2 chuyên ngành, có phân vai và quy ước làm việc</td><td>1.1, 1.2, 2.1, 2.2, 3.1</td></tr>\n<tr><td>Group Assignment 2 (Checkpoint 2)</td><td><strong>20%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO3</td><td>Khảo sát và nghiên cứu thị trường: phỏng vấn thật, bảng hỏi không thiên lệch, cỡ mẫu, đối thủ, TAM/SAM/SOM</td><td>3.2, 4.1, 4.2, 5.1, 5.2</td></tr>\n<tr><td>Group Assignment 3 (Checkpoint 3)</td><td><strong>15%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO4</td><td>Sản phẩm đúng và mô hình kinh doanh hợp lý: MVP đã xây và trình diễn, cấu trúc doanh thu &amp; chi phí</td><td>6.1, 6.2, 7.1, 7.2</td></tr>\n<tr><td>Presentation (Checkpoint 4)</td><td><strong>40%</strong></td><td>5</td><td>10'&ndash;30'</td><td>CLO5</td><td>Pitch deck sơ bộ và phần trình bày thuyết phục &mdash; buổi 18 &ldquo;giới thiệu startup của bạn&rdquo; (tuần 10)</td><td>9.1, 9.2, 9.3</td></tr>\n</tbody>\n</table>\n\n<div class=\"callout\"><strong>Thứ syllabus <em>không</em> công bố:</strong> rubric chi tiết từng checkpoint hay danh sách slide bắt buộc. Bảng trên bám theo CLO gắn với từng dòng trong bảng đánh giá cộng với tên các buổi theo tuần &mdash; hãy coi đó là bộ khung đáng tin và xác nhận sản phẩm nộp cụ thể với giảng viên đầu kỳ.</div>\n\n<h3>Quy tắc áp cho cả bốn</h3>\n<ul>\n<li><strong>Điểm danh &ge; 80%</strong> các buổi coaching, seminar và mentoring &mdash; cổng cứng.</li>\n<li><strong>Đội 4&ndash;6 người từ ít nhất 2 chuyên ngành khác nhau</strong> &mdash; yêu cầu của syllabus, không phải sở thích.</li>\n<li><strong>Mỗi thành phần phải đạt 5.</strong> Checkpoint 2 yếu thì Checkpoint 4 mạnh cũng không cứu được.</li>\n<li>Các buổi mentoring (2 buổi bắt buộc, thêm tối đa 3 buổi tùy chọn) sinh ra đúng để giảm rủi ro cho checkpoint kế tiếp &mdash; mang bằng chứng đến, đừng mang slide.</li>\n</ul>\n\n<div class=\"callout\"><span class=\"badge\">Tự kiểm</span> Quiz dưới đây ôn lại các ý cốt lõi của môn. Đây là luyện tập, không phải đề thi &mdash; EXE101 không có bài thi nào.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
              ...
              },
              {
                ...
                "question": "A profitable café that grows by opening more branches is best described as:|||Một quán cà phê có lãi, tăng trưởng bằng cách mở thêm chi nhánh, được mô tả đúng nhất là:",
                "options": [
                  "A startup|||Một startup",
                  "An SME / small business|||Một SME / doanh nghiệp nhỏ",
                  "A unicorn|||Một kỳ lân",
                  "A non-profit|||Một tổ chức phi lợi nhuận"
                ],
                "correctIndex": 1
              },
              {
