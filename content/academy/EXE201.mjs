...
<div class="callout"><span class="badge">★ Ngoài giáo trình</span> <b>Tăng trưởng = retention trước, rồi acquisition, rồi kiếm tiền — đúng thứ tự đó.</b> Đổ acquisition vào retention yếu là phí tiền; kiếm tiền trước khi có giá trị là đuổi người dùng đi. Trình tự khỏe mạnh là sửa giá trị → giữ người dùng → tăng người dùng → rồi mới kiếm. <em>Trình tự chiến lược ngoài syllabus mà nhiều startup có vốn đã làm sai chí mạng.</em></div>
    ...
    {
      "title": "Assessment — the three outcomes|||Đánh giá — ba outcome",
      "description": "EXE201 KHÔNG có thi cuối kỳ. Toàn bộ điểm đến từ ba outcome on-going: demo sản phẩm 40%, thuyết trình kế hoạch thu hút khách 20%, báo cáo tăng trưởng 40% (mốc hoàn thành 4).",
      "lessons": [
        {
          "title": "No final exam — Outcome 1 & Outcome 2|||Không có thi cuối kỳ — Outcome 1 & Outcome 2",
          "slug": "exe201-final-exam-pe",
          "type": "article",
          "description": "EXE201 không có bài thi nào. Ba thành phần on-going theo syllabus; bài này nói kỹ Outcome 1 (demo sản phẩm 40%) và Outcome 2 (thuyết trình acquisition 20%, buổi 8 tuần 5).",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Assessment · Outcomes 1 &amp; 2</span>\n<h2>EXE201 has no final exam</h2>\n<p class=\"lead\">The syllabus (sylID 10361) lists <strong>exactly three assessment components, and all three are on-going</strong>: Outcome 1 (40%), Outcome 2 (20%) and Outcome 3 (40%). There is <strong>no final exam, no practical exam and no multiple-choice test</strong>. Everything you are graded on is something your team produces and presents.</p>\n<table>\n<thead><tr><th>Component</th><th>Type</th><th>Weight</th><th>Completion</th><th>Duration</th><th>CLO</th><th>Form</th></tr></thead>\n<tbody>\n<tr><td>Outcome 1</td><td>on-going</td><td><strong>40%</strong></td><td>&gt; 0</td><td>no limit</td><td>CLO1</td><td>Product/service demonstration</td></tr>\n<tr><td>Outcome 2</td><td>on-going</td><td><strong>20%</strong></td><td>&gt; 0</td><td>no limit</td><td>CLO2</td><td>Presentation</td></tr>\n<tr><td>Outcome 3</td><td>on-going</td><td><strong>40%</strong></td><td><strong>4</strong></td><td>no limit</td><td>CLO3, CLO4</td><td>Reports</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><strong>Correction.</strong> An earlier version of this page described a written &ldquo;PE&rdquo; and a computer-graded &ldquo;FE&rdquo;. Neither exists in EXE201. Spend your preparation on deliverables, not on exam technique.</div>\n\n<h3>Outcome 1 &mdash; product/service demonstration (40%, CLO1)</h3>\n<p>You demonstrate a <strong>real, usable</strong> product or service. &ldquo;No limit&rdquo; in the Duration column means it is not a timed exam slot &mdash; but plan a tight 5&ndash;8 minute run so the assessor sees the core loop working end to end.</p>\n<ul>\n<li>Show the core loop <em>live</em>, on a real device with real data &mdash; not slides of screenshots.</li>\n<li>Keep a fallback recording ready in case the network or the build fails on the day.</li>\n<li>Say plainly what is built and what is still mocked. An honest boundary scores better than a discovered fake.</li>\n<li>Name who has used it and what they did with it &mdash; CLO1 is &ldquo;build a physical product/service&rdquo;, and usage is the proof it exists.</li>\n</ul>\n\n<h3>Outcome 2 &mdash; customer acquisition presentation (20%, CLO2)</h3>\n<p>The syllabus schedules the <strong>Outcome 2 presentation in session 8 (week 5)</strong>, straight after the session &ldquo;How to get your first ten customers&rdquo;. You present the acquisition plan: who the customer is, which channels you will use, the message, the funnel and the numbers you expect.</p>\n<ul>\n<li>One slide per channel: what you will do, what it costs, the conversion you expect, how you will measure it.</li>\n<li>Show the message you actually tested, not a slogan invented that morning.</li>\n<li>Bring first evidence &mdash; even ten conversations &mdash; so the plan is grounded rather than imagined.</li>\n</ul>\n\n<div class=\"callout ok\"><strong>Where the marks live:</strong> Outcomes 1 and 3 are 80% of the grade and both require a <em>shipped thing</em>. A team that plans perfectly and never launches cannot pass them. Outcome 3 &mdash; the only component with a hard gate &mdash; is the next lesson.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Đánh giá · Outcome 1 &amp; 2</span>\n<h2>EXE201 không có thi cuối kỳ</h2>\n<p class=\"lead\">Syllabus (sylID 10361) liệt kê <strong>đúng ba thành phần đánh giá, cả ba đều on-going</strong>: Outcome 1 (40%), Outcome 2 (20%) và Outcome 3 (40%). <strong>Không có thi cuối kỳ, không có thi thực hành, không có bài trắc nghiệm</strong>. Mọi thứ bạn bị chấm đều là thứ đội bạn làm ra và trình bày.</p>\n<table>\n<thead><tr><th>Thành phần</th><th>Loại</th><th>Trọng số</th><th>Mốc hoàn thành</th><th>Thời lượng</th><th>CLO</th><th>Hình thức</th></tr></thead>\n<tbody>\n<tr><td>Outcome 1</td><td>on-going</td><td><strong>40%</strong></td><td>&gt; 0</td><td>không giới hạn</td><td>CLO1</td><td>Trình diễn sản phẩm/dịch vụ</td></tr>\n<tr><td>Outcome 2</td><td>on-going</td><td><strong>20%</strong></td><td>&gt; 0</td><td>không giới hạn</td><td>CLO2</td><td>Thuyết trình</td></tr>\n<tr><td>Outcome 3</td><td>on-going</td><td><strong>40%</strong></td><td><strong>4</strong></td><td>không giới hạn</td><td>CLO3, CLO4</td><td>Báo cáo</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><strong>Đính chính.</strong> Bản trước của trang này mô tả một bài &ldquo;PE&rdquo; viết luận và một bài &ldquo;FE&rdquo; trắc nghiệm máy chấm. EXE201 không có cả hai. Hãy dồn công sức vào sản phẩm nộp, không phải vào kỹ thuật đi thi.</div>\n\n<h3>Outcome 1 &mdash; trình diễn sản phẩm/dịch vụ (40%, CLO1)</h3>\n<p>Bạn trình diễn một sản phẩm hoặc dịch vụ <strong>thật, dùng được</strong>. Cột Thời lượng ghi &ldquo;không giới hạn&rdquo; nghĩa là đây không phải ca thi bấm giờ &mdash; nhưng hãy dựng một mạch chạy gọn 5&ndash;8 phút để người chấm thấy vòng lõi chạy từ đầu đến cuối.</p>\n<ul>\n<li>Chạy vòng lõi <em>trực tiếp</em>, trên thiết bị thật với dữ liệu thật &mdash; không phải slide chụp màn hình.</li>\n<li>Thủ sẵn một bản ghi màn hình phòng khi mạng hoặc bản build hỏng đúng hôm đó.</li>\n<li>Nói thẳng phần nào đã xây, phần nào còn giả lập. Ranh giới trung thực được điểm cao hơn một chỗ giả bị phát hiện.</li>\n<li>Nêu ai đã dùng và họ làm gì với nó &mdash; CLO1 là &ldquo;xây sản phẩm/dịch vụ thật&rdquo;, và người dùng chính là bằng chứng nó tồn tại.</li>\n</ul>\n\n<h3>Outcome 2 &mdash; thuyết trình kế hoạch thu hút khách (20%, CLO2)</h3>\n<p>Syllabus xếp <strong>buổi thuyết trình Outcome 2 vào buổi 8 (tuần 5)</strong>, ngay sau buổi &ldquo;How to get your first ten customers&rdquo;. Bạn trình bày kế hoạch acquisition: khách hàng là ai, dùng kênh nào, thông điệp gì, phễu ra sao và các con số bạn kỳ vọng.</p>\n<ul>\n<li>Mỗi kênh một slide: bạn sẽ làm gì, tốn bao nhiêu, kỳ vọng chuyển đổi bao nhiêu, đo bằng cách nào.</li>\n<li>Đưa thông điệp bạn đã thật sự test, không phải khẩu hiệu nghĩ ra sáng hôm đó.</li>\n<li>Mang bằng chứng đầu tiên &mdash; kể cả mười cuộc nói chuyện &mdash; để kế hoạch có gốc chứ không phải tưởng tượng.</li>\n</ul>\n\n<div class=\"callout ok\"><strong>Điểm nằm ở đâu:</strong> Outcome 1 và 3 chiếm 80% và cả hai đều đòi một <em>thứ đã ra mắt</em>. Đội lập kế hoạch hoàn hảo mà không bao giờ launch thì không qua được hai phần này. Outcome 3 &mdash; thành phần duy nhất có cổng cứng &mdash; là bài kế tiếp.</div>\n</div>"
        },
        {
          "title": "Outcome 3 — reports, feedback analysis & the final evaluation|||Outcome 3 — báo cáo, phân tích phản hồi & buổi đánh giá cuối",
          "slug": "exe201-final-exam-fe",
          "type": "article",
          "description": "Outcome 3 (40%, CLO3+CLO4) là thành phần duy nhất có cổng: mốc hoàn thành 4. Nội dung báo cáo, lịch đánh giá buổi 18 và cơ hội launch lại tuần 11–14. Kèm quiz tự kiểm.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Assessment · Outcome 3</span>\n<h2>Outcome 3 &mdash; the only component with a gate</h2>\n<p class=\"lead\">Outcome 3 is worth <strong>40%</strong>, is assessed as <strong>Reports</strong>, and covers <strong>CLO3 (launch the product on different channels)</strong> and <strong>CLO4 (analyze feedback from the channels)</strong>. Its syllabus completion criterion is <strong>4</strong> &mdash; the other two outcomes only need &gt; 0. Score below 4 here and you do not pass EXE201, however good the demo was.</p>\n\n<h3>What the reports have to contain</h3>\n<table>\n<thead><tr><th>Part</th><th>CLO</th><th>Evidence that counts</th></tr></thead>\n<tbody>\n<tr><td>Launch log</td><td>CLO3</td><td>Date, channel, what you posted/did, reach &mdash; one row per launch, several channels</td></tr>\n<tr><td>Channel results</td><td>CLO3</td><td>Visitors &rarr; signups &rarr; activated &rarr; returning, per channel, weekly</td></tr>\n<tr><td>Feedback collected</td><td>CLO4</td><td>Raw quotes, ratings, support messages, churn reasons &mdash; with their source</td></tr>\n<tr><td>Analysis</td><td>CLO4</td><td>Themes grouped and counted, not anecdotes; what the numbers say the problem is</td></tr>\n<tr><td>Change &rarr; result loop</td><td>CLO4</td><td>&ldquo;We saw X &rarr; we changed Y &rarr; the metric moved from A to B&rdquo;, at least twice</td></tr>\n</tbody>\n</table>\n\n<h3>The schedule that decides it</h3>\n<ul>\n<li><strong>Session 18 (week 10, offline):</strong> all groups are evaluated.</li>\n<li><strong>Sessions in weeks 11&ndash;14:</strong> the syllabus explicitly allows you to <em>relaunch and approach customers again if you previously failed</em>. A weak week 10 is recoverable &mdash; but only if you actually run another launch and report it.</li>\n<li>Attendance of coaching, seminars and mentoring must be <strong>&ge; 80%</strong>.</li>\n</ul>\n\n<div class=\"pitfall\"><strong>The usual way to lose Outcome 3:</strong> one launch, one channel, one screenshot of likes. Three channels with honest small numbers and two documented changes beat one channel with a big vanity spike.</div>\n<div class=\"callout\"><span class=\"badge\">Self-check</span> The quiz below is a quick review of the course&rsquo;s core ideas. It is practice, not an exam &mdash; EXE201 has none.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Đánh giá · Outcome 3</span>\n<h2>Outcome 3 &mdash; thành phần duy nhất có cổng</h2>\n<p class=\"lead\">Outcome 3 chiếm <strong>40%</strong>, chấm dưới dạng <strong>Báo cáo</strong>, phủ <strong>CLO3 (launch sản phẩm trên nhiều kênh)</strong> và <strong>CLO4 (phân tích phản hồi từ các kênh)</strong>. Mốc hoàn thành theo syllabus là <strong>4</strong> &mdash; hai outcome kia chỉ cần &gt; 0. Dưới 4 ở đây là không qua môn, dù bản demo có tốt đến đâu.</p>\n\n<h3>Báo cáo phải có gì</h3>\n<table>\n<thead><tr><th>Phần</th><th>CLO</th><th>Bằng chứng được tính</th></tr></thead>\n<tbody>\n<tr><td>Nhật ký launch</td><td>CLO3</td><td>Ngày, kênh, bạn đăng/làm gì, tiếp cận bao nhiêu &mdash; mỗi lần launch một dòng, nhiều kênh</td></tr>\n<tr><td>Kết quả theo kênh</td><td>CLO3</td><td>Lượt xem &rarr; đăng ký &rarr; kích hoạt &rarr; quay lại, theo từng kênh, theo tuần</td></tr>\n<tr><td>Phản hồi thu được</td><td>CLO4</td><td>Trích nguyên văn, đánh giá, tin nhắn hỗ trợ, lý do rời bỏ &mdash; kèm nguồn</td></tr>\n<tr><td>Phân tích</td><td>CLO4</td><td>Gom nhóm và đếm chủ đề, không kể giai thoại; số liệu nói vấn đề nằm ở đâu</td></tr>\n<tr><td>Vòng thay đổi &rarr; kết quả</td><td>CLO4</td><td>&ldquo;Thấy X &rarr; đổi Y &rarr; chỉ số đi từ A lên B&rdquo;, ít nhất hai lần</td></tr>\n</tbody>\n</table>\n\n<h3>Lịch quyết định điểm</h3>\n<ul>\n<li><strong>Buổi 18 (tuần 10, offline):</strong> đánh giá tất cả các nhóm.</li>\n<li><strong>Các buổi tuần 11&ndash;14:</strong> syllabus cho phép rõ ràng <em>launch lại và tiếp cận khách hàng lần nữa nếu lần trước thất bại</em>. Tuần 10 yếu vẫn cứu được &mdash; nhưng chỉ khi bạn thật sự chạy thêm một lần launch và báo cáo nó.</li>\n<li>Điểm danh coaching, seminar và mentoring phải <strong>&ge; 80%</strong>.</li>\n</ul>\n\n<div class=\"pitfall\"><strong>Cách mất điểm Outcome 3 quen thuộc nhất:</strong> một lần launch, một kênh, một ảnh chụp số like. Ba kênh với con số nhỏ trung thực và hai thay đổi có ghi chép thắng một kênh với đỉnh phù phiếm.</div>\n<div class=\"callout\"><span class=\"badge\">Tự kiểm</span> Quiz dưới đây ôn nhanh các ý cốt lõi của môn. Đây là luyện tập, không phải đề thi &mdash; EXE201 không có bài thi nào.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
