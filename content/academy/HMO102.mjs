/**
 * HMO102 — Introduction to Tourism &amp; Hospitality industry.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — khối Quản trị Kinh doanh, semester 1. Lessons are not written yet.|||Môn trong khung chương trình FPTU — khối Quản trị Kinh doanh, kỳ 1. Bài giảng chưa được dựng.',
    description: 'Môn <strong>HMO102 — Introduction to Tourism &amp;amp; Hospitality industry</strong> thuộc khung chương trình khối Quản trị Kinh doanh, kỳ 1.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
