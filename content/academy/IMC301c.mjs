/**
 * IMC301c — Integrated Marketing Communication in Digital World.
...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>IMC301c — Integrated Marketing Communication in Digital World</strong> thuộc khung chương trình khối Quản trị Kinh doanh, kỳ 3.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
