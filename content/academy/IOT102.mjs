...
<div class="lz-map">
  ...
  <div class="lz-stage">Core — and where the marks are</div>
  <div class="lz-node"><div class="lz-badge">8</div><div class="lz-nbody"><div class="lz-ntitle">Interrupts (CLO13, sessions 40 &amp; 45)</div><div class="lz-nsub">External &amp; timer interrupts · millis()</div></div></div>
  <div class="lz-node"><div class="lz-badge">10</div><div class="lz-nbody"><div class="lz-ntitle">IoT security (CLO4, sessions 16–17)</div><div class="lz-nsub">Threats · defences</div></div></div>
  <div class="lz-node"><div class="lz-badge">11</div><div class="lz-nbody"><div class="lz-ntitle">The project — 50% of your grade</div><div class="lz-nsub">30% on-going assessment + 20% final presentation</div></div></div>
</div>
...
<div class="lz-map">
  ...
  <div class="lz-stage">Nội dung chính — và là nơi có điểm</div>
  <div class="lz-node"><div class="lz-badge">8</div><div class="lz-nbody"><div class="lz-ntitle">Ngắt (CLO13, buổi 40 &amp; 45)</div><div class="lz-nsub">Ngắt ngoài &amp; ngắt timer · millis()</div></div></div>
  <div class="lz-node"><div class="lz-badge">10</div><div class="lz-nbody"><div class="lz-ntitle">Bảo mật IoT (CLO4, buổi 16–17)</div><div class="lz-nsub">Mối đe doạ · phòng vệ</div></div></div>
  <div class="lz-node"><div class="lz-badge">11</div><div class="lz-nbody"><div class="lz-ntitle">Đồ án — 50% điểm môn</div><div class="lz-nsub">30% chấm tiến độ + 20% bảo vệ cuối kỳ</div></div></div>
</div>
...
<table>
  <thead><tr><th>Component</th><th>Parts</th><th>Weight</th><th>Completion criterion</th><th>Duration / note</th></tr></thead>
  <tbody>
    <tr><td>Active learning</td><td>1</td><td>10%</td><td>&gt; 0</td><td>from start to finish — participation in class + at-home labs</td></tr>
    <tr><td>Progress test <small>(home practice, exercises, quiz)</small></td><td>2</td><td>10%</td><td>&gt; 0</td><td>30 min each — sessions 34 &amp; 52</td></tr>
    <tr><td>Presentation</td><td>1</td><td>10%</td><td>&gt; 0</td><td>group or individual — sessions 26–27</td></tr>
    <tr><td>On-going Project Assessment</td><td>2</td><td><b>30%</b></td><td>&gt; 0</td><td>checkpoints on your project — sessions 46–47 &amp; 56–57</td></tr>
    <tr><td>Final Project Presentation</td><td>1</td><td><b>20%</b></td><td><b>&ge; 4</b></td><td>30 min per group</td></tr>
    <tr><td>Final exam</td><td>1</td><td>20%</td><td><b>&ge; 4</b></td><td>60 min <small>(the syllabus states no question format)</small></td></tr>
  </tbody>
</table>
...
<div class="callout warn"><b>An average of 5.0 is not enough on its own.</b> Every component carries a completion criterion: the four on-going ones must be <strong>&gt; 0</strong> (a zero on any of them blocks you, however high the rest), and both <strong>Final Project Presentation</strong> and <strong>Final exam</strong> must reach <strong>4</strong>. On top of that you must attend <strong>at least 80% of contact sessions</strong> to be accepted to the final examination.</div>

<div class="callout warn">Two duties every week: <strong>watch the online theory videos</strong> and <strong>do the labs</strong> at home. Labs are checked in class ("Practice at home Evaluation" appears in 12 sessions — 13, 14, 28, 32, 33, 38, 39, 40, 45, 50, 51, 55) — arriving with nothing built costs you the Active learning and Progress test marks directly.</div>
...
<table>
  <thead><tr><th>Thành phần</th><th>Số lần</th><th>Trọng số</th><th>Điều kiện hoàn thành</th><th>Thời lượng / ghi chú</th></tr></thead>
  <tbody>
    <tr><td>Active learning <small>(học tích cực)</small></td><td>1</td><td>10%</td><td>&gt; 0</td><td>xuyên suốt kỳ — tham gia trên lớp + lab ở nhà</td></tr>
    <tr><td>Progress test <small>(kiểm tra lab về nhà, bài tập, quiz)</small></td><td>2</td><td>10%</td><td>&gt; 0</td><td>30 phút mỗi lần — buổi 34 &amp; 52</td></tr>
    <tr><td>Presentation <small>(thuyết trình)</small></td><td>1</td><td>10%</td><td>&gt; 0</td><td>nhóm hoặc cá nhân — buổi 26–27</td></tr>
    <tr><td>On-going Project Assessment <small>(chấm tiến độ đồ án)</small></td><td>2</td><td><b>30%</b></td><td>&gt; 0</td><td>các mốc kiểm tra đồ án — buổi 46–47 &amp; 56–57</td></tr>
    <tr><td>Final Project Presentation <small>(bảo vệ đồ án)</small></td><td>1</td><td><b>20%</b></td><td><b>≥ 4</b></td><td>30 phút mỗi nhóm</td></tr>
    <tr><td>Thi cuối kỳ</td><td>1</td><td>20%</td><td><b>≥ 4</b></td><td>60 phút <small>(syllabus không nêu dạng câu hỏi)</small></td></tr>
  </tbody>
</table>
...
<div class="callout warn"><b>Trung bình 5.0 thôi chưa đủ.</b> Mỗi cột điểm đều có điều kiện hoàn thành riêng: bốn cột quá trình phải <strong>&gt; 0</strong> (một điểm 0 ở bất kỳ cột nào là chặn, dù các cột khác cao tới đâu), và cả <strong>bảo vệ đồ án cuối kỳ</strong> lẫn <strong>thi cuối kỳ</strong> phải đạt <strong>4</strong>. Ngoài ra phải dự <strong>tối thiểu 80% số buổi trên lớp</strong> mới đủ điều kiện dự thi cuối kỳ.</div>

<div class="callout warn">Hai nhiệm vụ mỗi tuần: <strong>xem video lý thuyết online</strong> và <strong>làm lab</strong> ở nhà. Lab bị kiểm trên lớp ("Practice at home Evaluation" xuất hiện ở 12 buổi — 13, 14, 28, 32, 33, 38, 39, 40, 45, 50, 51, 55) — đến lớp tay không là mất thẳng điểm Active learning và Progress test.</div>
...
`,
    ...
    /* ══════════════════ NÂNG CAO ══════════════════ */
    {
      ...
      description: 'Học thêm SAU môn: ESP32/FreeRTOS, ngủ sâu chạy pin nhiều năm, cập nhật OTA, TinyML. (Ngắt = chương 8, bảo mật IoT = chương 10, đồ án = chương 11 — cả ba đều là nội dung CHÍNH của giáo trình.)',
      lessons: [
        {
...
`,
    ...
    /* END-SECTIONS-MARKER */
    {
      ...
      "description": "Thi cuối kỳ chỉ chiếm 20% (60 phút, phải ≥ 4); 50% điểm nằm ở đồ án. Khung + câu mẫu; đề thật thêm sau khi có trang phòng thi.",
      "lessons": [
        {
          "title": "No Practical Exam — the project is the practical work|||Không có thi thực hành — đồ án là phần thực hành",
          "slug": "iot102-final-exam-pe",
          "type": "article",
          "description": "Vì sao IOT102 KHÔNG có PE: 6 đầu điểm của syllabus và chỗ 50% điểm thực hành thật sự nằm (đồ án 30% + bảo vệ 20%).",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · no PE</span>\n<h2>IOT102 has no Practical Exam — the project is the practical work</h2>\n<p class=\"lead\">This page corrects a common expectation: <strong>&quot;PE&quot; is not one of IOT102&#39;s assessments.</strong> The syllabus lists exactly <strong>six</strong>: Active learning 10% · Progress test (2 parts) 10% · Presentation 10% · On-Going Project Assessment (2 parts) 30% · Final Project Presentation 20% · Final exam 20% (60&#39;). There is no timed hands-on coding exam anywhere in that list.</p>\n<h3>Where the &quot;practical&quot; marks really are</h3>\n<table>\n  <thead><tr><th>Component</th><th>Weight</th><th>Completion</th><th>What you actually do</th></tr></thead>\n  <tbody>\n    <tr><td>On-Going Project Assessment <small>(2 parts)</small></td><td><b>30%</b></td><td>&gt; 0</td><td>Your project is inspected at checkpoints (sessions 46–47 and 56–57): wiring, code, progress against the plan.</td></tr>\n    <tr><td>Final Project Presentation</td><td><b>20%</b></td><td><b>&ge; 4</b></td><td>30 minutes per group: demo the device, explain the circuit and the code, answer questions.</td></tr>\n    <tr><td>Active learning + Progress test</td><td>20%</td><td>&gt; 0</td><td>&quot;Practice at home&quot; labs checked in class (12 sessions) and two 30&#39; progress tests.</td></tr>\n  </tbody>\n</table>\n<p><strong>Half your grade is the project.</strong> That is the practical exam of this subject — it just runs across the whole semester instead of a single sitting, and it is graded on a working device, not on a compiled file.</p>\n<h3>How to prepare for it</h3>\n<ul>\n<li>Register your topic early (the syllabus registers topics at session 15) and keep a build log; the on-going assessment rewards visible progress, not a last-week sprint.</li>\n<li>Rebuild the course labs from a blank sketch <em>without notes</em> — digital I/O, analogRead, a sensor, a servo, serial output. Everything in the project is a combination of them.</li>\n<li>Get the smallest version working end to end first (sense &rarr; decide &rarr; act), then add features. A device that does 80% and runs beats an ambitious one that does not.</li>\n<li>Prepare the presentation like a demo, not a slide deck: circuit diagram, flowchart (lesson 11.2), live run, then the code.</li>\n<li>Remember the gates: the Final Project Presentation must reach <strong>4</strong>, and each on-going component must be <strong>&gt; 0</strong>.</li>\n</ul>\n<div class=\"callout\">For the one written paper this subject does have — the <strong>Final exam, 20%, 60 minutes, completion criterion 4</strong> — see the FE page next to this one.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · không có PE</span>\n<h2>IOT102 KHÔNG có thi thực hành — đồ án chính là phần thực hành</h2>\n<p class=\"lead\">Trang này đính chính một hiểu nhầm phổ biến: <strong>&quot;PE&quot; không nằm trong các đầu điểm của IOT102.</strong> Syllabus liệt kê đúng <strong>sáu</strong> cột: Active learning 10% · Progress test (2 lần) 10% · Presentation 10% · On-Going Project Assessment (2 lần) 30% · Bảo vệ đồ án cuối kỳ 20% · Thi cuối kỳ 20% (60&#39;). Không có bài thi code bấm giờ nào trong danh sách đó.</p>\n<h3>Điểm &quot;thực hành&quot; thật ra nằm ở đâu</h3>\n<table>\n  <thead><tr><th>Thành phần</th><th>Trọng số</th><th>Điều kiện</th><th>Bạn thật sự làm gì</th></tr></thead>\n  <tbody>\n    <tr><td>Chấm tiến độ đồ án <small>(2 lần)</small></td><td><b>30%</b></td><td>&gt; 0</td><td>Đồ án bị soi ở các mốc (buổi 46–47 và 56–57): đấu nối, code, tiến độ so với kế hoạch.</td></tr>\n    <tr><td>Bảo vệ đồ án cuối kỳ</td><td><b>20%</b></td><td><b>≥ 4</b></td><td>30 phút mỗi nhóm: chạy demo thiết bị, giải thích mạch và code, trả lời câu hỏi.</td></tr>\n    <tr><td>Active learning + Progress test</td><td>20%</td><td>&gt; 0</td><td>Lab &quot;làm ở nhà&quot; bị kiểm trên lớp (12 buổi) và hai bài progress test 30&#39;.</td></tr>\n  </tbody>\n</table>\n<p><strong>Một nửa điểm môn là đồ án.</strong> Đó chính là bài thi thực hành của môn này — chỉ khác là nó trải suốt kỳ thay vì một buổi, và chấm trên một thiết bị chạy được chứ không phải một file biên dịch xong.</p>\n<h3>Chuẩn bị thế nào</h3>\n<ul>\n<li>Đăng ký đề tài sớm (syllabus đăng ký đề tài ở buổi 15) và giữ nhật ký làm việc; chấm tiến độ thưởng cho tiến bộ thấy được, không thưởng cho việc cày dồn tuần cuối.</li>\n<li>Dựng lại các lab của môn từ một sketch trống, <em>không nhìn ghi chú</em> — vào/ra số, analogRead, một cảm biến, một servo, xuất serial. Mọi thứ trong đồ án đều là tổ hợp của chúng.</li>\n<li>Cho bản nhỏ nhất chạy thông đầu-cuối trước (cảm nhận &rarr; quyết định &rarr; tác động), rồi mới thêm tính năng. Một thiết bị làm được 80% mà chạy hơn một thiết bị tham vọng mà không chạy.</li>\n<li>Chuẩn bị buổi bảo vệ như một buổi demo, không phải một tập slide: sơ đồ mạch, lưu đồ (bài 11.2), chạy trực tiếp, rồi tới code.</li>\n<li>Nhớ các chốt: bảo vệ đồ án phải đạt <strong>4</strong>, và mỗi cột quá trình phải <strong>&gt; 0</strong>.</li>\n</ul>\n<div class=\"callout\">Bài viết duy nhất môn này có — <strong>Thi cuối kỳ, 20%, 60 phút, điều kiện hoàn thành 4</strong> — xem trang FE ngay bên cạnh.</div>\n</div>"
        },
        {
          ...
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · FE</span>\n<h2>FE — Final Exam (Multiple Choice)</h2>\n<p class=\"lead\">The Final exam of IOT102 is worth <strong>20% of the mark</strong>, lasts <strong>60 minutes</strong> and has completion criterion <strong>4</strong> — you must reach 4 on it, whatever the project scored. The syllabus does <strong>not</strong> state the question format, so ask your instructor; the sample items below are multiple choice because that is the usual shape, not because the syllabus says so. The other 80% (and the 50% that is the project) is described in <em>Lesson 0.2 — Grading</em>.</p>\n<h3>How to do well</h3>\n<ul>\n<li>Pace yourself: divide time by the number of questions; flag hard ones and return at the end.</li>\n<li>Eliminate clearly wrong options first, then choose among the rest.</li>\n<li>For \"what should you do / which is best\" items, answer by this subject's method, not gut feeling.</li>\n<li>Never leave the gated final blank &mdash; an educated guess beats an empty answer.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Sample</span> The questions below are <strong>sample questions</strong> drawn from this course to show the format. The <em>real past-exam questions</em> will be added here later, in the exam room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · FE</span>\n<h2>FE — Thi trắc nghiệm cuối kỳ</h2>\n<p class=\"lead\">Thi cuối kỳ IOT102 chiếm <strong>20% điểm</strong>, kéo dài <strong>60 phút</strong> và có điều kiện hoàn thành <strong>4</strong> — phải đạt 4 dù đồ án được bao nhiêu. Syllabus <strong>không</strong> nêu dạng câu hỏi, nên hãy hỏi giảng viên; các câu mẫu dưới đây là trắc nghiệm vì đó là dạng thường gặp, không phải vì syllabus ghi thế. 80% còn lại (trong đó 50% là đồ án) xem <em>Bài 0.2 — Thang điểm</em>.</p>\n<h3>Cách làm tốt</h3>\n<ul>\n<li>Phân bổ thời gian: chia đều theo số câu; đánh dấu câu khó, quay lại ở cuối.</li>\n<li>Loại phương án sai rõ ràng trước, rồi chọn trong số còn lại.</li>\n<li>Câu \"nên làm gì / cái nào tốt nhất\" &mdash; trả lời theo phương pháp của môn, không theo cảm tính.</li>\n<li>Đừng bao giờ bỏ trống bài thi có cổng &mdash; đoán có suy luận vẫn hơn để trống.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Câu mẫu</span> Các câu dưới đây là <strong>câu mẫu</strong> lấy từ chính môn học để minh hoạ format. <em>Đề thi thật</em> sẽ được thêm vào đây sau, trong trang phòng thi.</div>\n</div>",
          "quiz": {
