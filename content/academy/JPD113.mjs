 ...
 * Mục tiêu A1.1: kana thành thạo, 200 từ vựng, 23 cấu trúc ngữ pháp (CLO2), 35 kanji, tự giới thiệu.
...
export default {
  ...
  course: {
    ...
    language: 'Vietnamese',
    status: 'PUBLISHED',
    shortDescription: 'Your first step into Japanese: read and write both kana alphabets (hiragana & katakana), learn 200 words and 35 kanji, master the 23 grammar structures of CLO2, and introduce yourself. Practise every character and word on My Language.|||Bước đầu vào tiếng Nhật: đọc & viết cả hai bảng kana (hiragana & katakana), học ~200 từ và 35 kanji, thành thạo 23 cấu trúc ngữ pháp, và tự giới thiệu. Luyện từng chữ và từ trên My Language.',
    description: 'Môn nhập môn tiếng Nhật trình độ A1.1, không yêu cầu biết trước. Bạn sẽ đọc và viết thành thạo hai bảng chữ cái kana (hiragana - chữ mềm và katakana - chữ cứng), ghi nhớ khoảng 200 từ vựng cơ bản, 35 chữ Hán (kanji), và 23 cấu trúc ngữ pháp, đủ để tự giới thiệu bản thân và đọc đoạn văn ngắn. Giáo trình theo bộ できる日本語 (Dekiru Nihongo). Tiên quyết: không.',
    whatYouLearn: 'Đọc & viết Hiragana (chữ mềm) và Katakana (chữ cứng) đầy đủ; âm đục/bán đục, âm ghép, trường âm, âm ngắt; chào hỏi và câu dùng trong lớp; số đếm; ~200 từ vựng chủ đề; 23 cấu trúc ngữ pháp sơ cấp (は, の, です, これ/それ/あれ, ここ/そこ/あそこ, Nをください, Vます/Vません…); 35 chữ Hán cơ bản; tự giới thiệu bản thân; và đọc đoạn văn ngắn.',
...
<p>The goal by the end, in the syllabus&#39;s own words (CLO2): read and write both kana fluently, and memorise <strong>200 words, 23 grammar structures and 35 kanji</strong>. It is very achievable with daily practice — Japanese rewards little-and-often.</p>
<h3>Study map</h3>
<div class="lz-map">
  ...
  <div class="lz-node"><div class="lz-badge">5</div><div class="lz-nbody"><div class="lz-ntitle">Lessons 2–3 — this/that, places &amp; shopping</div><div class="lz-nsub">これ/それ/あれ · ここ/そこ/あそこ · このN · Nをください &nbsp;(+ あります/います, extra)</div></div></div>
...
<p>Mục tiêu cuối kỳ, theo đúng chữ của syllabus (CLO2): đọc và viết cả hai kana thành thạo, và ghi nhớ <strong>200 từ, 23 cấu trúc ngữ pháp và 35 chữ Hán</strong>. Rất khả thi nếu luyện mỗi ngày — tiếng Nhật thưởng cho việc học ít-mà-đều.</p>
<h3>Bản đồ học</h3>
<div class="lz-map">
  ...
  <div class="lz-node"><div class="lz-badge">5</div><div class="lz-nbody"><div class="lz-ntitle">Bài 2–3 — cái này/cái kia, nơi chốn &amp; mua sắm</div><div class="lz-nsub">これ/それ/あれ · ここ/そこ/あそこ · このN · Nをください &nbsp;(+ あります/います, phần thêm)</div></div></div>
...
<p class="lead">From the official JPD113 syllabus (ID 14232). There is no prerequisite — anyone can start. Note the shape of this subject's grading: <strong>there is no practical exam and no progress test</strong>; it is two small tests, your participation, and a final exam that has <em>two separate parts</em>, one of them spoken.</p>
<div class="kv-grid">
  <div class="kv"><span class="k">Credits</span><span class="v">3</span></div>
  <div class="kv"><span class="k">Total hours</span><span class="v">150h <small>45h class (20 sessions × 135&#39;) + 1h exam + 104h self-study</small></span></div>
  ...
  <div class="kv"><span class="k">Targets (CLO2)</span><span class="v">200 words · <strong>23 grammar structures</strong> · 35 kanji</span></div>
</div>
<h3>Grade structure — the five assessment rows, exactly as the syllabus lists them</h3>
<table>
  <thead><tr><th>Component</th><th>Type</th><th>Parts</th><th>Weight</th><th>Completion</th></tr></thead>
  <tbody>
    <tr><td>Kiểm tra nhỏ (small test)</td><td>on-going</td><td>2</td><td><strong>40%</strong></td><td>&gt; 0</td></tr>
    <tr><td>Tham gia giờ học (participation)</td><td>on-going</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>
    <tr><td><strong>Thi cuối kỳ (final exam, total)</strong></td><td>final exam</td><td>2</td><td><strong>45%</strong></td><td><strong>&ge; 4</strong></td></tr>
    <tr><td>&nbsp;&nbsp;&mdash; part 1: vocabulary, grammar, kanji</td><td>final-exam part</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>
    <tr><td>&nbsp;&nbsp;&mdash; part 2: speaking (Nói)</td><td>final-exam part</td><td>1</td><td><strong>30%</strong></td><td>&gt; 0</td></tr>
  </tbody>
</table>
<p>The two small tests are scheduled by scope: <strong>small test 1 = kana + lesson 1</strong> (session 31), <strong>small test 2 = lessons 2–3</strong> (session 58). <strong>The syllabus publishes no question count and no question type for any component</strong>, and the duration column is cut off in the official export (only its first digit survives) — so do not trust any stated minutes you read elsewhere, including in older versions of this course. Get the real timings from your teacher.</p>
<div class="callout warn">Three gates. (1) Attend ≥ 80% of sessions to be accepted to the final. (2) Both on-going components and both final-exam parts have completion criterion <strong>&gt; 0</strong> — a zero anywhere fails the subject. (3) The final exam <em>as a whole</em> must reach <strong>4/10</strong>, and your weighted average <strong>5.0</strong>. Look at the split: <strong>speaking alone is 30%</strong>, double the written part, and it sits under the final's 4/10 gate. This is a subject you pass with your mouth, not only with your pen.</div>
...
<p class="lead">Từ syllabus chính thức JPD113 (ID 14232). Không có tiên quyết — ai cũng bắt đầu được. Để ý hình dạng chấm điểm của môn này: <strong>KHÔNG có thi thực hành và KHÔNG có progress test</strong>; chỉ có hai bài kiểm tra nhỏ, điểm tham gia giờ học, và một bài thi cuối kỳ gồm <em>hai phần riêng</em>, một trong đó là phần NÓI.</p>
<div class="kv-grid">
  <div class="kv"><span class="k">Tín chỉ</span><span class="v">3</span></div>
  <div class="kv"><span class="k">Tổng giờ</span><span class="v">150h <small>45h lớp (20 session × 135&#39;) + 1h thi + 104h tự học</small></span></div>
  ...
  <div class="kv"><span class="k">Mục tiêu (CLO2)</span><span class="v">200 từ · <strong>23 cấu trúc ngữ pháp</strong> · 35 chữ Hán</span></div>
</div>
<h3>Cấu trúc điểm — năm dòng đánh giá, đúng như syllabus liệt kê</h3>
<table>
  <thead><tr><th>Thành phần</th><th>Loại</th><th>Số phần</th><th>Trọng số</th><th>Điều kiện hoàn thành</th></tr></thead>
  <tbody>
    <tr><td>Kiểm tra nhỏ</td><td>on-going</td><td>2</td><td><strong>40%</strong></td><td>&gt; 0</td></tr>
    <tr><td>Tham gia giờ học tại giảng đường</td><td>on-going</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>
    <tr><td><strong>Thi cuối kỳ (tổng)</strong></td><td>final exam</td><td>2</td><td><strong>45%</strong></td><td><strong>&ge; 4</strong></td></tr>
    <tr><td>&nbsp;&nbsp;&mdash; phần 1: Từ vựng, ngữ pháp, chữ Hán</td><td>phần của thi cuối kỳ</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>
    <tr><td>&nbsp;&nbsp;&mdash; phần 2: Nói</td><td>phần của thi cuối kỳ</td><td>1</td><td><strong>30%</strong></td><td>&gt; 0</td></tr>
  </tbody>
</table>
<p>Hai bài kiểm tra nhỏ được xếp theo phạm vi: <strong>bài 1 = kana + 第1課</strong> (session 31), <strong>bài 2 = 第2–3課</strong> (session 58). <strong>Syllabus KHÔNG công bố số câu và dạng câu hỏi cho bất kỳ thành phần nào</strong>, và cột thời lượng bị cắt trong bản xuất chính thức (chỉ còn chữ số đầu) — nên đừng tin bất kỳ con số phút nào bạn đọc ở chỗ khác, kể cả trong các phiên bản cũ của khóa học này. Hãy hỏi giáo viên để biết thời lượng thật.</p>
<div class="callout warn">Ba cửa. (1) Dự ≥ 80% số buổi mới được vào kết quả cuối. (2) Cả hai cột quá trình và cả hai phần của bài thi cuối đều có điều kiện hoàn thành <strong>&gt; 0</strong> — 0 điểm ở bất kỳ đâu là trượt môn. (3) Bài thi cuối kỳ <em>tính chung</em> phải đạt <strong>4/10</strong>, và trung bình có trọng số đạt <strong>5,0</strong>. Nhìn tỷ lệ: <strong>riêng phần NÓI đã 30%</strong>, gấp đôi phần viết, và nó nằm dưới cổng 4/10 của bài thi cuối. Đây là môn bạn qua bằng cái miệng, không chỉ bằng cây bút.</div>
...
`,
    ...
    /* ══════════════════ CHƯƠNG 5 — BÀI 2-3: NÀY/KIA & NƠI CHỐN ══════════════════ */
    {
      ...
      description: 'これ/それ/あれ (chỉ định) — nội dung 第2課 của syllabus; kèm あります/います (tồn tại) là phần THÊM ngoài ngữ pháp 第1–3課 mà syllabus liệt kê, nhưng cần để mô tả vị trí và sẽ dùng ở JPD123.',
      lessons: [
        {
...
<h3>あります vs います <small>&mdash; extra, not in the syllabus&#39;s 第1&ndash;3課 grammar</small></h3>
<p>The syllabus&#39;s grammar list for lessons 1&ndash;3 does not include the existence verbs (Dekiru&#39;s 第2課 is floors, shops and prices; 第3課 is time and daily schedule). They are taught here anyway because you need them to answer &ldquo;where is it?&rdquo; naturally, and they are core in JPD123 &mdash; but know that they are <strong>not</strong> examinable grammar for this subject.</p>
<div class="lz-stack">
...
<h3>あります vs います <small>&mdash; phần THÊM, không có trong ngữ pháp 第1&ndash;3課 của syllabus</small></h3>
<p>Danh sách ngữ pháp của syllabus cho 第1&ndash;3課 không có động từ tồn tại (第2課 của Dekiru là tầng lầu, cửa hàng và giá cả; 第3課 là thời gian và lịch sinh hoạt). Ở đây vẫn dạy vì bạn cần chúng để trả lời &ldquo;nó ở đâu?&rdquo; cho tự nhiên, và chúng là nội dung cốt lõi của JPD123 &mdash; nhưng hãy biết rằng chúng <strong>không</strong> nằm trong phạm vi ngữ pháp thi của môn này.</p>
<div class="lz-stack">
...
<p class="lead">Mọi câu bạn xây từ đầu tới giờ đều dùng です (là/thì). Giờ đến <strong>động từ hành động</strong> — mảng ngữ pháp lớn nhất trong đề thi thật, và cũng là trọn vẹn 第3課 ST2–ST3 của syllabus: session 49–55 chính là Vます (予定), Vません, Vます (習慣), [場所]へ, [場所]で, [時間]に, から～まで và どこへも行きません. Ở trình độ A1.1, hãy coi mỗi động từ thể ます như một mục từ vựng học thuộc nguyên khối, giống cách bạn học câu です — quy tắc chia động từ sâu hơn (gốc động từ nhóm 1/2/3) sẽ học sau ở N5/N4.</p>
...
`,
    ...
    {
      title: 'Final exam · Speaking part (30%) — full preparation|||Thi cuối kỳ · Phần NÓI (30%) — luyện thi đầy đủ',
      description: 'Phần NÓI là MỘT PHẦN của bài thi cuối kỳ JPD113 (30% điểm môn, nằm dưới cổng ≥4/10 của bài thi cuối) — syllabus không có kỳ thi thực hành riêng. Toàn bộ phần này: cấu trúc & thang điểm (theo đề thật, không phải theo syllabus), 13 bài đọc thật, 22 câu hỏi không tranh, 6 bộ câu hỏi có tranh, lộ trình 4 tuần và mẹo phòng thi.',
      lessons: [
        {
          title: 'S.1 — Speaking part: format & scoring|||S.1 — Phần NÓI: cấu trúc đề & thang điểm',
          slug: 'jpd113-speaking-cau-truc',
          type: 'VIDEO',
          description: 'Phần NÓI = 30% điểm môn (một phần của thi cuối kỳ). Ba phần nhỏ theo đề thật (READING 30 / TALKING 60 / PRESENTING 10 — thang này KHÔNG có trong syllabus), quy trình từng bước, và 30 giây chuẩn bị dùng để làm gì.',
          content: `
<div class="ml-en">
<span class="eyebrow">Speaking · Lesson S.1</span>
<h2>What the JPD113 speaking exam actually is</h2>
<p class="lead">First, get its place in the grading right. <strong>JPD113 has no Practical Exam.</strong> The syllabus lists speaking as <em>&ldquo;Thi cuối kỳ: Nói&rdquo;</em> &mdash; the second <strong>part of the final exam</strong>, worth <strong>30% of the whole subject</strong> (against 15% for the written vocabulary/grammar/kanji part), with its own completion criterion of &gt; 0 and sitting under the final exam&#39;s overall <strong>4/10</strong> gate. It is the single heaviest thing you are graded on. It is a face-to-face speaking test with an examiner.</p>
<div class="callout warn"><span class="badge">Where these numbers come from</span> The 100-point split below (READING 30 / TALKING 60 / PRESENTING 10), the 30-second preparation and the question counts are the <strong>working format of the real papers</strong>, matching the passage and question banks in S.2&ndash;S.5. <strong>The syllabus itself publishes none of them</strong> &mdash; it gives only the 30% weight and the &ldquo;&gt; 0&rdquo; criterion. Treat this page as an accurate rehearsal of the exam as it is run, and confirm the rubric with your teacher.</div>
<h3>The score breakdown (as the papers are marked, not from the syllabus)</h3>
<table>
...
<p class="lead">Trước hết, phải đặt nó đúng chỗ trong bảng điểm. <strong>JPD113 KHÔNG có kỳ thi thực hành (PE).</strong> Syllabus ghi phần nói là <em>&ldquo;Thi cuối kỳ: Nói&rdquo;</em> &mdash; <strong>phần thứ hai của bài thi cuối kỳ</strong>, chiếm <strong>30% điểm toàn môn</strong> (so với 15% cho phần viết từ vựng/ngữ pháp/chữ Hán), có điều kiện hoàn thành riêng &gt; 0 và nằm dưới cổng <strong>4/10</strong> chung của bài thi cuối. Đây là cột điểm nặng nhất của môn. Hình thức: thi nói trực tiếp với giám thị.</p>
<div class="callout warn"><span class="badge">Các con số này từ đâu</span> Thang 100 điểm bên dưới (READING 30 / TALKING 60 / PRESENTING 10), 30 giây chuẩn bị và số lượng câu hỏi là <strong>cách vận hành thật của đề thi</strong>, khớp với ngân hàng bài đọc và câu hỏi ở S.2&ndash;S.5. <strong>Bản thân syllabus KHÔNG công bố con số nào trong đó</strong> &mdash; nó chỉ cho trọng số 30% và điều kiện &ldquo;&gt; 0&rdquo;. Hãy coi trang này là bản diễn tập chính xác theo cách đề đang được tổ chức, và xác nhận thang chấm với giáo viên.</div>
<h3>Cơ cấu điểm (theo cách đề được chấm, không phải từ syllabus)</h3>
<table>
...
`,
    ...
    /* END-SECTIONS-MARKER */
    {
      ...
      "description": "Thi cuối kỳ JPD113 có HAI PHẦN: từ vựng/ngữ pháp/chữ Hán 15% + NÓI 30% (tổng 45%, phải đạt ≥4/10). KHÔNG có kỳ thi thực hành riêng, và syllabus không nêu dạng câu hỏi hay số câu — hai bài dưới nói rõ sự thật.",
      "lessons": [
        {
          "title": "No Practical Exam — speaking is part of the final (30%)|||Không có thi thực hành — phần NÓI nằm trong thi cuối kỳ (30%)",
          "slug": "jpd113-final-exam-pe",
          "type": "article",
          "description": "Syllabus JPD113 không có kỳ thi thực hành. Phần nói là MỘT PHẦN của thi cuối kỳ, 30% điểm môn — bài này chỉnh lại sự thật và dẫn sang mục luyện S.1–S.6.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final exam · Speaking part (30%)</span>\n<h2>There is no Practical Exam in JPD113 — speaking is part of the final</h2>\n<p class=\"lead\">If you are looking for a separate practical exam: <strong>JPD113 does not have one</strong>. The syllabus (ID 14232) lists five assessment rows, and none of them is a practical exam. Speaking appears as <em>&ldquo;Thi cuối kỳ: Nói&rdquo;</em> &mdash; the second <strong>part of the final exam</strong>.</p>\n<table>\n<thead><tr><th>Row in the syllabus</th><th>Type</th><th>Parts</th><th>Weight</th><th>Completion</th></tr></thead>\n<tbody>\n<tr><td>Kiểm tra nhỏ (small test)</td><td>on-going</td><td>2</td><td>40%</td><td>&gt; 0</td></tr>\n<tr><td>Tham gia giờ học (participation)</td><td>on-going</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>\n<tr><td><strong>Thi cuối kỳ (total)</strong></td><td>final exam</td><td>2</td><td><strong>45%</strong></td><td><strong>&ge; 4</strong></td></tr>\n<tr><td>&mdash; Từ vựng, ngữ pháp, chữ Hán</td><td>final-exam part</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>\n<tr><td>&mdash; <strong>Nói (speaking)</strong></td><td>final-exam part</td><td>1</td><td><strong>30%</strong></td><td>&gt; 0</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><span class=\"badge\">Correction</span> This page used to describe a standalone &ldquo;Practical Exam&rdquo; with its own preparation advice (&ldquo;prepare 3&ndash;5 common topics, speak ~1 minute on each&rdquo;) that did not match the real format. Speaking is a <em>part of the final exam</em>, it is <strong>30% of the whole subject</strong> &mdash; double the written part &mdash; and the actual format is: <strong>read a given passage aloud, then answer 4 questions</strong> (1 without a picture + 3 about one picture), with manner and pronunciation also marked.</div>\n<h3>Where the real preparation is</h3>\n<p>This course has a whole section for it &mdash; <strong>&ldquo;Final exam · Speaking part (30%)&rdquo;</strong>, lessons S.1&ndash;S.6:</p>\n<ul>\n<li><b>S.1</b> &mdash; the format and score breakdown, step by step, and what to do with the 30 preparation seconds.</li>\n<li><b>S.2&ndash;S.3</b> &mdash; all <strong>13 real reading passages</strong>, with readings and traps.</li>\n<li><b>S.4</b> &mdash; the <strong>22 questions without a picture</strong>, with model answers.</li>\n<li><b>S.5</b> &mdash; the <strong>6 picture sets</strong> and their three questions each.</li>\n<li><b>S.6</b> &mdash; a four-week plan and the in-room tips (never go silent for five seconds; say ええと rather than freezing).</li>\n</ul>\n<p>Go there. Do not revise for a practical exam that does not exist &mdash; revise for the speaking part that is worth 30%.</p>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · Phần NÓI (30%)</span>\n<h2>JPD113 không có kỳ thi thực hành — phần nói nằm TRONG bài thi cuối kỳ</h2>\n<p class=\"lead\">Nếu bạn tìm một kỳ thi thực hành riêng: <strong>JPD113 không có</strong>. Syllabus (ID 14232) liệt kê năm dòng đánh giá, không dòng nào là thi thực hành. Phần nói xuất hiện dưới tên <em>&ldquo;Thi cuối kỳ: Nói&rdquo;</em> &mdash; <strong>phần thứ hai của bài thi cuối kỳ</strong>.</p>\n<table>\n<thead><tr><th>Dòng trong syllabus</th><th>Loại</th><th>Số phần</th><th>Trọng số</th><th>Điều kiện</th></tr></thead>\n<tbody>\n<tr><td>Kiểm tra nhỏ</td><td>on-going</td><td>2</td><td>40%</td><td>&gt; 0</td></tr>\n<tr><td>Tham gia giờ học</td><td>on-going</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>\n<tr><td><strong>Thi cuối kỳ (tổng)</strong></td><td>final exam</td><td>2</td><td><strong>45%</strong></td><td><strong>&ge; 4</strong></td></tr>\n<tr><td>&mdash; Từ vựng, ngữ pháp, chữ Hán</td><td>phần của thi cuối kỳ</td><td>1</td><td>15%</td><td>&gt; 0</td></tr>\n<tr><td>&mdash; <strong>Nói</strong></td><td>phần của thi cuối kỳ</td><td>1</td><td><strong>30%</strong></td><td>&gt; 0</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><span class=\"badge\">Đính chính</span> Trang này trước đây mô tả một &ldquo;kỳ thi thực hành&rdquo; riêng kèm lời khuyên ôn tập (&ldquo;chuẩn bị 3&ndash;5 chủ đề, nói khoảng 1 phút mỗi chủ đề&rdquo;) không khớp với format thật. Phần nói là <em>một phần của bài thi cuối kỳ</em>, chiếm <strong>30% toàn môn</strong> &mdash; gấp đôi phần viết &mdash; và format thật là: <strong>đọc to một bài đọc được giao, rồi trả lời 4 câu hỏi</strong> (1 câu không tranh + 3 câu về một bức tranh), kèm chấm cả thái độ và phát âm.</div>\n<h3>Chỗ luyện thật nằm ở đâu</h3>\n<p>Khóa học có hẳn một mục cho nó &mdash; <strong>&ldquo;Thi cuối kỳ · Phần NÓI (30%)&rdquo;</strong>, bài S.1&ndash;S.6:</p>\n<ul>\n<li><b>S.1</b> &mdash; cấu trúc đề và cơ cấu điểm, quy trình từng bước, và dùng 30 giây chuẩn bị vào việc gì.</li>\n<li><b>S.2&ndash;S.3</b> &mdash; toàn bộ <strong>13 bài đọc thật</strong>, kèm cách đọc và các bẫy.</li>\n<li><b>S.4</b> &mdash; <strong>22 câu hỏi không tranh</strong>, kèm câu trả lời mẫu.</li>\n<li><b>S.5</b> &mdash; <strong>6 bộ tranh</strong> và ba câu hỏi của mỗi bộ.</li>\n<li><b>S.6</b> &mdash; lộ trình bốn tuần và mẹo phòng thi (đừng im quá năm giây; hãy nói ええと thay vì đơ ra).</li>\n</ul>\n<p>Hãy sang đó. Đừng ôn cho một kỳ thi thực hành không tồn tại &mdash; hãy ôn cho phần NÓI đáng 30% điểm.</p>\n</div>"
        },
        {
          "title": "FE — written part: vocabulary, grammar & kanji (15%)|||FE — phần viết: từ vựng, ngữ pháp & chữ Hán (15%)",
          "slug": "jpd113-final-exam-fe",
          "type": "article",
          "description": "Thi cuối kỳ có HAI phần: viết 15% + nói 30%, tổng 45%, phải đạt ≥4/10. Syllabus không nêu format, số câu hay thời lượng. Phạm vi CLO2 (200 từ · 23 ngữ pháp · 35 kanji) + câu mẫu.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final exam · Written part (15%)</span>\n<h2>FE — the written part: vocabulary, grammar &amp; kanji (15%)</h2>\n<p class=\"lead\">The JPD113 final exam has <strong>two parts</strong>, and this page is about the first one. What the syllabus (ID 14232) actually states:</p>\n<table>\n<thead><tr><th>Field</th><th>Value</th></tr></thead>\n<tbody>\n<tr><td>Final exam, total</td><td>2 parts, <strong>45%</strong> of the subject, completion criterion <strong>&ge; 4</strong>/10</td></tr>\n<tr><td>&mdash; Part 1: Từ vựng, ngữ pháp, chữ Hán (vocabulary, grammar, kanji)</td><td>1 part, <strong>15%</strong>, completion &gt; 0</td></tr>\n<tr><td>&mdash; Part 2: Nói (speaking)</td><td>1 part, <strong>30%</strong>, completion &gt; 0 &mdash; see the Speaking section, lessons S.1&ndash;S.6</td></tr>\n<tr><td>Question type</td><td><strong>Not stated in the syllabus</strong></td></tr>\n<tr><td>Number of questions</td><td><strong>Not stated in the syllabus</strong></td></tr>\n<tr><td>Duration</td><td><strong>Cut off in the official export</strong> &mdash; only the first digit survives; do not trust any figure you read elsewhere</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><span class=\"badge\">Correction</span> This page used to say the final is &ldquo;a computer-graded multiple-choice test&rdquo; and told you to &ldquo;time yourself: 45 minutes / 30 questions&rdquo;. None of that is in the syllabus, and the written part is only <strong>15%</strong> of the subject &mdash; half the weight of the speaking part. Get the real length and format from your teacher, and put your hours where the marks are.</div>\n<h3>What the written part covers — CLO2, in exact numbers</h3>\n<p>CLO2 is the only outcome with published targets, and they are the scope of this part: <strong>200 words, 23 grammar structures, 35 kanji</strong>, over lessons 第1&ndash;3課 of できる日本語 plus kana.</p>\n<ul>\n<li><b>Kana (CLO1).</b> Both charts, plus dakuon/handakuon, yōon, long vowels, sokuon and ん. Chapters 1&ndash;2.</li>\n<li><b>Lesson 1 grammar.</b> 私は[名前]です · お国はどちらですか · お仕事は · ～ですか / はい・いいえ、～じゃありません · NのN · ～歳です · いつ・～月～日 · 何ですか · NとN · Nも. Chapter 4 and the Chapter 4 grammar summary.</li>\n<li><b>Lesson 2 grammar.</b> 何階ですか · ～はどこですか / ここ・そこ・あそこ · こちら・そちら・あちら · ～はいくらですか / これ・それ・あれ · このN · Nをください · 何のN · [言語]で · どこのN · だれのN. Chapter 5 and its summary.</li>\n<li><b>Lesson 3 grammar.</b> 今何時ですか · [時間]から[時間]まで · 何曜日 · Vます (予定) · [場所]へ · Vません · [場所]で · Vます (習慣) · NやNなど · 何もVません · [時間]に · どこへも行きません. Chapter 6 and its summary.</li>\n<li><b>Kanji (35).</b> Chapters 7.1&ndash;7.3 &mdash; numbers, time, people, school; on- and kun-readings.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Note on the negative form</span> The syllabus writes lesson 1&#39;s negative as <strong>～じゃありません</strong> (the spoken form in できる日本語). This course teaches ではありません, the written form. Both are correct; recognise and be able to produce the じゃ form, because that is the one the textbook and the paper use.</div>\n<h3>Two small tests come first &mdash; and they are worth more</h3>\n<p>Before the final, you sit <strong>two small tests worth 40% together</strong>, more than the whole final exam. Their scope is fixed by the syllabus: <strong>test 1 = kana + lesson 1</strong> (session 31), <strong>test 2 = lessons 2&ndash;3</strong> (session 58). Revising for them <em>is</em> revising for this written part &mdash; same material, earlier.</p>\n<div class=\"callout\"><span class=\"badge\">Sample</span> The questions below are <strong>sample questions</strong> drawn from this course, for content practice, not a prediction of the paper's format. Real past papers &mdash; 14 of them &mdash; are in the Exam Room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · Phần VIẾT (15%)</span>\n<h2>FE — phần viết: từ vựng, ngữ pháp &amp; chữ Hán (15%)</h2>\n<p class=\"lead\">Bài thi cuối kỳ JPD113 có <strong>hai phần</strong>, và trang này nói về phần thứ nhất. Syllabus (ID 14232) thực sự ghi:</p>\n<table>\n<thead><tr><th>Mục</th><th>Giá trị</th></tr></thead>\n<tbody>\n<tr><td>Thi cuối kỳ, tổng</td><td>2 phần, <strong>45%</strong> điểm môn, điều kiện hoàn thành <strong>&ge; 4</strong>/10</td></tr>\n<tr><td>&mdash; Phần 1: Từ vựng, ngữ pháp, chữ Hán</td><td>1 phần, <strong>15%</strong>, điều kiện &gt; 0</td></tr>\n<tr><td>&mdash; Phần 2: Nói</td><td>1 phần, <strong>30%</strong>, điều kiện &gt; 0 &mdash; xem mục Thi nói, bài S.1&ndash;S.6</td></tr>\n<tr><td>Dạng câu hỏi</td><td><strong>Syllabus không nêu</strong></td></tr>\n<tr><td>Số câu</td><td><strong>Syllabus không nêu</strong></td></tr>\n<tr><td>Thời lượng</td><td><strong>Bị cắt trong bản xuất chính thức</strong> &mdash; chỉ còn chữ số đầu; đừng tin con số nào bạn đọc ở chỗ khác</td></tr>\n</tbody>\n</table>\n<div class=\"callout warn\"><span class=\"badge\">Đính chính</span> Trang này trước đây nói bài thi cuối là &ldquo;trắc nghiệm máy chấm&rdquo; và bảo bạn &ldquo;bấm giờ: 45 phút / 30 câu&rdquo;. Không điều nào có trong syllabus, và phần viết chỉ chiếm <strong>15%</strong> điểm môn &mdash; bằng một nửa phần nói. Hãy hỏi giáo viên về độ dài và format thật, và dồn giờ vào chỗ có điểm.</div>\n<h3>Phần viết thi những gì — CLO2, bằng con số chính xác</h3>\n<p>CLO2 là chuẩn đầu ra duy nhất có mục tiêu được công bố, và đó chính là phạm vi của phần này: <strong>200 từ, 23 cấu trúc ngữ pháp, 35 chữ Hán</strong>, trải trên 第1&ndash;3課 của できる日本語 cộng kana.</p>\n<ul>\n<li><b>Kana (CLO1).</b> Cả hai bảng, cộng âm đục/bán đục, âm ghép, trường âm, âm ngắt và ん. Chương 1&ndash;2.</li>\n<li><b>Ngữ pháp 第1課.</b> 私は[名前]です · お国はどちらですか · お仕事は · ～ですか / はい・いいえ、～じゃありません · NのN · ～歳です · いつ・～月～日 · 何ですか · NとN · Nも. Chương 4 và bảng tổng kết ngữ pháp chương 4.</li>\n<li><b>Ngữ pháp 第2課.</b> 何階ですか · ～はどこですか / ここ・そこ・あそこ · こちら・そちら・あちら · ～はいくらですか / これ・それ・あれ · このN · Nをください · 何のN · [言語]で · どこのN · だれのN. Chương 5 và bảng tổng kết.</li>\n<li><b>Ngữ pháp 第3課.</b> 今何時ですか · [時間]から[時間]まで · 何曜日 · Vます (dự định) · [場所]へ · Vません · [場所]で · Vます (thói quen) · NやNなど · 何もVません · [時間]に · どこへも行きません. Chương 6 và bảng tổng kết.</li>\n<li><b>Chữ Hán (35).</b> Bài 7.1&ndash;7.3 &mdash; số, thời gian, người, trường học; âm on và âm kun.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Lưu ý về thể phủ định</span> Syllabus viết thể phủ định của 第1課 là <strong>～じゃありません</strong> (dạng nói của できる日本語). Khóa học này dạy ではありません, dạng viết. Cả hai đều đúng; hãy nhận ra và nói/viết được dạng じゃ, vì đó mới là dạng giáo trình và đề thi dùng.</div>\n<h3>Hai bài kiểm tra nhỏ đến trước &mdash; và chúng nặng hơn</h3>\n<p>Trước bài thi cuối, bạn làm <strong>hai bài kiểm tra nhỏ, cộng lại 40%</strong>, nhiều hơn cả bài thi cuối kỳ. Phạm vi do syllabus ấn định: <strong>bài 1 = kana + 第1課</strong> (session 31), <strong>bài 2 = 第2&ndash;3課</strong> (session 58). Ôn cho chúng <em>chính là</em> ôn cho phần viết này &mdash; cùng nội dung, chỉ sớm hơn.</p>\n<div class=\"callout\"><span class=\"badge\">Câu mẫu</span> Các câu dưới đây là <strong>câu mẫu</strong> lấy từ chính khóa học, để luyện nội dung, không phải dự đoán format đề. Đề thi thật &mdash; 14 đề &mdash; nằm ở trang phòng thi.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
