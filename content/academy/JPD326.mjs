...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Ngôn ngữ Nhật, semester 3. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Ngôn ngữ Nhật, kỳ 3. Bài giảng chưa được dựng.',
    description: 'Môn <strong>JPD326 — Intermediate Japanese 2-B2.1</strong> thuộc khung chương trình ngành Ngôn ngữ Nhật, kỳ 3.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
