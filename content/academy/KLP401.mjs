/**
 * KLP401 — Korean Language Practice.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Ngôn ngữ Hàn, semester 5. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Ngôn ngữ Hàn, kỳ 5. Bài giảng chưa được dựng.',
    description: 'Môn <strong>KLP401 — Korean Language Practice</strong> thuộc khung chương trình ngành Ngôn ngữ Hàn, kỳ 5.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
