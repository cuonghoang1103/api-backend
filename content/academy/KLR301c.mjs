/**
 * KLR301c — Scientific Research Methods.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Ngôn ngữ Hàn, semester 6. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Ngôn ngữ Hàn, kỳ 6. Bài giảng chưa được dựng.',
    description: 'Môn <strong>KLR301c — Scientific Research Methods</strong> thuộc khung chương trình ngành Ngôn ngữ Hàn, kỳ 6.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
    whatYouLearn: 'Chưa có nội dung. Xem giáo trình chính thức trên FLM (flm.fpt.edu.vn) để biết chuẩn đầu ra của môn.',
    requirements: 'Xem điều kiện tiên quyết trong khung chương trình ngành Ngôn ngữ Hàn trên FLM.',
  },
  sections: [],
};
