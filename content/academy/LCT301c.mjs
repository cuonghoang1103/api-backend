/**
 * LCT301c — Leadership and Critical Thinking.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Khoa học Máy tính, semester 6. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Khoa học Máy tính, kỳ 6. Bài giảng chưa được dựng.',
    description: 'Môn <strong>LCT301c — Leadership and Critical Thinking</strong> thuộc khung chương trình ngành Khoa học Máy tính, kỳ 6.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
