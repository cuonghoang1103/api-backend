/**
 * LEI201 — Law and Ethics in Business and Investment.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — khối Quản trị Kinh doanh, semester 7. Lessons are not written yet.|||Môn trong khung chương trình FPTU — khối Quản trị Kinh doanh, kỳ 7. Bài giảng chưa được dựng.',
    description: 'Môn <strong>LEI201 — Law and Ethics in Business and Investment</strong> thuộc khung chương trình khối Quản trị Kinh doanh, kỳ 7.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
