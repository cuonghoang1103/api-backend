/**
 * LTG201 — Introduction to linguistics.
...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>LTG201 — Introduction to linguistics</strong> thuộc khung chương trình ngành Ngôn ngữ Trung, kỳ 3.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
