...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>MAD102 — Discrete mathematics</strong> thuộc khung chương trình ngành Khoa học Máy tính, kỳ 1.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
