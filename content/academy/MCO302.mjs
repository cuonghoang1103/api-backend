/**
 * MCO302 — Intercultural Communication -Truyền th&#244;ng li&#234;n văn h&#243;a.
...
export default {
  ...
  course: {
    ...
    title: 'Intercultural Communication -Truyền th&#244;ng li&#234;n văn h&#243;a',
    level: 'BEGINNER',
    language: 'Vietnamese',
    status: 'PUBLISHED',
