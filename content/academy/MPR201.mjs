/**
 * MPR201 — Media production: Theory and practice.
...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>MPR201 — Media production: Theory and practice</strong> thuộc khung chương trình khối Công nghệ Truyền thông, kỳ 5.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
