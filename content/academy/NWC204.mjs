 ...
 * bộ CCNA gốc là tài liệu bản quyền Cisco trên netacad). 135 ảnh ở
 ...
 *
 * Hiện phủ buổi 1–16 + chương bù hệ đếm. Buổi 17–60 còn nợ, xem
...
export default {
  ...
  sections: [...muc0, ...ch01, ...ch02, ...ch03, ...ch04, ...ch04b, ...ch05],
};
