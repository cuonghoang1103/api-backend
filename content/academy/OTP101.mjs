...
export default {
  ...
  course: {
    ...
    shortDescription: 'Your first course at FPTU — a freshman survival guide: the SE program, the learning systems (FLM/FAP/EduNext), academic regulations & integrity, study at university, digital skills & English, student life, career orientation and growth mindset. Bilingual, with quizzes.|||Môn đầu tiên ở FPTU — cẩm nang tân SV: ngành SE, hệ thống học tập (FLM/FAP/EduNext), quy chế & liêm chính, cách học đại học, kỹ năng số & tiếng Anh, đời sống SV, định hướng nghề nghiệp và tư duy phát triển. Song ngữ, có quiz.',
