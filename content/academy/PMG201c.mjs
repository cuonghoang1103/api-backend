...
<table>
  ...
  <tbody>
    ...
    <tr><td>Practical Exam (PE)</td><td>50%</td><td>120 min. <b>The syllabus leaves the PE question-type cell blank</b> — no format is published. Prepare applied project-planning work against CLO1–CLO4 (charter, scope, WBS, estimating, schedule/critical path, risk register, communications and change control).</td><td>PE ≥ 4</td></tr>
...
<div class="pitfall">The commonest failure is neglecting the <strong>PE (practical) half</strong> — students revise MCQ theory but never actually practise building a charter, a WBS, a network diagram or a risk register under time. The PE has its own ≥4 gate; theory alone cannot carry you. (Earned Value is taught here as supplementary — Schwalbe ch. 7 — because no syllabus session names it; practise it, but do not assume it is on the paper.)</div>
</div>
<div class="ml-vi">
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Thi thực hành (PE)</td><td>50%</td><td>120 phút. <b>Syllabus để TRỐNG ô dạng câu hỏi của PE</b> — không công bố hình thức nào. Hãy luyện phần lập kế hoạch áp dụng theo CLO1–CLO4 (charter, phạm vi, WBS, ước lượng, tiến độ/đường găng, sổ rủi ro, truyền thông và kiểm soát thay đổi).</td><td>PE ≥ 4</td></tr>
...
<div class="pitfall">Kiểu rớt phổ biến nhất là lơ là <strong>phần PE (thực hành)</strong> — sinh viên ôn lý thuyết trắc nghiệm nhưng chưa bao giờ thực sự luyện dựng charter, WBS, sơ đồ mạng hay sổ rủi ro có tính giờ. PE có cổng ≥4 riêng; lý thuyết không mình cõng bạn qua được. (EVM ở đây dạy như phần bổ sung — Schwalbe ch. 7 — vì không buổi nào trong syllabus gọi tên nó; cứ luyện, nhưng đừng mặc định nó có trong đề.)</div>
</div>`,
        },
        {
...
<table>
  ...
  <tbody>
    ...
    <tr><td>5</td><td>Mixing up EVM terms (PV/EV/AC, CPI/SPI) — <em>supplementary: no syllabus session names Earned Value</em></td><td>Memorise the formulas; practise one full EVM table. Useful for the capstone and for real projects, but do not assume it is examined.</td></tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>5</td><td>Lẫn thuật ngữ EVM (PV/EV/AC, CPI/SPI) — <em>phần bổ sung: không buổi nào trong syllabus gọi tên Earned Value</em></td><td>Học thuộc công thức; luyện một bảng EVM đầy đủ. Hữu ích cho capstone và dự án thật, nhưng đừng mặc định nó vào đề thi.</td></tr>
...
<div class="pitfall">Đừng bao giờ dán dữ liệu dự án bảo mật (hợp đồng khách, ngân sách, dữ liệu cá nhân) vào một công cụ AI công cộng. Làm vậy có thể rò rỉ thông tin nhạy cảm và vi phạm thỏa thuận — một rủi ro quản trị mà PM hiện đại phải quản lý, không chỉ là câu chuyện tiện lợi.</div>
    ...
    {
      "title": "Final Exam — PE (50%, 120') + TE (50%, 60')|||Thi cuối kỳ — PE (50%, 120') + TE (50%, 60')",
      "description": "Hai bài thi cuối kỳ theo đúng tên trong syllabus: PE 50% / 120 phút (ô dạng câu hỏi để TRỐNG) và TE 50% / 60 phút trắc nghiệm máy chấm. Mỗi bài cổng ≥ 4; FR = min(10, (TE+PE)/2 + Bonus) ≥ 5.",
      "lessons": [
        {
          "title": "PE — Practical Exam (50%, 120 minutes): what is known and how to prepare|||PE — Thi thực hành (50%, 120 phút): biết chắc điều gì và luyện thế nào",
          "slug": "pmg201c-final-exam-pe",
          "type": "article",
          "description": "PE của PMG201c là bài áp dụng quản trị dự án 120 phút, cổng ≥ 4. Syllabus để TRỐNG ô dạng câu hỏi — bài này nói rõ điều đó và luyện theo CLO1–CLO4 thay vì đoán format.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · PE</span>\n<h2>PE &mdash; 50% of the subject, 120 minutes, its own &ge; 4 gate</h2>\n<p class=\"lead\">The PE is one of PMG201c's two final exams. What the syllabus (sylID 12548) actually states is short: <strong>Final exam, 50%, completion criterion 4, 120 minutes</strong>. Its <strong>Question Type cell is blank</strong> &mdash; no format is published. Anyone who tells you it is &ldquo;an essay&rdquo; or &ldquo;an EVM table&rdquo; is guessing.</p>\n<div class=\"callout warn\"><strong>Correction.</strong> An earlier version of this page described the PE as a generic report-writing exam &mdash; &ldquo;thesis &rarr; evidence &rarr; analysis &rarr; conclusion&rdquo; &mdash; which has nothing to do with project management and is not in the syllabus. The safe preparation is the subject's own CLOs.</div>\n<table>\n<thead><tr><th>Field</th><th>What the syllabus says</th></tr></thead>\n<tbody>\n<tr><td>Weight</td><td>50% (the other 50% is the TE)</td></tr>\n<tr><td>Completion criterion</td><td><strong>4</strong> &mdash; independent of the TE and of the final result</td></tr>\n<tr><td>Duration</td><td><strong>120 minutes</strong></td></tr>\n<tr><td>Question type</td><td><em>blank in the published syllabus</em></td></tr>\n<tr><td>Final result</td><td>FR = min(10, (TE + PE) / 2 + Bonus), pass needs TE &ge; 4 <b>and</b> PE &ge; 4 <b>and</b> FR &ge; 5</td></tr>\n<tr><td>Eligibility</td><td>You must hold the certification of &ldquo;Introduction to Project Management Principles and Practices&rdquo; and complete the online courses</td></tr>\n</tbody>\n</table>\n\n<h3>Prepare against the CLOs, not against a rumoured format</h3>\n<p>Two hours is long enough for a chain of connected planning artifacts on one scenario. Whatever shape the paper takes, these are the things the CLOs say you must be able to produce:</p>\n<table>\n<thead><tr><th>CLO</th><th>Be able to produce, under time</th><th>Lesson</th></tr></thead>\n<tbody>\n<tr><td>CLO1</td><td>A project charter: objective, deliverables, milestones, stakeholders, constraints and assumptions; and the plan components in the right order</td><td>1.1, 1.2, 4.1</td></tr>\n<tr><td>CLO2</td><td>Scope statement &rarr; WBS (3 levels, 100% rule) &rarr; estimates by a named method (analogous, parametric, three-point/PERT) &rarr; network and critical path with float</td><td>2.1, 2.2</td></tr>\n<tr><td>CLO3</td><td>A risk register (cause &rarr; event &rarr; impact, P&times;I, response, owner) and a communications plan table; a change request run through the change-control steps</td><td>3.1, 3.2</td></tr>\n<tr><td>CLO4</td><td>The whole set, consistent with each other &mdash; the same deliverables in the charter, the WBS and the schedule</td><td>4.1, capstone checklist</td></tr>\n</tbody>\n</table>\n\n<h3>A 120-minute working order that survives any format</h3>\n<ol>\n<li><strong>0&ndash;10 min</strong> &mdash; read the whole scenario and list the artifacts asked for. Allocate minutes per artifact before writing anything.</li>\n<li><strong>10&ndash;40 min</strong> &mdash; scope and WBS first: everything downstream depends on it, and a wrong WBS makes the schedule wrong too.</li>\n<li><strong>40&ndash;75 min</strong> &mdash; estimates and the network: draw the dependencies, do the forward and backward pass, mark the critical path and the float. Show the working; partial credit lives there.</li>\n<li><strong>75&ndash;105 min</strong> &mdash; risk register, communications plan, change control.</li>\n<li><strong>105&ndash;120 min</strong> &mdash; consistency pass: do the deliverables in the charter appear in the WBS? Does the schedule contain every WBS work package? This is the cheapest mark in the paper.</li>\n</ol>\n<div class=\"callout\"><span class=\"badge\">Supplementary</span> Earned Value (PV/EV/AC, CPI/SPI) is taught in this course from Schwalbe ch. 7 because it is standard practice &mdash; but <strong>no PMG201c session names it</strong> and the PE format is not published, so treat it as useful, not as guaranteed exam content.</div>\n<div class=\"callout\"><span class=\"badge\">Sample</span> A scenario-based PE prompt bank will be added here later, in the exam room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · PE</span>\n<h2>PE &mdash; 50% môn học, 120 phút, có cổng &ge; 4 riêng</h2>\n<p class=\"lead\">PE là một trong hai bài thi cuối kỳ của PMG201c. Thứ syllabus (sylID 12548) thật sự nói rất ngắn: <strong>thi cuối kỳ, 50%, mốc hoàn thành 4, 120 phút</strong>. Ô <strong>dạng câu hỏi để TRỐNG</strong> &mdash; không công bố format nào. Ai bảo bạn nó là &ldquo;bài luận&rdquo; hay &ldquo;một bảng EVM&rdquo; là đang đoán.</p>\n<div class=\"callout warn\"><strong>Đính chính.</strong> Bản trước của trang này mô tả PE như một bài viết báo cáo chung chung &mdash; &ldquo;luận đề &rarr; bằng chứng &rarr; phân tích &rarr; kết luận&rdquo; &mdash; vốn chẳng liên quan gì tới quản trị dự án và không có trong syllabus. Cách ôn an toàn là bám CLO của chính môn.</div>\n<table>\n<thead><tr><th>Trường</th><th>Syllabus ghi gì</th></tr></thead>\n<tbody>\n<tr><td>Trọng số</td><td>50% (50% còn lại là TE)</td></tr>\n<tr><td>Mốc hoàn thành</td><td><strong>4</strong> &mdash; độc lập với TE và với điểm cuối</td></tr>\n<tr><td>Thời lượng</td><td><strong>120 phút</strong></td></tr>\n<tr><td>Dạng câu hỏi</td><td><em>để trống trong syllabus công bố</em></td></tr>\n<tr><td>Kết quả cuối</td><td>FR = min(10, (TE + PE) / 2 + Bonus), đậu cần TE &ge; 4 <b>và</b> PE &ge; 4 <b>và</b> FR &ge; 5</td></tr>\n<tr><td>Điều kiện dự thi</td><td>Phải có chứng chỉ &ldquo;Introduction to Project Management Principles and Practices&rdquo; và hoàn thành các khoá online</td></tr>\n</tbody>\n</table>\n\n<h3>Ôn theo CLO, đừng ôn theo format nghe đồn</h3>\n<p>Hai tiếng đủ dài cho một chuỗi sản phẩm lập kế hoạch nối nhau trên cùng một tình huống. Dù đề có hình dạng nào, đây là những thứ CLO nói bạn phải làm ra được:</p>\n<table>\n<thead><tr><th>CLO</th><th>Phải làm được, có tính giờ</th><th>Bài</th></tr></thead>\n<tbody>\n<tr><td>CLO1</td><td>Project charter: mục tiêu, sản phẩm bàn giao, mốc, bên liên quan, ràng buộc và giả định; và các thành phần kế hoạch theo đúng thứ tự</td><td>1.1, 1.2, 4.1</td></tr>\n<tr><td>CLO2</td><td>Tuyên bố phạm vi &rarr; WBS (3 cấp, quy tắc 100%) &rarr; ước lượng bằng phương pháp có tên (analogous, parametric, three-point/PERT) &rarr; sơ đồ mạng và đường găng kèm float</td><td>2.1, 2.2</td></tr>\n<tr><td>CLO3</td><td>Sổ rủi ro (nguyên nhân &rarr; sự kiện &rarr; tác động, P&times;I, ứng phó, người chịu trách nhiệm) và bảng kế hoạch truyền thông; một yêu cầu thay đổi chạy qua đủ các bước kiểm soát</td><td>3.1, 3.2</td></tr>\n<tr><td>CLO4</td><td>Toàn bộ bộ tài liệu, nhất quán với nhau &mdash; cùng những sản phẩm bàn giao trong charter, trong WBS và trong tiến độ</td><td>4.1, checklist capstone</td></tr>\n</tbody>\n</table>\n\n<h3>Trình tự 120 phút sống sót với mọi format</h3>\n<ol>\n<li><strong>0&ndash;10 phút</strong> &mdash; đọc hết tình huống và liệt kê những sản phẩm đề yêu cầu. Chia phút cho từng sản phẩm trước khi viết bất cứ gì.</li>\n<li><strong>10&ndash;40 phút</strong> &mdash; phạm vi và WBS trước: mọi thứ phía sau phụ thuộc vào nó, WBS sai kéo theo tiến độ sai.</li>\n<li><strong>40&ndash;75 phút</strong> &mdash; ước lượng và sơ đồ mạng: vẽ phụ thuộc, làm forward và backward pass, đánh dấu đường găng và float. Trình bày cách làm; điểm thành phần nằm ở đó.</li>\n<li><strong>75&ndash;105 phút</strong> &mdash; sổ rủi ro, kế hoạch truyền thông, kiểm soát thay đổi.</li>\n<li><strong>105&ndash;120 phút</strong> &mdash; rà nhất quán: sản phẩm bàn giao trong charter có xuất hiện trong WBS không? Tiến độ có đủ mọi gói công việc của WBS không? Đây là điểm rẻ nhất cả bài.</li>\n</ol>\n<div class=\"callout\"><span class=\"badge\">Phần bổ sung</span> Earned Value (PV/EV/AC, CPI/SPI) được dạy trong môn này theo Schwalbe ch. 7 vì đó là thực hành chuẩn &mdash; nhưng <strong>không buổi nào của PMG201c gọi tên nó</strong> và format PE không công bố, nên hãy coi nó là hữu ích chứ không phải nội dung thi chắc chắn.</div>\n<div class=\"callout\"><span class=\"badge\">Câu mẫu</span> Ngân hàng đề PE dạng tình huống sẽ được thêm vào đây sau, trong trang phòng thi.</div>\n</div>"
        },
        {
          "title": "TE — Theory Exam (50%, 60 minutes, multiple choice)|||TE — Thi lý thuyết (50%, 60 phút, trắc nghiệm)",
          "slug": "pmg201c-final-exam-fe",
          "type": "article",
          "description": "Bài thi lý thuyết mang tên TE trong syllabus (không phải \"FE\"): 50%, 60 phút, trắc nghiệm máy chấm, cổng ≥ 4. Chiến thuật làm bài + câu mẫu.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · TE</span>\n<h2>TE &mdash; the theory half, 60 minutes of multiple choice</h2>\n<p class=\"lead\">The syllabus calls this exam <strong>TE (Theory Exam)</strong>, not &ldquo;FE&rdquo;. It is <strong>50%</strong> of the subject, <strong>60 minutes</strong>, <strong>multiple choice marked by computer</strong>, with its own completion criterion of <strong>4</strong>. Together with the PE it makes up the whole grade: FR = min(10, (TE + PE) / 2 + Bonus).</p>\n<div class=\"callout warn\"><strong>Correction.</strong> This page previously called the theory exam &ldquo;FE&rdquo;. The name in the syllabus assessment table is <strong>TE</strong> &mdash; use it when you ask the department or read the exam schedule, or you will be asking about a paper that does not exist in this subject.</div>\n\n<h3>What it covers</h3>\n<ul>\n<li><strong>Definitions and distinctions</strong>: project vs operations, project vs programme vs portfolio, product scope vs project scope, authority vs influence.</li>\n<li><strong>Process</strong>: initiating, planning, executing, monitoring &amp; controlling, closing; what belongs in which.</li>\n<li><strong>Scope &amp; schedule</strong>: the 100% rule, WBS vs schedule, critical path and float, crashing vs fast-tracking, estimating methods.</li>\n<li><strong>Risk &amp; communication</strong>: qualitative vs quantitative analysis, the four risk responses, the communications plan, change control steps.</li>\n<li><strong>Stakeholders</strong>: identification, the power/interest grid, engagement.</li>\n</ul>\n\n<h3>Technique for 60 minutes of MCQ</h3>\n<ul>\n<li>Divide time by the number of questions before you start; flag hard items and come back.</li>\n<li>Answer with the <em>method taught in the course</em>, not with workplace habit &mdash; &ldquo;what should the project manager do next&rdquo; items are scored against the process, not against instinct.</li>\n<li>Eliminate the two clearly wrong options first; the remaining pair usually differs by one word (&ldquo;avoid&rdquo; vs &ldquo;mitigate&rdquo;, &ldquo;verify&rdquo; vs &ldquo;validate&rdquo;).</li>\n<li>Never leave a blank &mdash; the TE has a &ge; 4 gate and an unanswered item is a guaranteed zero.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Practice</span> The items below are practice questions in the TE format, drawn from this course. Real past-exam questions will be added later in the exam room.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · TE</span>\n<h2>TE &mdash; nửa lý thuyết, 60 phút trắc nghiệm</h2>\n<p class=\"lead\">Syllabus gọi bài thi này là <strong>TE (Theory Exam)</strong>, không phải &ldquo;FE&rdquo;. Nó chiếm <strong>50%</strong> môn học, <strong>60 phút</strong>, <strong>trắc nghiệm máy chấm</strong>, có mốc hoàn thành riêng là <strong>4</strong>. Cùng với PE, nó tạo nên toàn bộ điểm: FR = min(10, (TE + PE) / 2 + Bonus).</p>\n<div class=\"callout warn\"><strong>Đính chính.</strong> Trang này trước đây gọi bài lý thuyết là &ldquo;FE&rdquo;. Tên trong bảng đánh giá của syllabus là <strong>TE</strong> &mdash; hãy dùng đúng tên khi hỏi phòng đào tạo hay đọc lịch thi, không thì bạn đang hỏi về một bài thi không tồn tại trong môn này.</div>\n\n<h3>Nội dung phủ</h3>\n<ul>\n<li><strong>Định nghĩa và phân biệt</strong>: dự án với vận hành, dự án &ndash; chương trình &ndash; danh mục, phạm vi sản phẩm với phạm vi dự án, quyền hạn với ảnh hưởng.</li>\n<li><strong>Quy trình</strong>: khởi tạo, lập kế hoạch, thực thi, giám sát &amp; kiểm soát, kết thúc; cái gì thuộc nhóm nào.</li>\n<li><strong>Phạm vi &amp; tiến độ</strong>: quy tắc 100%, WBS khác tiến độ, đường găng và float, crashing khác fast-tracking, các phương pháp ước lượng.</li>\n<li><strong>Rủi ro &amp; truyền thông</strong>: phân tích định tính với định lượng, bốn cách ứng phó rủi ro, kế hoạch truyền thông, các bước kiểm soát thay đổi.</li>\n<li><strong>Bên liên quan</strong>: nhận diện, lưới quyền lực/quan tâm, cách gắn kết.</li>\n</ul>\n\n<h3>Kỹ thuật cho 60 phút trắc nghiệm</h3>\n<ul>\n<li>Chia thời gian theo số câu trước khi bắt đầu; đánh dấu câu khó rồi quay lại.</li>\n<li>Trả lời theo <em>phương pháp được dạy trong môn</em>, không theo thói quen công sở &mdash; câu &ldquo;quản trị dự án nên làm gì tiếp theo&rdquo; chấm theo quy trình, không theo cảm tính.</li>\n<li>Loại hai phương án sai rõ trước; cặp còn lại thường chỉ khác một từ (&ldquo;tránh&rdquo; với &ldquo;giảm nhẹ&rdquo;, &ldquo;verify&rdquo; với &ldquo;validate&rdquo;).</li>\n<li>Đừng bỏ trống câu nào &mdash; TE có cổng &ge; 4 và câu bỏ trống chắc chắn là 0.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Luyện tập</span> Các câu dưới đây là câu luyện theo đúng dạng TE, lấy từ chính môn học. Đề thi thật sẽ được thêm sau, trong trang phòng thi.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
                ...
                "question": "A project is best defined as…|||Dự án được định nghĩa tốt nhất là…",
                "options": [
                  "ongoing repetitive work|||công việc lặp lại liên tục",
                  "a temporary effort producing a unique result|||nỗ lực tạm thời tạo kết quả duy nhất",
                  "any task with a computer|||bất kỳ việc gì có máy tính",
                  "a permanent department|||một phòng ban thường trực"
                ],
                "correctIndex": 1
              },
              {
                "id": "q2",
                "points": 1,
                "question": "In the triple constraint, if scope increases but time is fixed, then…|||Trong tam giác ràng buộc, nếu phạm vi tăng mà thời gian cố định, thì…",
                "options": [
                  "nothing else changes|||không gì khác đổi",
                  "cost and/or quality must change|||chi phí và/hoặc chất lượng phải đổi",
                  "the project is cancelled|||dự án bị huỷ",
                  "risk disappears|||rủi ro biến mất"
                ],
                "correctIndex": 1
              },
              {
                "id": "q3",
                "points": 1,
                "question": "A stakeholder with high power and high interest should be…|||Một bên liên quan quyền lực cao, quan tâm cao nên được…",
                "options": [
                  "monitored with minimal effort|||theo dõi tối thiểu",
                  "managed closely|||quản lý sát",
                  "ignored|||bỏ qua",
                  "kept uninformed|||giữ không thông tin"
                ],
                "correctIndex": 1
              },
              {
                "id": "q4",
                "points": 1,
                "question": "The project charter is primarily used to…|||Project charter chủ yếu dùng để…",
                "options": [
                  "list every task in detail|||liệt kê mọi việc chi tiết",
                  "authorise the project and empower the PM|||cho phép dự án và trao quyền cho PM",
                  "write the source code|||viết mã nguồn",
                  "replace the WBS|||thay thế WBS"
                ],
                "correctIndex": 1
              },
              {
                "id": "q5",
                "points": 1,
                "question": "Silently adding features without adjusting time or cost is called…|||Âm thầm thêm tính năng không chỉnh thời gian hay chi phí gọi là…",
                "options": [
                  "fast-tracking",
                  "scope creep",
                  "crashing",
              ...
              },
              {
                "id": "q6",
                "points": 1,
                "question": "Formal power to decide (e.g., signing the budget) is called… while informally swaying others is… (beyond-syllabus)|||Quyền chính thức để quyết (vd ký ngân sách) là… còn tác động phi chính thức người khác là… (ngoài giáo trình)",
                "options": [
                  "influence; authority|||ảnh hưởng; quyền hạn",
                  "authority; influence|||quyền hạn; ảnh hưởng",
                  "scope; cost|||phạm vi; chi phí",
                  "risk; quality|||rủi ro; chất lượng"
                ],
                "correctIndex": 1
              }
            ]
