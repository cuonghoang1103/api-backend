/**
 * PRS201 — Policy and Risk Management in Information Systems.
...
export default {
  ...
  course: {
    ...
    shortDescription: 'Subject in the FPTU curriculum — ngành Khoa học Máy tính, semester 3. Lessons are not written yet.|||Môn trong khung chương trình FPTU — ngành Khoa học Máy tính, kỳ 3. Bài giảng chưa được dựng.',
    description: 'Môn <strong>PRS201 — Policy and Risk Management in Information Systems</strong> thuộc khung chương trình ngành Khoa học Máy tính, kỳ 3.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
    whatYouLearn: 'Chưa có nội dung. Xem giáo trình chính thức trên FLM (flm.fpt.edu.vn) để biết chuẩn đầu ra của môn.',
    requirements: 'Xem điều kiện tiên quyết trong khung chương trình ngành Khoa học Máy tính trên FLM.',
  },
  sections: [],
};
