            ...
            "questions": [
              {
                "id": "q1",
                "points": 1,
                "question": "Node.js handles many concurrent connections using…|||Node.js xử lý nhiều kết nối đồng thời bằng…",
                "options": [
                  "one thread per connection|||một luồng mỗi kết nối",
                  "a single thread with an event loop|||một luồng đơn với event loop",
                  "multiple processes only|||chỉ nhiều tiến trình",
              ...
              },
              {
                "id": "q2",
                "points": 1,
                "question": "Which call is non-blocking?|||Lệnh nào không chặn?",
                "options": [
                  "fs.readFileSync()",
                  "fs.readFile(path, callback)",
                  "a huge for-loop",
                  "JSON.parse of a 1GB string"
                ],
                "correctIndex": 1
              },
              {
                "id": "q3",
                "points": 1,
                "question": "In CommonJS, you import a module with…|||Trong CommonJS, bạn import một module bằng…",
                "options": [
                  "import x from \"y\"",
                  "require(\"y\")",
                  "include \"y\"",
              ...
              },
              {
                "id": "q4",
                "points": 1,
                "question": "Which HTTP method should READ a resource without side effects?|||Method HTTP nào nên ĐỌC một tài nguyên không tác dụng phụ?",
                "options": [
                  "POST",
                  "GET",
                  "DELETE",
              ...
              },
              {
                "id": "q5",
                "points": 1,
                "question": "Putting a huge CPU-bound loop on the main thread will…|||Đặt một vòng lặp nặng CPU trên luồng chính sẽ…",
                "options": [
                  "speed up the server|||tăng tốc server",
                  "block the event loop and freeze other requests|||chặn event loop và đóng băng request khác",
                  "have no effect|||không ảnh hưởng",
                  "create new threads automatically|||tự tạo luồng mới"
                ],
                "correctIndex": 1
              },
              {
                "id": "q6",
                "points": 1,
                "question": "A resolved Promise callback runs before a setTimeout(…,0) because promises use the… (beyond-syllabus)|||Callback của một Promise đã resolve chạy trước setTimeout(…,0) vì promise dùng… (ngoài giáo trình)",
                "options": [
                  "timer queue|||hàng đợi timer",
                  "microtask queue|||hàng đợi microtask",
                  "call stack directly|||call stack trực tiếp",
                  "a separate thread|||một luồng riêng"
                ],
                "correctIndex": 1
              }
            ]
