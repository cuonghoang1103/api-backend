...
export default {
  ...
  course: {
    ...
    description: 'Môn <strong>SLN301 — Social Listening</strong> thuộc khung chương trình khối Công nghệ Truyền thông, kỳ 4.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
