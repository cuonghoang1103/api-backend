...
export default {
  ...
  course: {
    ...
    title: 'Advanced Business Communication/Kỹ năng giao tiếp n&#226;ng cao trong kinh doanh',
    level: 'BEGINNER',
    language: 'Vietnamese',
    status: 'PUBLISHED',
