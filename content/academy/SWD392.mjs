...
<table>
  ...
  <tbody>
    <tr><td>Course Project</td><td>25%</td><td>Team design of a complex system. Option 1: 30 slots; Option 2: constructivism. <b>The syllabus does not state a team size</b> — the rows "Final Evaluation (Team 1-2-3-4)" and "(Team 5-6)" are team <em>numbers</em> scheduled per session, not the number of members.</td><td><b>≥ 5</b></td></tr>
...
<div class="callout warn">The <strong>Course Project (25%, gate ≥5)</strong> is a team design of a complex system — not code, but a full design: use cases, analysis model, architecture, design with patterns, and a database. It is graded on design quality and defended in the final evaluation, which runs across <strong>sessions 55–59</strong> (teams 1–4, then teams 5–6) — session 60 is the course review.</div>
...
<table>
  ...
  <tbody>
    <tr><td>Course Project</td><td>25%</td><td>Nhóm thiết kế một hệ thống phức tạp. Option 1: 30 slot; Option 2: constructivism. <b>Syllabus KHÔNG nêu quy mô nhóm</b> — các dòng "Final Evaluation (Team 1-2-3-4)" và "(Team 5-6)" là SỐ HIỆU nhóm xếp theo buổi, không phải số thành viên.</td><td><b>≥ 5</b></td></tr>
...
<div class="callout warn"><strong>Course Project (25%, cổng ≥5)</strong> là một thiết kế nhóm cho một hệ thống phức tạp — không phải code, mà là một thiết kế đầy đủ: use case, analysis model, kiến trúc, thiết kế với pattern, và một cơ sở dữ liệu. Nó được chấm theo chất lượng thiết kế và bảo vệ ở buổi đánh giá cuối, trải từ <strong>buổi 55 đến buổi 59</strong> (nhóm 1–4, rồi nhóm 5–6) — buổi 60 là buổi ôn tập môn.</div>
...
<div class="callout warn"><b>What the syllabus actually assigns for CLO4.</b> Sessions 26&ndash;53 work through Gomaa's architecture chapters: overview and subsystem design (Ch 12&ndash;13), object-oriented architectures (Ch 14), client/server architectures with the Banking case study (Ch 15, 21), <b>service-oriented architectures (Ch 16 + Online Shopping case, sessions 42&ndash;45)</b>, <b>component-based architectures (Ch 17 + Emergency Monitoring case, sessions 46&ndash;49)</b> and <b>concurrent &amp; real-time architectures (Ch 18 + Light Rail case, sessions 50&ndash;53)</b>. This lesson teaches the general style catalogue that those chapters sit inside; the three Gomaa architectures in bold are <em>not yet covered here</em> &mdash; read Gomaa Ch 16&ndash;18 for them and expect them in the Theory Exam.</div>
...
<div class="callout warn"><b>Giáo trình thật sự giao gì cho CLO4.</b> Buổi 26&ndash;53 đi qua các chương kiến trúc của Gomaa: tổng quan và thiết kế hệ con (Ch 12&ndash;13), kiến trúc hướng đối tượng (Ch 14), kiến trúc client/server kèm case study Banking (Ch 15, 21), <b>kiến trúc hướng dịch vụ (Ch 16 + case Online Shopping, buổi 42&ndash;45)</b>, <b>kiến trúc dựa trên thành phần (Ch 17 + case Emergency Monitoring, buổi 46&ndash;49)</b> và <b>kiến trúc đồng thời &amp; thời gian thực (Ch 18 + case Light Rail, buổi 50&ndash;53)</b>. Bài này dạy danh mục kiểu kiến trúc tổng quát mà các chương đó nằm bên trong; ba kiến trúc Gomaa in đậm <em>chưa được dạy ở đây</em> &mdash; hãy đọc Gomaa Ch 16&ndash;18 và chuẩn bị gặp chúng trong Theory Exam.</div>
...
<div class="pitfall">Áp DDD hay microservices vào một project sinh viên nhỏ là over-engineer kiểu golden-hammer sách giáo khoa. Các cách này sinh lợi ở quy mô lớn và tốn phức tạp dưới nó. Trích chúng để cho thấy nhận thức; áp chúng chỉ khi quy mô project thực sự đáng.</div>
    ...
    {
      "title": "Final Exam — Practical (20%, 85') + Theory (40%, 60') = 60%, 145 minutes|||Thi cuối kỳ — Practical (20%, 85') + Theory (40%, 60') = 60%, 145 phút",
      "description": "Thi cuối kỳ của SWD392 có HAI phần, tổng 145 phút: Practical Exam 20% (85 phút, mô hình hoá/thiết kế áp dụng, cổng ≥ 4) và Theory Exam 40% (60 phút, cổng ≥ 4). SWD392 là môn THIẾT KẾ — PE không phải bài thi code.",
      "lessons": [
        {
          "title": "PE — Practical Exam (20%, 85'): applied modelling & design, not coding|||PE — Thi thực hành (20%, 85'): mô hình hoá & thiết kế áp dụng, không phải code",
