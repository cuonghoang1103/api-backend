/**
 * TTM202 — Quản trị điểm đến v&#224; Marketing.
...
export default {
  ...
  course: {
    ...
    title: 'Quản trị điểm đến v&#224; Marketing',
    level: 'BEGINNER',
    language: 'Vietnamese',
    status: 'PUBLISHED',
    ...
    description: 'Môn <strong>TTM202 — Quản trị điểm đến v&amp;#224; Marketing</strong> thuộc khung chương trình khối Quản trị Kinh doanh, kỳ 5.<br><br>Academy đã tạo sẵn môn này để bạn tra được mã môn, tên môn và vị trí trong lộ trình. <strong>Phần bài giảng chưa được dựng</strong> — khi có, toàn bộ nội dung sẽ được xây từ chính giáo trình của trường.',
