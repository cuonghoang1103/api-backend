...
<table>
<thead><tr><th>Component</th><th>Weight</th><th>Completion criterion</th><th>Duration</th><th>What is assessed</th></tr></thead>
<tbody>
<tr><td>On-going Assessment 1</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/team</td><td>Iteration 1: requirements, design, first working feature</td></tr>
<tr><td>On-going Assessment 2</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/team</td><td>Iteration 2: more features, backend/frontend integration</td></tr>
<tr><td>On-going Assessment 3</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/team</td><td>Iteration 3: near-complete app, quality &amp; teamwork</td></tr>
<tr><td>Final Project Presentation <em>(this is the final exam)</em></td><td><strong>40%</strong></td><td><strong>≥ 5</strong></td><td>45'/each</td><td>Full demo + defense (individual Q&A)</td></tr>
</tbody>
</table>
<div class="callout warn"><strong>There is no written exam, no multiple-choice FE and no PE in WDP301.</strong> The syllabus (ID 12037) lists exactly four assessments: three on-going assessments of 20% each (completion criterion <strong>&gt; 0</strong>, 45'/team — option 2 applies to Constructivism classes) and one <strong>Final Project Presentation, 40%, completion criterion 5, 45'/each</strong>, which <em>is</em> the final exam of this subject. Everything you are graded on comes from the team project.</div>
<div class="kv-grid">
...
<table>
<thead><tr><th>Thành phần</th><th>Trọng số</th><th>Điều kiện hoàn thành</th><th>Thời lượng</th><th>Đánh giá gì</th></tr></thead>
<tbody>
<tr><td>On-going Assessment 1</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/nhóm</td><td>Iteration 1: yêu cầu, thiết kế, tính năng đầu chạy được</td></tr>
<tr><td>On-going Assessment 2</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/nhóm</td><td>Iteration 2: thêm tính năng, tích hợp backend/frontend</td></tr>
<tr><td>On-going Assessment 3</td><td><strong>20%</strong></td><td><strong>&gt; 0</strong></td><td>45'/nhóm</td><td>Iteration 3: app gần hoàn chỉnh, chất lượng &amp; teamwork</td></tr>
<tr><td>Thuyết trình đồ án cuối <em>(chính là bài thi cuối kỳ)</em></td><td><strong>40%</strong></td><td><strong>≥ 5</strong></td><td>45'/người</td><td>Demo đầy đủ + bảo vệ (Q&A cá nhân)</td></tr>
</tbody>
</table>
<div class="callout warn"><strong>WDP301 KHÔNG có thi viết, KHÔNG có FE trắc nghiệm và KHÔNG có PE.</strong> Syllabus (ID 12037) liệt kê đúng bốn đầu điểm: ba On-going Assessment mỗi cái 20% (điều kiện hoàn thành <strong>&gt; 0</strong>, 45'/nhóm — phương án 2 dành cho lớp Constructivism) và một <strong>Final Project Presentation, 40%, điều kiện hoàn thành 5, 45'/người</strong> — đó chính là bài thi cuối kỳ của môn. Mọi điểm của bạn đều đến từ đồ án nhóm.</div>
<div class="kv-grid">
...
<div class="lz-layer"><span class="lz-lk">CLO3</span> "Proficiency in Web programming skills, <strong>based on the Java/DotNet programming language</strong>" (syllabus wording). <em>→ Construction</em></div>
...
<div class="callout warn"><strong>CLO3 is a known syllabus defect — read it as "the stack this class actually uses".</strong> The approved WDP301 syllabus (ID 12037) still says "based on the Java/DotNet programming language", a leftover from an older version of the subject. Everything else in the same syllabus is MERN: the prerequisites are FER201m + SDN301m (React and Node/Express), and the materials are <em>Pro MERN Stack</em>, <em>React Native for Mobile Development</em> and <em>Mastering React Native</em>. So in practice you build and are defended on a <strong>React + Node/Express</strong> stack — but the discrepancy is in the official text and is worth reporting to the faculty.</div>
...
<div class="lz-layer"><span class="lz-lk">CLO3</span> "Proficiency in Web programming skills, <strong>based on the Java/DotNet programming language</strong>" (nguyên văn syllabus). <em>→ Construction</em></div>
...
<div class="callout warn"><strong>CLO3 là một lỗi đã biết của syllabus — hãy đọc nó theo stack lớp thực sự dùng.</strong> Syllabus WDP301 được duyệt (ID 12037) vẫn ghi "based on the Java/DotNet programming language", sót lại từ phiên bản cũ của môn. Mọi thứ còn lại trong chính syllabus đó đều là MERN: môn tiên quyết là FER201m + SDN301m (React và Node/Express), tài liệu là <em>Pro MERN Stack</em>, <em>React Native for Mobile Development</em> và <em>Mastering React Native</em>. Nên trên thực tế bạn xây và bảo vệ trên stack <strong>React + Node/Express</strong> — nhưng chỗ vênh này nằm trong văn bản chính thức và nên được báo cho nhà trường.</div>
...
<p class="lead"><span class="badge">★ Beyond the syllabus</span> Sections 2–4 below (Docker deployment, performance tuning, real-time) aren't required to pass, but each one visibly lifts your project above a basic CRUD app — and demonstrating even one in the defense signals real engineering maturity.</p>
...
<p class="lead"><span class="badge">★ Ngoài giáo trình</span> Các mục 2–4 dưới đây (triển khai Docker, tối ưu hiệu năng, real-time) không bắt buộc để qua môn, nhưng mỗi cái nâng dự án của bạn lên trên một app CRUD cơ bản một cách nhìn thấy được — và trưng dù chỉ một cái khi bảo vệ cho thấy độ chín kỹ thuật thật.</p>
...
<div class="callout"><span class="badge">★ Ngoài giáo trình</span> <b>Một pipeline CI là cú "flex" cuối.</b> Một GitLab CI đơn giản chạy test mỗi lần push chứng minh kỷ luật chuyên nghiệp: repo luôn xanh, regression bị bắt tự động. Ít đội SV làm điều này — đội nào làm thì nổi bật ngay. <em>Thực hành ★ sâu nhất: tự động hóa giữ chất lượng cao mà không tốn công thủ công.</em></div>
    ...
    },
    {
      ...
      "description": "WDP301 không có PE và không có FE trắc nghiệm: bài thi cuối kỳ là Final Project Presentation (40%, điều kiện hoàn thành 5, 45'/người). Hai trang dưới nói rõ đầu điểm thật và cách chuẩn bị.",
      "lessons": [
        {
          "title": "PE — WDP301 has no practical exam: the 3 on-going assessments instead|||PE — WDP301 không có thi thực hành: thay vào đó là 3 On-going Assessment",
          "slug": "wdp301-final-exam-pe",
          "type": "article",
          "description": "WDP301 không có PE. Trang này giải thích đầu điểm thực hành thật của môn: 3 On-going Assessment (20% mỗi cái, >0, 45'/nhóm) và cách chuẩn bị.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · PE</span>\n<h2>There is no PE in WDP301 — your practical work is graded in the 3 on-going assessments</h2>\n<p class=\"lead\">WDP301 has <strong>no practical exam sitting</strong>. The syllabus (ID 12037) lists four assessments only: <strong>On-going Assessment 1, 2 and 3</strong> &mdash; 20% each, completion criterion <strong>&gt; 0</strong>, 45'/team &mdash; and the <strong>Final Project Presentation</strong> (40%, completion criterion 5, 45'/each), which is the final exam. There is no separate coding sitting and no written paper: what you build in the team project <em>is</em> the practical assessment.</p>\n<h3>What each on-going assessment actually is</h3>\n<table>\n<thead><tr><th>Checkpoint</th><th>Weight</th><th>Your team shows</th></tr></thead>\n<tbody>\n<tr><td>On-going 1 (end of Iteration 1)</td><td>20%</td><td>Requirements &amp; actors, data model, project setup on GitLab, first working feature end-to-end</td></tr>\n<tr><td>On-going 2 (end of Iteration 2)</td><td>20%</td><td>More features, backend/frontend integration, business rules implemented in your assigned screens</td></tr>\n<tr><td>On-going 3 (end of Iteration 3)</td><td>20%</td><td>Near-complete app, quality, self-tested flows, evidence of real teamwork in the commit history</td></tr>\n</tbody>\n</table>\n<p>Each is run live with the teacher: a 45-minute team session in which you demo what the iteration produced and answer the session's constructive questions individually (\"which tables do your screens read?\", \"what business rules did you implement?\", \"which Git commands do you use to manage the source?\").</p>\n<h3>How to prepare for a checkpoint</h3>\n<ul>\n<li>Have the branch <strong>running</strong> before the session &mdash; a demo that does not start scores as not delivered.</li>\n<li>Be able to open <em>your own</em> code and walk through it: route &rarr; controller &rarr; service &rarr; model, and where the screen calls it.</li>\n<li>Rehearse the constructive questions of that session (see 7.1) &mdash; they are asked person by person.</li>\n<li>Self-test each assigned flow before the demo; the syllabus names \"self-test\" in most practice sessions.</li>\n<li>Commit steadily: the GitLab history is the evidence of who did what.</li>\n</ul>\n<div class=\"callout warn\"><strong>A zero on any on-going assessment fails the subject</strong> &mdash; the completion criterion is &gt; 0. Missing a checkpoint is not \"losing 20%\", it is not completing the course.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · PE</span>\n<h2>WDP301 không có PE — phần thực hành được chấm ở 3 On-going Assessment</h2>\n<p class=\"lead\">WDP301 <strong>không có ca thi thực hành</strong> nào. Syllabus (ID 12037) chỉ liệt kê bốn đầu điểm: <strong>On-going Assessment 1, 2 và 3</strong> &mdash; mỗi cái 20%, điều kiện hoàn thành <strong>&gt; 0</strong>, 45'/nhóm &mdash; và <strong>Final Project Presentation</strong> (40%, điều kiện hoàn thành 5, 45'/người) chính là bài thi cuối kỳ. Không có ca code riêng, không có bài viết: thứ bạn xây trong đồ án nhóm <em>chính là</em> phần đánh giá thực hành.</p>\n<h3>Mỗi On-going Assessment thực chất là gì</h3>\n<table>\n<thead><tr><th>Mốc</th><th>Trọng số</th><th>Nhóm bạn phải trình ra</th></tr></thead>\n<tbody>\n<tr><td>On-going 1 (cuối Iteration 1)</td><td>20%</td><td>Yêu cầu &amp; actor, mô hình dữ liệu, dựng dự án trên GitLab, tính năng đầu tiên chạy thông đầu-cuối</td></tr>\n<tr><td>On-going 2 (cuối Iteration 2)</td><td>20%</td><td>Thêm tính năng, tích hợp backend/frontend, cài đặt quy tắc nghiệp vụ trên màn hình được giao</td></tr>\n<tr><td>On-going 3 (cuối Iteration 3)</td><td>20%</td><td>App gần hoàn chỉnh, chất lượng, luồng đã tự kiểm, bằng chứng teamwork thật trong lịch sử commit</td></tr>\n</tbody>\n</table>\n<p>Mỗi mốc chạy trực tiếp với giảng viên: một buổi 45 phút cho nhóm, bạn demo thứ iteration làm ra và trả lời các câu hỏi kiến tạo của buổi đó theo TỪNG NGƯỜI (\"màn hình của bạn đọc những bảng nào?\", \"bạn cài quy tắc nghiệp vụ nào?\", \"bạn dùng lệnh Git nào để quản lý mã nguồn?\").</p>\n<h3>Chuẩn bị cho một mốc thế nào</h3>\n<ul>\n<li>Nhánh phải <strong>chạy được</strong> trước buổi &mdash; demo không khởi động nổi bị tính như không nộp.</li>\n<li>Mở được <em>code của chính bạn</em> và đi qua nó: route &rarr; controller &rarr; service &rarr; model, và chỗ màn hình gọi vào.</li>\n<li>Tập trước các câu hỏi kiến tạo của buổi đó (xem bài 7.1) &mdash; chúng được hỏi lần lượt từng người.</li>\n<li>Tự kiểm từng luồng được giao trước khi demo; syllabus ghi \"self-test\" trong hầu hết các buổi thực hành.</li>\n<li>Commit đều đặn: lịch sử GitLab là bằng chứng ai làm gì.</li>\n</ul>\n<div class=\"callout warn\"><strong>Điểm 0 ở bất kỳ On-going Assessment nào là trượt môn</strong> &mdash; điều kiện hoàn thành là &gt; 0. Vắng một mốc không phải \"mất 20%\", mà là không hoàn thành môn học.</div>\n</div>"
        },
        {
          "title": "FE — Final Project Presentation (40%, pass mark 5, 45'/each)|||FE — Thuyết trình đồ án cuối kỳ (40%, điểm qua 5, 45'/người)",
          "slug": "wdp301-final-exam-fe",
          "type": "article",
          "description": "Bài thi cuối kỳ của WDP301 là Final Project Presentation: 40%, điều kiện hoàn thành 5, 45'/người — demo + bảo vệ cá nhân. Không có đề trắc nghiệm.",
          "content": "\n<div class=\"ml-en\">\n<span class=\"eyebrow\">Final Exam · FE</span>\n<h2>FE — the final exam of WDP301 is the Final Project Presentation</h2>\n<p class=\"lead\">There is <strong>no multiple-choice paper and no written exam</strong> in this subject. The syllabus (ID 12037) records the final exam as <strong>\"Final Project Presentation\" &mdash; weight 40%, completion criterion 5, duration 45'/each</strong>. You pass it by demoing the product your team built and defending your own contribution in person; you need at least <strong>5</strong> on it, plus a final result &ge; 5 and &ge; 80% attendance to be accepted to the presentation at all.</p>\n<h3>What the session looks like</h3>\n<table>\n<thead><tr><th>Stage</th><th>Roughly</th><th>What the panel is judging</th></tr></thead>\n<tbody>\n<tr><td>Product demo</td><td>15-20'</td><td>Does the app run? Does the main flow work end-to-end on real data, without a rehearsed happy path?</td></tr>\n<tr><td>Technical walkthrough</td><td>10'</td><td>Architecture (MVC layering), data model, how front-end and back-end integrate, quality of the code you show</td></tr>\n<tr><td>Individual Q&amp;A</td><td>10-15'</td><td>Each member is questioned on <em>their own</em> screens/modules: what you wrote, why, how it integrates (CLO1-CLO5)</td></tr>\n</tbody>\n</table>\n<h3>How to score well</h3>\n<ul>\n<li>Freeze the code a day early and rehearse the demo on the <strong>deployed/clean-checkout</strong> build, not on your dev machine's lucky state.</li>\n<li>Prepare a 15-minute demo script that follows one user story end-to-end; never open the IDE to \"fix\" something live.</li>\n<li>Know your own slice cold: route &rarr; controller &rarr; service &rarr; model, the tables it touches, the business rules it enforces.</li>\n<li>Have answers ready for the standard defence questions: how tasks were assigned and tracked, what you would improve, what the team learned (syllabus CQ18.1-18.3).</li>\n<li>Bring evidence &mdash; GitLab history, issue board, test notes. A claim about teamwork that the repository contradicts costs marks.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Self-check</span> The questions below are <strong>not</strong> an exam format &mdash; WDP301 has no MCQ paper. They are a quick self-check on the core technical facts you should be able to state instantly during the technical walkthrough and the individual Q&amp;A.</div>\n</div>\n<div class=\"ml-vi\">\n<span class=\"eyebrow\">Thi cuối kỳ · FE</span>\n<h2>FE — bài thi cuối kỳ của WDP301 là Thuyết trình đồ án</h2>\n<p class=\"lead\">Môn này <strong>không có đề trắc nghiệm và không có thi viết</strong>. Syllabus (ID 12037) ghi bài thi cuối kỳ là <strong>\"Final Project Presentation\" &mdash; trọng số 40%, điều kiện hoàn thành 5, thời lượng 45'/người</strong>. Bạn qua bằng cách demo sản phẩm nhóm đã xây và bảo vệ trực tiếp phần đóng góp của chính mình; cần tối thiểu <strong>5</strong> ở bài này, cộng kết quả cuối &ge; 5 và điểm danh &ge; 80% mới được vào bảo vệ.</p>\n<h3>Buổi bảo vệ diễn ra thế nào</h3>\n<table>\n<thead><tr><th>Phần</th><th>Khoảng</th><th>Hội đồng chấm gì</th></tr></thead>\n<tbody>\n<tr><td>Demo sản phẩm</td><td>15-20'</td><td>App có chạy không? Luồng chính có thông đầu-cuối trên dữ liệu thật, không phải đường mòn đã tập?</td></tr>\n<tr><td>Đi qua kỹ thuật</td><td>10'</td><td>Kiến trúc (phân lớp MVC), mô hình dữ liệu, front-end và back-end tích hợp ra sao, chất lượng đoạn code bạn mở</td></tr>\n<tr><td>Q&amp;A cá nhân</td><td>10-15'</td><td>Từng thành viên bị hỏi về <em>màn hình/module của chính mình</em>: bạn viết gì, vì sao, tích hợp thế nào (CLO1-CLO5)</td></tr>\n</tbody>\n</table>\n<h3>Cách ăn điểm cao</h3>\n<ul>\n<li>Đóng băng code trước một ngày và tập demo trên bản <strong>deploy/clone sạch</strong>, không phải trên trạng thái may mắn của máy bạn.</li>\n<li>Chuẩn bị kịch bản demo 15 phút đi trọn MỘT user story; tuyệt đối không mở IDE \"sửa nhanh\" giữa buổi.</li>\n<li>Thuộc lát cắt của mình: route &rarr; controller &rarr; service &rarr; model, bảng nó chạm, quy tắc nghiệp vụ nó bảo đảm.</li>\n<li>Sẵn câu trả lời cho các câu bảo vệ chuẩn: giao và theo dõi việc thế nào, sẽ cải thiện gì, nhóm học được gì (CQ18.1-18.3 trong syllabus).</li>\n<li>Mang bằng chứng &mdash; lịch sử GitLab, bảng issue, ghi chú kiểm thử. Lời khai về teamwork mà repo phản bác thì mất điểm.</li>\n</ul>\n<div class=\"callout\"><span class=\"badge\">Tự kiểm</span> Các câu dưới đây <strong>không phải</strong> format thi &mdash; WDP301 không có đề trắc nghiệm. Đó là bài tự kiểm nhanh những sự thật kỹ thuật cốt lõi bạn phải nói ra được ngay trong phần đi qua kỹ thuật và Q&amp;A cá nhân.</div>\n</div>",
          "quiz": {
            "timeLimitSeconds": 360,
            "questions": [
              {
