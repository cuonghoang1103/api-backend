...
const QUIZ1 = {
  ...
  quiz: {
    ...
    questions: [
      q('Which of the following is a main goal of software testing? (SWT1 s.8)|||Đâu là mục tiêu chính của kiểm thử phần mềm? (SWT1 s.8)', ['Assess the quality of the software|||Đánh giá chất lượng phần mềm', 'Increase the quality of the software|||Nâng cao chất lượng phần mềm'], 0, 'Testing measures quality and gives information about it (SWT1 slide 8, lesson 1.1). "Increase the quality" is the classic trap: quality only rises when someone fixes the defects, which is development work, not testing.|||Kiểm thử đo chất lượng và cung cấp thông tin về nó (SWT1 slide 8, bài 1.1). "Nâng cao chất lượng" là bẫy kinh điển: chất lượng chỉ tăng khi có người sửa defect, đó là việc phát triển chứ không phải kiểm thử.'),
      q('If you find a defect early in the lifecycle, what is impacted? (s.9)|||Tìm ra defect sớm trong vòng đời thì điều gì bị ảnh hưởng? (s.9)', ['Risk of meeting it in operation increases|||Rủi ro gặp nó khi vận hành tăng', 'Risk of meeting it in operation is not impacted|||Rủi ro gặp nó khi vận hành không đổi', 'Risk of meeting it in operation is reduced|||Rủi ro gặp nó khi vận hành giảm'], 2, 'A defect found and fixed before release can no longer show up as a failure in production, so the risk of meeting it in operation is reduced (slide 9); fixing it early is also much cheaper (slide 45). "Not impacted" is wrong because the defect is removed before users can meet it.|||Defect được tìm và sửa trước khi phát hành thì không thể lộ thành failure trên production nữa, nên rủi ro gặp nó khi vận hành giảm (slide 9); sửa sớm còn rẻ hơn nhiều (slide 45). "Không đổi" là sai vì defect đã bị gỡ trước khi người dùng gặp.'),
      q('What is the main role of the tester? (s.10)|||Vai trò chính của tester là gì? (s.10)', ['Resolve defects|||Sửa defect', 'Develop applications|||Phát triển ứng dụng', 'Find defects|||Tìm defect'], 2, 'The tester\'s core role is to find defects and report them (slide 10). Resolving defects is debugging and developing applications is coding; both are developer tasks.|||Vai trò cốt lõi của tester là tìm defect và báo cáo (slide 10). Sửa defect là debugging, còn phát triển ứng dụng là viết code; cả hai đều là việc của developer.'),
      q('Software testing is a way to… (s.11)|||Kiểm thử phần mềm là cách để… (s.11)', ['Increase the quality of the software|||Nâng cao chất lượng phần mềm', 'Reduce the risk of software failure in operation|||Giảm rủi ro phần mềm hỏng khi vận hành'], 1, 'The ISTQB definition (slide 7) says testing assesses quality and reduces the risk of software failure in operation (slide 11). "Increase the quality" is the same trap as slide 8: testing only reveals defects, and it is fixing them that raises quality.|||Định nghĩa ISTQB (slide 7) nói kiểm thử đánh giá chất lượng và giảm rủi ro phần mềm hỏng khi vận hành (slide 11). "Nâng cao chất lượng" là cùng cái bẫy của slide 8: kiểm thử chỉ làm lộ defect, việc sửa defect mới làm chất lượng tăng.'),
      q('In the 7-activity test process, test execution is step number… (s.16)|||Trong quy trình 7 hoạt động, test execution là bước thứ… (s.16)', ['4', '5', '6', '7'], 2, 'The seven activity groups in order are planning, monitoring and control, analysis, design, implementation, execution, completion, so execution is number 6 (slide 16, lesson 1.1). Answering 5 usually means forgetting monitoring and control, which runs alongside the others but is still one of the seven.|||Bảy nhóm hoạt động theo thứ tự: planning, monitoring & control, analysis, design, implementation, execution, completion, nên execution là bước 6 (slide 16, bài 1.1). Chọn 5 thường là quên monitoring & control, hoạt động chạy song song nhưng vẫn là một trong bảy.'),
      q('Checking whether the developer commented the code properly is… (s.17)|||Kiểm tra developer có chú thích code đầy đủ không là… (s.17)', ['Dynamic testing|||Kiểm thử động', 'Static testing|||Kiểm thử tĩnh'], 1, 'You read the source code to judge its comments and execute nothing, so it is static testing (slide 17). Any review of code or documents without running them is static; dynamic testing requires executing the software.|||Bạn đọc mã nguồn để đánh giá chú thích và không chạy gì cả, nên đây là kiểm thử tĩnh (slide 17). Mọi việc xem xét code hay tài liệu mà không chạy đều là static; dynamic testing đòi hỏi phải chạy phần mềm.'),
      q('"Building the right product" and "building the product right" are… (s.18)|||"Làm đúng sản phẩm" và "làm sản phẩm đúng cách" lần lượt là… (s.18)', ['Validation and verification|||Validation và verification', 'Verification and validation|||Verification và validation'], 0, 'Building the right product means matching the real need, which is validation; building the product right means matching the specification, which is verification (slides 15 and 18, the shirt example). The other option simply swaps the two terms.|||Làm đúng sản phẩm là khớp với nhu cầu thật, tức validation; làm sản phẩm đúng cách là khớp với đặc tả, tức verification (slide 15 và 18, ví dụ chiếc áo). Phương án còn lại chỉ đảo hai thuật ngữ.'),
      q('A developer runs his code and finds a defect. This is… (s.19)|||Developer chạy code của mình và thấy defect. Đây là… (s.19)', ['Static testing|||Kiểm thử tĩnh', 'Dynamic testing|||Kiểm thử động', 'System testing|||System testing'], 1, 'Running the code is dynamic testing, whoever does it (slide 19). It is not static testing because the code is executed, and not system testing, which is a test level on the complete integrated system.|||Chạy code là kiểm thử động, bất kể ai chạy (slide 19). Không phải static vì code đã được chạy, cũng không phải system testing vì đó là một cấp test trên cả hệ thống đã tích hợp.'),
      q('Which can be one main objective of software testing? (s.21)|||Đâu có thể là một mục tiêu chính của kiểm thử? (s.21)', ['Market the product to customers|||Quảng bá sản phẩm tới khách hàng', 'Give the client good knowledge about the project status|||Cho khách hàng nắm rõ tình trạng dự án', 'Decide colleagues\' bonuses|||Xét thưởng cho đồng nghiệp'], 1, 'Giving the client good knowledge of the project status is the objective "providing information to stakeholders" (slide 20, box 6; slide 21). Marketing the product and deciding colleagues\' bonuses are not testing objectives at all.|||Cho khách hàng nắm rõ tình trạng dự án chính là mục tiêu "cung cấp thông tin cho các bên liên quan" (slide 20, ô 6; slide 21). Quảng bá sản phẩm và xét thưởng đồng nghiệp hoàn toàn không phải mục tiêu kiểm thử.'),
      q('A tester reviews requirements and finds a contradiction. Which objective is achieved? (s.22)|||Tester review yêu cầu và thấy mâu thuẫn. Đạt được mục tiêu nào? (s.22)', ['Building confidence|||Tạo niềm tin', 'Compliance with laws|||Tuân thủ luật', 'Preventing defects|||Ngăn ngừa defect'], 2, 'The contradiction is removed before anyone writes code, so the code defect it would have caused never exists: that is preventing defects (slide 22). Building confidence is a real objective, but it is not what finding a contradiction in the requirements achieves.|||Mâu thuẫn được gỡ trước khi ai đó viết code, nên defect trong code mà nó lẽ ra gây ra không bao giờ xuất hiện: đó là ngăn ngừa defect (slide 22). Tạo niềm tin là mục tiêu thật, nhưng không phải cái mà việc tìm ra mâu thuẫn trong yêu cầu đạt được.'),
      q('Component testing happens early. Which objective does it serve? (s.23)|||Component testing diễn ra sớm. Nó phục vụ mục tiêu nào? (s.23)', ['Reduce risk|||Giảm rủi ro', 'Give information to stakeholders|||Cung cấp thông tin cho các bên', 'Compliance with laws|||Tuân thủ luật'], 0, 'Finding defects early in each component reduces the risk that they escape to integration, system testing or operation (slide 23, lesson 1.1). Giving information to stakeholders and compliance with laws fit acceptance or regulatory testing better than early component testing.|||Tìm defect sớm ở từng thành phần làm giảm rủi ro chúng lọt lên integration, system testing hay vận hành (slide 23, bài 1.1). Cung cấp thông tin cho các bên và tuân thủ luật hợp với acceptance hoặc kiểm định hơn là component testing làm sớm.'),
      q('Which is NOT an objective of software testing? (s.24)|||Đâu KHÔNG phải mục tiêu kiểm thử? (s.24)', ['Requirements fulfilment|||Đáp ứng yêu cầu', 'Building confidence in components|||Tạo niềm tin vào thành phần', 'Preventing defects|||Ngăn ngừa defect', 'Reducing project duration|||Rút ngắn thời gian dự án'], 3, 'Requirements fulfilment, building confidence and preventing defects are all among the objectives on slide 20. Testing may save time indirectly, but reducing project duration is not one of its objectives (slide 24).|||Đáp ứng yêu cầu, tạo niềm tin và ngăn ngừa defect đều nằm trong các mục tiêu ở slide 20. Kiểm thử có thể gián tiếp tiết kiệm thời gian, nhưng rút ngắn thời gian dự án không phải mục tiêu của nó (slide 24).'),
      q('Designing test cases early verifies the test basis. Which objective? (s.25)|||Thiết kế test sớm giúp verify test basis. Mục tiêu nào? (s.25)', ['Gaining confidence|||Tạo niềm tin', 'Finding defects|||Tìm defect', 'Preventing defects|||Ngăn ngừa defect', 'Providing information for decisions|||Cung cấp thông tin ra quyết định'], 2, 'Designing test cases forces you to read the requirements precisely, so ambiguities and gaps are fixed before coding: that prevents defects (slide 25, an official ISTQB sample question). Finding defects is tempting, but the point here is that the defects never reach the code.|||Thiết kế test case buộc bạn đọc yêu cầu thật kỹ, nên chỗ mơ hồ và thiếu sót được sửa trước khi code: đó là ngăn ngừa defect (slide 25, câu trong đề mẫu ISTQB). Finding defects nghe hợp lý, nhưng ý chính ở đây là defect không bao giờ vào tới code.'),
      q('Making sure what you built is what the client wants mostly meets… (s.26)|||Đảm bảo cái mình làm ra đúng cái khách hàng muốn chủ yếu đạt… (s.26)', ['Reducing risks|||Giảm rủi ro', 'Finding defects|||Tìm defect', 'Requirements fulfilment|||Đáp ứng yêu cầu'], 2, 'Checking the product against what the client asked for is requirements fulfilment (slide 20, box 2; slide 26). Reducing risks and finding defects are real objectives too, but they are not what this activity mainly achieves.|||Đối chiếu sản phẩm với cái khách hàng yêu cầu là mục tiêu đáp ứng yêu cầu (slide 20, ô 2; slide 26). Giảm rủi ro và tìm defect cũng là mục tiêu thật, nhưng không phải cái hoạt động này chủ yếu đạt được.'),
      q('Which is a correct definition of debugging? (s.28)|||Định nghĩa đúng của debugging? (s.28)', ['Checking whether the software performs correctly|||Kiểm tra phần mềm chạy đúng không', 'Checking no unintended consequences after a fix|||Kiểm tra không có hậu quả ngoài ý muốn sau khi sửa', 'Identifying the cause of a defect, repairing the code and checking the fix|||Xác định nguyên nhân defect, sửa code và kiểm bản sửa', 'Checking a reported defect has been corrected|||Kiểm tra defect đã báo đã được sửa'], 2, 'Debugging means finding the cause of a defect, repairing the code and checking the fix (slide 28). The other options describe testing, regression testing ("no unintended consequences") and confirmation testing ("the reported defect has been corrected").|||Debugging là tìm nguyên nhân defect, sửa code và kiểm tra bản sửa (slide 28). Các phương án còn lại lần lượt là testing, regression testing ("không có hậu quả ngoài ý muốn") và confirmation testing ("defect đã báo đã được sửa").'),
      q('In which lifecycle may testers be involved in debugging and component testing? (s.29)|||Trong mô hình nào tester có thể tham gia debugging và component testing? (s.29)', ['Waterfall', 'Agile development|||Phát triển Agile', 'V-model'], 1, 'The note on slide 27 says that in Agile development (and some other lifecycles) testers may be involved in debugging and component testing, because the whole team works together (slide 29). Waterfall and the V-model keep testing as separate phases handled by a test team.|||Ghi chú ở slide 27 nói trong Agile (và một số mô hình khác) tester có thể tham gia debugging và component testing, vì cả nhóm cùng làm (slide 29). Waterfall và V-model tách kiểm thử thành các pha riêng do nhóm test phụ trách.'),
      q('Which is an example of debugging? (s.30)|||Đâu là ví dụ về debugging? (s.30)', ['A tester finds a defect and reports it|||Tester tìm defect và báo cáo', 'A tester retests a fix and finds a regression|||Tester test lại bản sửa và thấy lỗi hồi quy', 'A developer finds and fixes a defect|||Developer tìm và sửa defect', 'A developer performs unit testing|||Developer làm unit test'], 2, 'A developer finding and fixing a defect is debugging (slide 30). A developer performing unit testing is the tempting option, but that is component testing, a testing activity even when a developer does it; the tester options are testing/reporting and confirmation/regression testing.|||Developer tìm và sửa defect là debugging (slide 30). Developer làm unit test là phương án dễ nhầm, nhưng đó là component testing, vẫn là hoạt động kiểm thử dù developer làm; hai phương án về tester là test/báo lỗi và confirmation/regression testing.'),
      q('Which BEST describes testing vs debugging? (s.31)|||Câu nào mô tả ĐÚNG NHẤT testing vs debugging? (s.31)', ['Testing pinpoints defects; debugging proposes prevention|||Testing chỉ ra defect; debugging đề xuất phòng ngừa', 'Dynamic testing shows failures caused by defects; debugging finds, analyses and removes their causes|||Kiểm thử động làm lộ failure do defect; debugging tìm, phân tích và gỡ nguyên nhân', 'Testing removes faults; debugging identifies causes|||Testing gỡ lỗi; debugging xác định nguyên nhân', 'Dynamic testing prevents failures; debugging removes failures|||Kiểm thử động ngăn failure; debugging gỡ failure'], 1, 'Word for word from the syllabus: dynamic testing shows failures caused by defects, debugging finds, analyses and removes their causes (slide 31). Option a is wrong because proposing prevention is root cause analysis; testing never removes faults, and debugging removes causes, not failures.|||Đúng từng chữ syllabus: kiểm thử động làm lộ failure do defect gây ra, debugging tìm, phân tích và gỡ nguyên nhân (slide 31). Phương án a sai vì đề xuất phòng ngừa là root cause analysis; testing không bao giờ gỡ lỗi, còn debugging gỡ nguyên nhân chứ không gỡ failure.'),
      q('Which statement describes a failure? (s.49)|||Câu nào mô tả một failure? (s.49)', ['The product crashed when the user selected an option|||Sản phẩm crash khi người dùng chọn một tuỳ chọn', 'The wrong version of a source file was built|||Build nhầm phiên bản một file mã nguồn', 'The algorithm used the wrong input variables|||Thuật toán dùng sai biến đầu vào', 'The developer misinterpreted the requirement|||Developer hiểu sai yêu cầu'], 0, 'A failure is an observable event at run time, such as a crash (slide 49, lesson 1.2). A wrong file version in the build and an algorithm using the wrong variables are defects; misinterpreting the requirement is an error (mistake).|||Failure là sự kiện quan sát được khi chạy, ví dụ crash (slide 49, bài 1.2). Build nhầm phiên bản file và thuật toán dùng sai biến là defect; hiểu sai yêu cầu là error (mistake).'),
      q('Choose the correct statement about root cause analysis. (s.50)|||Chọn câu đúng về phân tích nguyên nhân gốc. (s.50)', ['It applies to software only|||Chỉ áp dụng cho phần mềm', 'Root causes are the earliest actions but RCA destroys the process|||Nguyên nhân gốc là hành động sớm nhất nhưng RCA phá huỷ quy trình', 'It applies in all lifecycle steps and prevents many future defects|||Áp dụng ở mọi bước vòng đời và ngăn nhiều defect về sau'], 2, 'Slide 47 says root cause analysis can be applied in every lifecycle step and prevents many future defects (slide 50). It is not limited to software, and it improves the process rather than destroying it.|||Slide 47 nói root cause analysis áp dụng được ở mọi bước vòng đời và ngăn được nhiều defect về sau (slide 50). Nó không chỉ dành cho phần mềm, và nó cải tiến quy trình chứ không phá huỷ quy trình.'),
      q('Which statement is correct? (s.51)|||Câu nào đúng? (s.51)', ['An error results in a failure seen as a fault when executed|||Error gây failure, lộ ra như fault khi chạy', 'A failure results in a defect seen as a mistake|||Failure gây defect, lộ ra như mistake', 'A mistake causes a defect that may be seen as a failure during dynamic testing|||Mistake gây defect, có thể lộ thành failure khi kiểm thử động', 'A mistake causes a bug seen as a defect when executed|||Mistake gây bug, lộ ra như defect khi chạy'], 2, 'The chain is mistake (error) → defect → failure, and failures show up when the software is executed, for example during dynamic testing (slide 51, slides 39–40). Every other option scrambles the order, e.g. an error causing a failure that is "seen as a fault".|||Chuỗi đúng là mistake (error) → defect → failure, và failure lộ ra khi phần mềm được chạy, ví dụ lúc kiểm thử động (slide 51, slide 39–40). Các phương án khác đều đảo thứ tự, ví dụ error gây failure rồi "lộ ra như fault".'),
      q('1 legal/contract may require testing; 2 testing mainly improves developers\' work; 3 testing + fixing reduces operational risk; 4 testing proves all failures are found. (s.52)|||1 luật/hợp đồng có thể bắt buộc test; 2 test chủ yếu để cải thiện công việc dev; 3 test + sửa giảm rủi ro vận hành; 4 test chứng minh đã tìm hết failure. (s.52)', ['2 & 3 true|||2 & 3 đúng', '1 & 4 true|||1 & 4 đúng', '1 & 3 true|||1 & 3 đúng', '3 & 4 true|||3 & 4 đúng'], 2, 'Statement 1 is true (contracts or law may require testing) and 3 is true (rigorous testing plus fixing reduces operational risk). 2 is false because testing serves all stakeholders, and 4 is false because testing can never prove that all failures have been found (slide 52, Principle 1).|||Câu 1 đúng (hợp đồng hoặc luật có thể bắt buộc kiểm thử) và câu 3 đúng (test kỹ và sửa lỗi giảm rủi ro vận hành). Câu 2 sai vì kiểm thử phục vụ mọi bên liên quan, câu 4 sai vì không bao giờ chứng minh được đã tìm hết failure (slide 52, Nguyên tắc 1).'),
      q('Which statement correctly describes a testing principle? (s.68)|||Câu nào mô tả đúng một nguyên tắc kiểm thử? (s.68)', ['Automation makes it possible to test everything|||Tự động hoá giúp test được mọi thứ', 'With enough effort exhaustive testing is feasible|||Đủ nỗ lực thì test vét cạn khả thi', 'It is normally impossible to test all input/output combinations|||Thường không thể test mọi tổ hợp vào/ra', 'Testing proves the absence of defects|||Kiểm thử chứng minh không có defect'], 2, 'Principle 2: exhaustive testing is impossible, so it is normally impossible to test all input/output combinations (slide 68). Automation or "sufficient effort" do not make it possible, and "testing proves the absence of defects" contradicts Principle 1.|||Nguyên tắc 2: không thể test vét cạn, nên thường không thể test mọi tổ hợp đầu vào/đầu ra (slide 68). Tự động hoá hay "đủ nỗ lực" cũng không làm được, còn "kiểm thử chứng minh không có defect" trái với Nguyên tắc 1.'),
      q('Why avoid the pesticide paradox? (s.69)|||Vì sao phải tránh pesticide paradox? (s.69)', ['Dynamic testing is less reliable|||Kiểm thử động kém tin cậy', 'Pesticides mixed with static testing hide bugs|||Thuốc trừ sâu trộn với static testing làm lọt bug', 'Tests should not be context dependent|||Test không nên phụ thuộc ngữ cảnh', 'Running the same tests again reduces the chance of finding new defects|||Chạy lại cùng test làm giảm khả năng tìm defect mới'], 3, 'The pesticide paradox (Principle 5) is exactly this: running the same tests over and over finds fewer and fewer new defects, so tests must be reviewed and refreshed (slides 65 and 69). The other options are distractors built from unrelated words.|||Pesticide paradox (Nguyên tắc 5) chính là điều này: chạy đi chạy lại cùng các test sẽ tìm được ngày càng ít defect mới, nên phải xem lại và làm mới test (slide 65 và 69). Các phương án khác là nhiễu ghép từ những chữ không liên quan.'),
      q('True statement about exhaustive testing? (s.70)|||Câu đúng về test vét cạn? (s.70)', ['A form of stress testing|||Một dạng stress test', 'Not feasible except for trivial software|||Không khả thi trừ phần mềm tầm thường', 'Commonly done with automation|||Thường làm bằng tự động hoá', 'The developer\'s job in unit testing|||Việc của developer khi unit test'], 1, 'Word for word from Principle 2: exhaustive testing is not feasible except for trivial software (slides 55 and 70). It is not a kind of stress testing, automation does not make it feasible, and it is nobody\'s job in unit testing because nobody can do it.|||Đúng từng chữ Nguyên tắc 2: test vét cạn không khả thi, trừ phần mềm tầm thường (slide 55 và 70). Nó không phải một dạng stress test, tự động hoá không làm nó khả thi, và không phải việc của ai khi unit test vì không ai làm nổi.'),
      q('Team finds 90–95% of defects, users happy, failures low-impact; which principle explains why some defects are missed? (s.71)|||Nhóm tìm 90–95% defect, người dùng hài lòng, failure ít tác động; nguyên tắc nào giải thích việc vẫn sót defect? (s.71)', ['Pesticide paradox', 'Defect clustering', 'Exhaustive testing is impossible|||Không thể test vét cạn', 'Absence-of-errors fallacy|||Ngộ nhận không có lỗi'], 2, 'Because exhaustive testing is impossible, some defects always escape; 90–95% detection with happy users and low-impact failures is a good risk-based result (slide 71). The absence-of-errors fallacy is tempting but wrong: it is about building a system users do not need, and here users are happy.|||Vì không thể test vét cạn nên luôn có defect lọt; phát hiện 90–95% trong khi người dùng hài lòng và failure ít tác động là kết quả tốt dựa trên rủi ro (slide 71). Absence-of-errors fallacy dễ nhầm nhưng sai: nó nói về việc làm ra hệ thống người dùng không cần, còn ở đây người dùng hài lòng.'),
      q('A programmer works on very complex code. Which principle may affect his work? (s.72)|||Lập trình viên làm với code rất phức tạp. Nguyên tắc nào ảnh hưởng? (s.72)', ['Pesticide paradox', 'Defect clustering', 'Absence-of-errors fallacy|||Ngộ nhận không có lỗi', 'Exhaustive testing is impossible|||Không thể test vét cạn'], 1, 'Complexity is one of the best predictors of where defects cluster (Principle 4), so very complex code probably holds more defects and deserves more testing (slides 64 and 72). The pesticide paradox is about repeating the same tests, not about the code being complex.|||Độ phức tạp là một trong những dấu hiệu dự báo tốt nhất nơi defect co cụm (Nguyên tắc 4), nên code rất phức tạp nhiều khả năng chứa nhiều defect hơn và cần test nhiều hơn (slide 64 và 72). Pesticide paradox nói về việc lặp lại cùng test, không liên quan tới độ phức tạp của code.'),
      q('When should test control take place? (s.91)|||Test control diễn ra khi nào? (s.91)', ['During planning|||Trong planning', 'During implementation and execution|||Trong implementation và execution', 'During monitoring|||Trong monitoring', 'During all the activities|||Trong mọi hoạt động'], 3, 'Like monitoring, test control is continuous: whenever monitoring shows a deviation from the plan, corrective action can be taken in any activity (slide 91, lesson 1.4). Limiting it to planning or to monitoring misses that it spans the whole project.|||Cũng như monitoring, test control diễn ra liên tục: hễ monitoring thấy lệch so với kế hoạch là có thể hành động khắc phục ở bất kỳ hoạt động nào (slide 91, bài 1.4). Giới hạn nó vào planning hay monitoring là bỏ sót việc nó trải suốt dự án.'),
      q('Which activity compares planned with actual test progress? (s.92)|||Hoạt động nào so tiến độ kế hoạch với thực tế? (s.92)', ['Test monitoring', 'Test planning', 'Test closure', 'Test control'], 0, 'Test monitoring compares actual progress against the plan (slide 92). Test control is the tempting wrong answer: it acts on the result of that comparison rather than making it; closure is simply the old name of completion.|||Test monitoring so sánh tiến độ thực tế với kế hoạch (slide 92). Test control là đáp án dễ nhầm: nó hành động dựa trên kết quả so sánh chứ không phải người so sánh; closure chỉ là tên cũ của completion.'),
      q('Designing and prioritising test cases occurs in… (s.93)|||Thiết kế và ưu tiên test case diễn ra ở… (s.93)', ['Test planning', 'Test analysis', 'Test design', 'Test completion'], 2, 'Test cases are the work product of test design, which answers "how to test?" (slides 82 and 93). Test analysis only identifies test conditions ("what to test?"); the cases that exercise them are designed in the next activity.|||Test case là sản phẩm của test design, hoạt động trả lời "test như thế nào?" (slide 82 và 93). Test analysis chỉ xác định test condition ("test cái gì?"); các test case để kiểm chúng được thiết kế ở hoạt động kế tiếp.'),
      q('Designing and prioritising test conditions from the test basis occurs in… (s.94)|||Xác định và ưu tiên test condition từ test basis diễn ra ở… (s.94)', ['Test planning', 'Test analysis', 'Test design', 'Test completion'], 1, 'Test conditions answer "what to test?" and come from analysing the test basis, so this is test analysis (slides 81 and 94). Do not be misled by the word "designing": test design is the next step, where the test cases for those conditions are created.|||Test condition trả lời "test cái gì?" và đến từ việc phân tích test basis, nên đây là test analysis (slide 81 và 94). Đừng bị chữ "designing" đánh lừa: test design là bước kế tiếp, nơi tạo test case cho các condition đó.'),
      q('Checking whether all defect reports are closed occurs in… (s.95)|||Kiểm tra mọi defect report đã đóng diễn ra ở… (s.95)', ['Test planning', 'Test analysis', 'Test design', 'Test completion'], 3, 'Checking that all defect reports are closed (or turned into change requests) is one of the completion tasks on slide 88 (slide 95). It happens when a level or project ends, not during planning, analysis or design.|||Kiểm tra mọi defect report đã đóng (hoặc chuyển thành change request) là một trong các việc của test completion ở slide 88 (slide 95). Nó diễn ra khi kết thúc một cấp test hay dự án, không phải lúc planning, analysis hay design.'),
      q('Comparing actual results with expected results occurs in… (s.96)|||So kết quả thực tế với mong đợi diễn ra ở… (s.96)', ['Test monitoring & control', 'Test analysis', 'Test implementation', 'Test execution'], 3, 'Running the tests and comparing actual with expected results is the heart of test execution (slides 86 and 96). Test implementation only prepares procedures, suites and the environment; nothing is compared until the tests actually run.|||Chạy test và so kết quả thực tế với kết quả mong đợi là trọng tâm của test execution (slide 86 và 96). Test implementation chỉ chuẩn bị procedure, suite và môi trường; chưa có gì để so cho tới khi test thực sự chạy.'),
      q('Developing and prioritising test procedures occurs in… (s.97)|||Xây dựng và ưu tiên test procedure diễn ra ở… (s.97)', ['Test monitoring & control', 'Test analysis', 'Test implementation', 'Test execution'], 2, 'Test procedures, test suites and the execution schedule are built in test implementation, which answers "is everything in place to run the tests?" (slides 85 and 97). Execution is the tempting wrong answer: it runs the procedures but does not develop them.|||Test procedure, test suite và lịch thực thi được xây ở test implementation, hoạt động trả lời "đã đủ mọi thứ để chạy test chưa?" (slide 85 và 97). Execution là đáp án dễ nhầm: nó chạy procedure chứ không xây dựng procedure.'),
      q('Checking test results and logs against coverage criteria occurs in… (s.98)|||Đối chiếu kết quả và log test với tiêu chí bao phủ diễn ra ở… (s.98)', ['Test monitoring & control', 'Test analysis', 'Test implementation', 'Test execution'], 0, 'Checking results and logs against coverage criteria means evaluating exit criteria, which the 2018 syllabus puts under test monitoring and control (slide 98; in the old 5-step process it was "evaluating exit criteria and reporting"). Execution produces the logs but does not judge them against the criteria.|||Đối chiếu kết quả và log với tiêu chí bao phủ là đánh giá exit criteria, việc mà syllabus 2018 xếp vào test monitoring & control (slide 98; quy trình 5 bước cũ gọi là "evaluating exit criteria and reporting"). Execution tạo ra log nhưng không đánh giá log so với tiêu chí.'),
      q('Testing is best described as a…|||Kiểm thử đúng nhất là một hoạt động…', ['Quality assurance activity (process-focused)|||Đảm bảo chất lượng (tập trung quy trình)', 'Quality control activity (product-focused)|||Kiểm soát chất lượng (tập trung sản phẩm)', 'Project-management activity|||Quản lý dự án', 'Debugging activity|||Debugging'], 1, 'Slide 38: quality assurance focuses on processes, while quality control focuses on products, and testing belongs to quality control. The job title "QA engineer" tempts people to pick QA, but the syllabus uses the strict meaning; debugging is a separate developer activity.|||Slide 38: quality assurance tập trung vào quy trình, còn quality control tập trung vào sản phẩm, và kiểm thử thuộc quality control. Chức danh "QA engineer" dễ khiến chọn QA, nhưng syllabus dùng nghĩa hẹp; còn debugging là hoạt động riêng của developer.'),
      q('"A failure is an event; a defect is…"|||"Failure là một sự kiện; defect là…"', ['a human action|||một hành động của con người', 'a state of the software, caused by an error|||một trạng thái của phần mềm, do error gây ra', 'an effect on the customer|||tác động lên khách hàng', 'a test result|||một kết quả test'], 1, 'The pink box on slide 39: a failure is an event, a defect is a state of the software, caused by an error. "A human action" is the definition of the error (mistake) itself, not of the defect it leaves in the work product.|||Ô hồng ở slide 39: failure là một sự kiện, defect là một trạng thái của phần mềm, do error gây ra. "Hành động của con người" là định nghĩa của chính error (mistake), không phải của defect mà nó để lại trong sản phẩm.'),
      q('In "incorrect interest payments → complaints", the product owner\'s lack of knowledge is the…|||Trong ví dụ "tính lãi sai → khiếu nại", việc PO thiếu kiến thức là…', ['Failure', 'Defect', 'Root cause|||Nguyên nhân gốc (root cause)', 'Effect'], 2, 'In the worked example on slide 48 the product owner\'s lack of knowledge of interest calculation is the root cause; the wrong line of code is the defect, the incorrect payments are the failure and the complaints are the effect. Calling it the defect confuses the cause with the flaw in the code.|||Trong ví dụ ở slide 48, việc product owner thiếu kiến thức tính lãi là root cause; dòng code sai là defect, khoản lãi tính sai là failure, còn khiếu nại là effect. Gọi nó là defect là lẫn nguyên nhân với khiếm khuyết trong code.'),
      q('Slide 56 computes 480,000 tests at 1 s each = 133 h. Why does it say 17.7 days?|||Slide 56 tính 480.000 test, 1 giây mỗi test = 133 giờ. Vì sao ghi 17,7 ngày?', ['It assumes 24-hour days|||Tính ngày 24 giờ', 'It assumes 7.5-hour working days|||Tính ngày làm việc 7,5 giờ', 'It includes retests|||Đã tính cả test lại', 'It is a typo|||Là lỗi đánh máy'], 1, '480,000 s is about 133.3 hours; divided by working days of 7.5 hours this gives about 17.7 days (slide 56, lesson 1.3). With 24-hour days it would be only about 5.6 days, so that option does not fit the number on the slide.|||480.000 giây là khoảng 133,3 giờ; chia cho ngày làm việc 7,5 giờ được khoảng 17,7 ngày (slide 56, bài 1.3). Nếu tính ngày 24 giờ thì chỉ khoảng 5,6 ngày, nên phương án đó không khớp con số trên slide.'),
      q('"How much testing is enough?" — the best answer is…|||"Test bao nhiêu là đủ?" — câu trả lời đúng nhất là…', ['When all planned tests have run|||Khi đã chạy hết test đã lên kế hoạch', 'When the customer is happy|||Khi khách hàng hài lòng', 'It depends on the risks|||Tuỳ vào rủi ro', 'When we proved the system works|||Khi đã chứng minh hệ thống chạy đúng'], 2, 'Slides 58–59: the only fully correct answer is that it depends on risk (technical, business, project), together with time and budget. "When all planned tests have run", "when the customer is happy" and "when we proved it works" are all marked wrong, because the plan itself should be driven by risk and nothing can prove the system works.|||Slide 58–59: câu trả lời đúng trọn vẹn duy nhất là tuỳ vào rủi ro (kỹ thuật, kinh doanh, dự án), cùng với thời gian và ngân sách. "Khi chạy hết test đã lên kế hoạch", "khi khách hàng hài lòng" và "khi đã chứng minh hệ thống chạy đúng" đều bị gạch, vì chính kế hoạch phải dựa trên rủi ro và không gì chứng minh được hệ thống chạy đúng.'),
      q('Which is NOT one of the four Es of a good test case?|||Đâu KHÔNG thuộc bốn chữ E của test case tốt?', ['Effective', 'Exemplary', 'Exhaustive', 'Economic'], 2, 'The four Es of a good test case are Effective (finds faults), Exemplary (represents others), Evolvable (easy to maintain) and Economic (cheap to use) (slide 83). Exhaustive is not one of them: exhaustive testing is impossible (Principle 2), and Exemplary is the look-alike distractor.|||Bốn chữ E của test case tốt là Effective (tìm được lỗi), Exemplary (đại diện cho các ca khác), Evolvable (dễ bảo trì) và Economic (rẻ khi dùng) (slide 83). Exhaustive không nằm trong đó: test vét cạn là không thể (Nguyên tắc 2), còn Exemplary là phương án gây nhầm vì nghe giống.'),
      q('"Build the test environment" belongs to…|||"Dựng môi trường test" thuộc về…', ['Test design', 'Test implementation', 'Test execution', 'Test planning'], 1, 'Test design only designs the environment (what infrastructure and tools are needed); building it, with stubs, drivers, simulators and test data, is test implementation (slides 82 and 85). Design is the tempting answer because the two tasks share the same object.|||Test design chỉ thiết kế môi trường (cần hạ tầng, công cụ gì); còn dựng nó, cùng stub, driver, simulator và dữ liệu test, là test implementation (slide 82 và 85). Design là đáp án dễ nhầm vì hai việc cùng nói về môi trường test.'),
      q('A crash in a rarely used admin report page is best classified as…|||Crash ở một trang báo cáo quản trị hiếm khi dùng nên xếp là…', ['High severity, low priority|||Severity cao, priority thấp', 'Low severity, high priority|||Severity thấp, priority cao', 'Low severity, low priority|||Severity thấp, priority thấp', 'It is not a defect|||Không phải defect'], 0, 'Severity is how badly the defect affects functionality, priority is how fast it must be fixed, and they are independent (slide 87 speaker notes). A crash is severe, but a rarely used page can wait, so it is high severity, low priority; the reverse case is a misspelt company name on the home page.|||Severity là defect ảnh hưởng chức năng nặng tới đâu, priority là phải sửa gấp tới đâu, và hai thứ độc lập nhau (ghi chú slide 87). Crash là nghiêm trọng, nhưng trang hiếm dùng thì chờ được, nên là severity cao, priority thấp; trường hợp ngược lại là sai chính tả tên công ty ở trang chủ.'),
      q('Which level of independence is the LOWEST?|||Mức độc lập THẤP nhất là…', ['Tests by a separate test team|||Test do nhóm test riêng', 'Tests by the author of the code|||Test do chính tác giả code', 'Tests by an external agency|||Test do công ty bên ngoài', 'Tests by another developer|||Test do developer khác'], 1, 'Slide 103 lists the levels from least to most independent: tests by the author, by another developer, by another team (e.g. a test team), by another organisation, and generated by a tool. Another developer is the tempting option, but it is already one step above the author testing his own code.|||Slide 103 xếp các mức từ ít đến nhiều độc lập: tác giả tự test, developer khác, nhóm khác (vd nhóm test), tổ chức khác, và test do công cụ sinh ra. Developer khác là phương án dễ nhầm, nhưng nó đã cao hơn một bậc so với tác giả tự test code của mình.'),
      q('The best way to build confidence in software is to…|||Cách tốt nhất để xây niềm tin vào phần mềm là…', ['run only easy test cases|||chỉ chạy test dễ', 'try to destroy it with difficult tests|||cố phá nó bằng test khó', 'let the author test it|||để tác giả tự test', 'skip testing when the deadline is close|||bỏ test khi sát deadline'], 1, 'The testing paradox on slide 108: finding faults destroys confidence, yet the best way to build confidence is to try to destroy it, because software that survived serious attempts to break it deserves more trust. Running only easy tests or letting the author test gives confidence that is not justified.|||Nghịch lý kiểm thử ở slide 108: tìm ra lỗi làm mất niềm tin, nhưng cách tốt nhất để xây niềm tin là cố phá nó, vì phần mềm đã qua được những lần cố phá nghiêm túc mới đáng tin hơn. Chỉ chạy test dễ hay để tác giả tự test tạo ra niềm tin không có cơ sở.'),
      q('"Certified testers shall maintain integrity and independence in their professional judgment" is the principle…|||"Tester phải giữ chính trực và độc lập trong phán đoán chuyên môn" là nguyên tắc…', ['Public', 'Product', 'Judgment', 'Self'], 2, 'This is the Judgment principle of the ISTQB code of ethics (slide 113). Product is the tempting option, but it is about deliverables meeting the highest professional standards; Public is about the public interest and Self about lifelong learning and ethical practice.|||Đây là nguyên tắc Judgment trong bộ quy tắc đạo đức ISTQB (slide 113). Product dễ nhầm, nhưng nó nói về sản phẩm bàn giao đạt chuẩn nghề nghiệp cao nhất; Public nói về lợi ích công chúng, còn Self nói về tự học suốt đời và hành nghề có đạo đức.'),
