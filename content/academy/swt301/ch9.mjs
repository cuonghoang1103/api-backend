  ...
  quiz: {
    ...
    questions: [
      qx('Which of the following is one of the four values of the Agile Manifesto? (Topic 8 s.7)|||Đâu là một trong bốn giá trị của Agile Manifesto? (Topic 8 s.7)', ['Following a plan over responding to change|||Bám theo kế hoạch hơn phản ứng với thay đổi', 'Comprehensive documentation over working software|||Tài liệu đầy đủ hơn phần mềm chạy được', 'Customer collaboration over contract negotiation|||Cộng tác với khách hàng hơn đàm phán hợp đồng', 'Processes and tools over individuals and interactions|||Quy trình và công cụ hơn cá nhân và tương tác'], 2,
        'The four values are: individuals and interactions over processes and tools, working software over comprehensive documentation, customer collaboration over contract negotiation, responding to change over following a plan (slides 7–11). The other three options swap the two sides.|||Bốn giá trị là: cá nhân và tương tác hơn quy trình và công cụ, phần mềm chạy được hơn tài liệu đầy đủ, cộng tác với khách hàng hơn đàm phán hợp đồng, phản ứng với thay đổi hơn bám theo kế hoạch (slide 7–11). Ba phương án kia đảo ngược hai vế.'),
      qx('"Working software is the primary measure of progress" is… (s.12)|||"Phần mềm chạy được là thước đo chính của tiến độ" là… (s.12)', ['one of the 12 principles behind the Agile Manifesto|||một trong 12 nguyên tắc đằng sau Agile Manifesto', 'one of the four Manifesto values|||một trong bốn giá trị của Tuyên ngôn', 'an XP testing rule|||một luật kiểm thử của XP', 'a Scrum timebox|||một timebox của Scrum'], 0,
        'It is one of the 12 principles behind the Manifesto (slide 12). The values are the four "X over Y" statements; "working software over comprehensive documentation" is a value, but "primary measure of progress" is the principle.|||Đây là một trong 12 nguyên tắc đằng sau Tuyên ngôn (slide 12). Giá trị là bốn câu dạng "X hơn Y"; "phần mềm chạy được hơn tài liệu đầy đủ" là giá trị, còn "thước đo chính của tiến độ" là nguyên tắc.'),
      qx('Which statement about the Agile Manifesto is TRUE? (s.7, s.9)|||Phát biểu nào về Agile Manifesto là ĐÚNG? (s.7, s.9)', ['Agile projects produce no documentation|||Dự án Agile không tạo tài liệu nào', 'The items on the right still have value, but the items on the left are valued more|||Các mục bên phải vẫn có giá trị, nhưng các mục bên trái được coi trọng hơn', 'Agile teams do not plan|||Đội Agile không lập kế hoạch', 'Contracts are forbidden in Agile|||Hợp đồng bị cấm trong Agile'], 1,
        'The Manifesto says that while there is value in the items on the right, the items on the left are valued more. So Agile teams still document, plan and sign contracts; those things just matter less than working software, collaboration and responding to change (slides 9–11).|||Tuyên ngôn nói các mục bên phải vẫn có giá trị, nhưng các mục bên trái được coi trọng hơn. Nên đội Agile vẫn viết tài liệu, lập kế hoạch và ký hợp đồng; chỉ là chúng kém quan trọng hơn phần mềm chạy được, sự cộng tác và phản ứng với thay đổi (slide 9–11).'),
      qx('Involving testers, developers and business representatives in all feature discussions is called… (s.16)|||Việc có mặt tester, developer và đại diện nghiệp vụ trong mọi buổi bàn về tính năng gọi là… (s.16)', ['the power of three|||power of three', 'pair programming|||lập trình cặp', 'the Definition of Done|||Definition of Done', 'sprint zero|||sprint zero'], 0,
        'Slide 16: involving testers, developers and business representatives in all feature discussions is known as the power of three. Pair programming is two people working at one keyboard, an XP coding practice.|||Slide 16: có mặt tester, developer và đại diện nghiệp vụ trong mọi buổi bàn về tính năng gọi là power of three. Pair programming là hai người làm chung một bàn phím, một thực hành viết code của XP.'),
      qx('Which is a benefit of the whole-team approach? (s.18)|||Đâu là một lợi ích của whole-team approach? (s.18)', ['Testers are no longer needed|||Không cần tester nữa', 'Quality becomes everyone\'s responsibility|||Chất lượng trở thành trách nhiệm của mọi người', 'Requirements never change|||Yêu cầu không bao giờ thay đổi', 'Documentation is eliminated|||Tài liệu bị loại bỏ'], 1,
        'Slide 18 lists the benefits: better communication and collaboration, using the whole range of skills, sharing knowledge, and making quality everyone\'s responsibility. The whole team still includes testers; testing work is shared, not removed.|||Slide 18 nêu các lợi ích: giao tiếp và cộng tác tốt hơn, tận dụng mọi kỹ năng trong đội, chia sẻ kiến thức, và biến chất lượng thành trách nhiệm của mọi người. Cả đội vẫn có tester; việc test được chia sẻ chứ không bị bỏ đi.'),
      qx('Which is a benefit of early and frequent feedback? (s.22)|||Đâu là lợi ích của phản hồi sớm và thường xuyên? (s.22)', ['It avoids requirements misunderstandings that would be expensive to fix later|||Tránh hiểu nhầm yêu cầu vốn sẽ tốn kém nếu sửa muộn', 'It removes the need for regression testing|||Không cần kiểm thử hồi quy nữa', 'It fixes the scope at the start of the project|||Chốt cứng phạm vi ngay đầu dự án', 'It lets the customer see the product only at the end|||Cho khách hàng chỉ thấy sản phẩm ở cuối'], 0,
        'Slide 22 notes: early feedback avoids requirements misunderstandings that might not be found until late in the cycle, when they are more expensive to fix. Regression testing is still needed, and the whole point is that the customer sees the product early, not only at the end.|||Ghi chú slide 22: phản hồi sớm tránh được hiểu nhầm yêu cầu mà nếu không sẽ chỉ lộ ra ở cuối chu kỳ, lúc sửa tốn kém hơn. Kiểm thử hồi quy vẫn cần, và mục đích chính là để khách hàng thấy sản phẩm sớm, không phải chỉ ở cuối.'),
      qx('Which Agile approach prescribes test-first programming, unit tests for all code and pair programming? (s.35–36, s.41)|||Cách tiếp cận Agile nào quy định lập trình test-first, unit test cho mọi code và lập trình cặp? (s.35–36, s.41)', ['Scrum', 'Kanban', 'Extreme Programming (XP)', 'DSDM'], 2,
        'XP prescribes engineering practices such as test-first programming, unit tests for all code and pair programming (slides 35–36). Scrum, in contrast, is a management framework and does not dictate techniques such as test-first programming (slide 41).|||XP quy định các thực hành kỹ thuật như lập trình test-first, unit test cho mọi code và lập trình cặp (slide 35–36). Ngược lại, Scrum là khung quản lý và không quy định kỹ thuật như lập trình test-first (slide 41).'),
      qx('In Scrum, who creates, maintains and prioritises the product backlog? (s.43)|||Trong Scrum, ai tạo, duy trì và xếp ưu tiên product backlog? (s.43)', ['The Scrum Master|||Scrum Master', 'The Product Owner|||Product Owner', 'The tester|||Tester', 'The project manager|||Quản lý dự án'], 1,
        'The Product Owner owns the product backlog: creates, maintains and prioritises it (slide 43, lesson 9.2). The Scrum Master coaches the process and removes impediments, and Scrum has no project manager role.|||Product Owner sở hữu product backlog: tạo, duy trì và xếp ưu tiên nó (slide 43, bài 9.2). Scrum Master hướng dẫn quy trình và gỡ vướng mắc, còn Scrum không có vai trò quản lý dự án.'),
      qx('Which statement about Kanban is correct? (s.46–47)|||Phát biểu nào về Kanban là đúng? (s.46–47)', ['Timeboxed sprints are mandatory|||Sprint theo timebox là bắt buộc', 'Each station pushes finished tickets to the next station regardless of its load|||Mỗi trạm đẩy ticket xong sang trạm sau bất kể trạm sau đang tải bao nhiêu', 'WIP limits cap the tickets per station and a station pulls work when it has capacity|||Giới hạn WIP chặn số ticket mỗi trạm và trạm kéo việc khi còn chỗ', 'Kanban defines three roles and five timeboxes|||Kanban định nghĩa ba vai trò và năm timebox'], 2,
        'Slide 46: a WIP limit caps the number of tickets allowed at a station, and whenever a station has free capacity it pulls tickets from the previous one. Pushing work regardless of load breaks the WIP limit, and sprints are optional in Kanban (slide 47).|||Slide 46: giới hạn WIP chặn số ticket tối đa ở một trạm, và khi trạm còn chỗ thì nó kéo ticket từ trạm trước. Đẩy việc bất kể tải là phá giới hạn WIP, còn sprint là tuỳ chọn trong Kanban (slide 47).'),
      qx('In INVEST, a story that is too big to finish in one iteration violates… (s.52)|||Trong INVEST, một story quá lớn để xong trong một iteration vi phạm… (s.52)', ['Independent|||Independent (độc lập)', 'Negotiable|||Negotiable (thương lượng được)', 'Small|||Small (nhỏ)', 'Valuable|||Valuable (có giá trị)'], 2,
        'S in INVEST = Small: sized so it fits into one iteration (slide 52). Independent means the story does not depend on other stories; a big story can be fully independent and still too large.|||S trong INVEST = Small: kích thước vừa để lọt trong một iteration (slide 52). Independent nghĩa là story không phụ thuộc story khác; một story lớn vẫn có thể hoàn toàn độc lập mà vẫn quá to.'),
      qx('The 3 Cs of a user story are…|||3 chữ C của một user story là…', ['Card, Conversation, Confirmation|||Card, Conversation, Confirmation', 'Code, Compile, Commit|||Code, Compile, Commit', 'Customer, Contract, Change|||Customer, Contract, Change', 'Create, Check, Close|||Create, Check, Close'], 0,
        'Card (a short written story), Conversation (the discussion that clarifies it) and Confirmation (acceptance criteria that confirm it is done) (lesson 9.3). The other triples are invented; none of them is a syllabus term.|||Card (story viết ngắn), Conversation (cuộc trao đổi làm rõ nó) và Confirmation (acceptance criteria xác nhận nó đã xong) (bài 9.3). Các bộ ba còn lại là bịa; không cái nào là thuật ngữ của syllabus.'),
      qx('What is the main purpose of a retrospective? (s.53–54)|||Mục đích chính của retrospective là gì? (s.53–54)', ['To demonstrate the increment to stakeholders|||Demo increment cho các bên liên quan', 'To improve the team\'s process — what went well, what to improve, how|||Cải tiến quy trình của đội — điều gì tốt, điều gì cần cải thiện, cải thiện thế nào', 'To assign blame for defects|||Quy trách nhiệm cho các defect', 'To estimate the product backlog|||Ước lượng product backlog'], 1,
        'Slide 53: a meeting at the end of each iteration to discuss what went well, what can be improved and how, covering process, people, organisation, relationships and tools. Demonstrating the increment to stakeholders is the sprint review, a different event.|||Slide 53: buổi họp cuối mỗi iteration để bàn điều gì tốt, điều gì cần cải thiện và cải thiện thế nào, về quy trình, con người, tổ chức, quan hệ và công cụ. Demo increment cho các bên liên quan là sprint review, một sự kiện khác.'),
      qx('Which is a RISK or challenge of continuous integration named on the slides? (s.64)|||Đâu là một RỦI RO hay thách thức của CI được nêu trên slide? (s.64)', ['Integration problems are found earlier|||Lỗi tích hợp được phát hiện sớm hơn', 'Teams over-rely on unit tests and do too little system and acceptance testing|||Đội quá tin unit test và làm quá ít system test, acceptance test', 'Executable software is always available|||Luôn có phần mềm chạy được', 'Repetitive manual testing is reduced|||Giảm test tay lặp đi lặp lại'], 1,
        'Slide 64 names over-reliance on unit tests, with too little system and acceptance testing, as a CI risk, alongside tool cost and automation effort. The other three options are CI benefits listed on slide 63.|||Slide 64 nêu việc quá tin unit test, làm quá ít system test và acceptance test, là một rủi ro của CI, bên cạnh chi phí công cụ và công sức tự động hoá. Ba phương án còn lại là lợi ích của CI ở slide 63.'),
      qx('According to the teacher\'s notes, with CI in place… (s.59–60)|||Theo ghi chú của thầy/cô, khi đã có CI… (s.59–60)', ['manual testing is no longer needed|||không cần test tay nữa', 'manual testing shifts to new features, changes and confirmation testing, plus exploratory testing|||test tay dời sang tính năng mới, thay đổi, confirmation testing và exploratory testing', 'testers only write unit tests|||tester chỉ viết unit test', 'regression testing is done once per release|||kiểm thử hồi quy làm mỗi release một lần'], 1,
        'Notes on slides 59–60: a common misreading of CI is that manual testing is no longer needed. Regression automation frees testers to test new features, changes and confirmation of fixes by hand, plus exploratory testing.|||Ghi chú slide 59–60: một cách hiểu sai phổ biến về CI là không cần test tay nữa. Tự động hoá regression giải phóng tester để test tay tính năng mới, thay đổi, xác nhận bản sửa, cùng exploratory testing.'),
      qx('Which tester activity belongs to ITERATION planning rather than release planning? (s.69, s.71)|||Hoạt động nào của tester thuộc ITERATION planning chứ không phải release planning? (s.69, s.71)', ['Defining the necessary test levels|||Xác định các cấp kiểm thử cần thiết', 'Planning the testing for the release|||Lập kế hoạch kiểm thử cho release', 'Breaking user stories down into tasks, particularly testing tasks|||Chia user story thành task, đặc biệt là task kiểm thử', 'Estimating high-level test effort for the whole release|||Ước lượng công sức test mức cao cho cả release'], 2,
        'Slide 71 (iteration planning) lists breaking user stories down into tasks, particularly testing tasks. The other three options are on slide 69 (release planning): defining test levels, planning the release testing and high-level effort estimates.|||Slide 71 (iteration planning) có mục chia user story thành task, đặc biệt là task kiểm thử. Ba phương án kia nằm ở slide 69 (release planning): xác định cấp kiểm thử, lập kế hoạch test cho release và ước lượng công sức mức cao.'),
      qx('A team finished 21, 18 and 24 points in its last three sprints. Using average velocity, how many points should it plan for the next sprint? (s.70)|||Một đội hoàn thành 21, 18 và 24 point trong ba sprint gần nhất. Theo velocity trung bình, sprint tới nên lên kế hoạch bao nhiêu point? (s.70)', ['18', '21', '24', '63'], 1,
        'Average velocity = (21 + 18 + 24) / 3 = 63 / 3 = 21 points (slide 70: stories selected depend on established velocity). 63 is the three-sprint total, and 24 is the best sprint, which would over-commit the team.|||Velocity trung bình = (21 + 18 + 24) / 3 = 63 / 3 = 21 point (slide 70: số story chọn phụ thuộc velocity đã ổn định). 63 là tổng ba sprint, còn 24 là sprint tốt nhất, lấy nó sẽ làm đội cam kết quá sức.'),
      qx('On a burndown chart the "remaining points" line stays flat for three days. The most likely meaning is…|||Trên burndown chart, đường "point còn lại" nằm ngang ba ngày liền. Ý nghĩa khả dĩ nhất là…', ['the team is idle|||đội đang ngồi chơi', 'work is in progress but no story has met the Definition of Done yet|||việc đang làm nhưng chưa story nào đạt Definition of Done', 'all stories are done|||mọi story đã xong', 'the sprint has been cancelled|||sprint đã bị huỷ'], 1,
        'Points burn only when a story meets the Definition of Done, so a flat line means work is in progress but nothing is Done yet, often stories waiting for testing (lesson 9.5). It does not prove the team is idle; the tester asks at stand-up which story will be Done first.|||Point chỉ giảm khi story đạt Definition of Done, nên đường nằm ngang nghĩa là việc đang làm nhưng chưa có gì Done, thường là story đang chờ test (bài 9.5). Nó không chứng minh đội ngồi chơi; tester hỏi ở stand-up story nào sẽ Done đầu tiên.'),
      qx('Which is a risk for a tester embedded in an Agile team, according to the syllabus?|||Theo syllabus, đâu là rủi ro với tester ngồi trong đội Agile?', ['Losing independence and becoming tolerant of inefficient practices|||Mất tính độc lập và trở nên dễ dãi với cách làm kém hiệu quả', 'Having too much time for testing|||Có quá nhiều thời gian để test', 'Not being allowed to attend the daily stand-up|||Không được dự daily stand-up', 'Being unable to use test tools|||Không được dùng công cụ test'], 0,
        'The syllabus warns that embedded testers may lose independence and objective evaluation, become tolerant of inefficient practices, or fail to keep pace with changes (lesson 9.5). Testers do attend the daily stand-up and do use tools, so C and D are wrong.|||Syllabus cảnh báo tester ngồi trong đội có thể mất tính độc lập và đánh giá khách quan, trở nên dễ dãi với cách làm kém hiệu quả, hoặc không theo kịp thay đổi (bài 9.5). Tester vẫn dự daily stand-up và vẫn dùng công cụ, nên C và D sai.'),
      qx('In TDD, what is the FIRST step of each cycle?|||Trong TDD, bước ĐẦU TIÊN của mỗi vòng là gì?', ['Write the production code, then the test|||Viết code production, rồi tới test', 'Write a test for the new behaviour and see it fail|||Viết test cho hành vi mới và thấy nó fail', 'Refactor the existing code|||Refactor code đang có', 'Run the acceptance tests|||Chạy acceptance test'], 1,
        'TDD cycle: write a test for the next small piece of behaviour and see it fail (red), write just enough code to pass (green), then refactor (lesson 9.6). Writing the code first and the test after is ordinary test-last development.|||Vòng TDD: viết test cho một mẩu hành vi nhỏ tiếp theo và thấy nó fail (red), viết vừa đủ code để pass (green), rồi refactor (bài 9.6). Viết code trước rồi mới viết test là cách test-last thông thường.'),
      qx('Which statement BEST describes BDD?|||Câu nào mô tả ĐÚNG NHẤT BDD?', ['Unit tests written by a developer only, in Java|||Unit test do riêng developer viết, bằng Java', 'Behaviour scenarios in Given/When/Then form that business people can read and tools such as Cucumber can execute|||Kịch bản hành vi dạng Given/When/Then mà người nghiệp vụ đọc được và công cụ như Cucumber chạy được', 'A load-testing technique|||Một kỹ thuật kiểm thử tải', 'A way to estimate stories|||Một cách ước lượng story'], 1,
        'BDD writes expected behaviour as Given/When/Then scenarios in business language (Gherkin) that tools such as Cucumber can execute (lesson 9.6). Unit tests written only by developers describe TDD, not BDD.|||BDD viết hành vi mong đợi thành kịch bản Given/When/Then bằng ngôn ngữ nghiệp vụ (Gherkin) mà công cụ như Cucumber chạy được (bài 9.6). Unit test chỉ do developer viết là TDD, không phải BDD.'),
      qx('The test pyramid recommends…|||Test pyramid khuyến nghị…', ['more tests at the higher levels (UI) than at the lower levels|||nhiều test ở cấp cao (UI) hơn cấp thấp', 'a larger number of tests at the lower levels (unit) than at the higher levels|||nhiều test ở cấp thấp (unit) hơn các cấp cao', 'the same number of tests at every level|||số test như nhau ở mọi cấp', 'no automated tests at the unit level|||không có test tự động ở cấp unit'], 1,
        'The pyramid has many fast, cheap unit tests at the base and fewer tests at each level above, with the fewest end-to-end UI tests at the top (lesson 9.6). More UI tests than unit tests is the inverted pyramid: slow, brittle and expensive to maintain.|||Kim tự tháp có rất nhiều unit test nhanh, rẻ ở đáy và càng lên cao càng ít test, ít nhất là test UI end-to-end ở đỉnh (bài 9.6). Nhiều test UI hơn unit test là kim tự tháp lộn ngược: chậm, dễ vỡ và tốn công bảo trì.'),
      qx('In the testing quadrants, performance, load and security tests belong to…|||Trong testing quadrants, test hiệu năng, tải và bảo mật thuộc…', ['Q1 — technology-facing, supporting the team|||Q1 — hướng kỹ thuật, hỗ trợ đội', 'Q2 — business-facing, supporting the team|||Q2 — hướng nghiệp vụ, hỗ trợ đội', 'Q3 — business-facing, critiquing the product|||Q3 — hướng nghiệp vụ, phê bình sản phẩm', 'Q4 — technology-facing, critiquing the product|||Q4 — hướng kỹ thuật, phê bình sản phẩm'], 3,
        'Q4 is technology-facing and critiques the product: performance, load, stress and security tests, usually tool-driven (lesson 9.6). Q1 is also technology-facing but supports the team, with unit and component tests.|||Q4 hướng kỹ thuật và phê bình sản phẩm: test hiệu năng, tải, stress và bảo mật, thường chạy bằng công cụ (bài 9.6). Q1 cũng hướng kỹ thuật nhưng hỗ trợ đội, với unit test và component test.'),
      qx('In planning poker, after the first reveal the estimates are 2, 3, 3 and 8. What happens next?|||Trong planning poker, sau lần lật đầu tiên các ước lượng là 2, 3, 3 và 8. Tiếp theo làm gì?', ['Take the average, 4|||Lấy trung bình, 4', 'Take the estimate of the most senior developer|||Lấy ước lượng của developer thâm niên nhất', 'The people who chose 2 and 8 explain their reasons, then the team votes again|||Người chọn 2 và 8 giải thích lý do, rồi đội bỏ phiếu lại', 'The Scrum Master decides|||Scrum Master quyết định'], 2,
        'Planning poker aims at consensus: when estimates differ, the people with the highest and lowest cards explain their reasons, then everyone votes again until the estimates converge (lesson 9.7). Taking the average of 4 hides whatever the person who chose 8 knows.|||Planning poker nhắm tới đồng thuận: khi ước lượng lệch nhau, người chọn lá cao nhất và thấp nhất giải thích lý do, rồi cả đội bỏ phiếu lại tới khi hội tụ (bài 9.7). Lấy trung bình 4 là che mất điều người chọn 8 đang biết.'),
      qx('Which statement about exploratory testing in Agile projects is correct?|||Phát biểu nào về exploratory testing trong dự án Agile là đúng?', ['It is unplanned and its results are not recorded|||Nó không có kế hoạch và kết quả không được ghi lại', 'It is guided by a test charter and run in time-boxed sessions, with results recorded and debriefed|||Nó được dẫn dắt bởi test charter và chạy theo phiên có giới hạn thời gian, kết quả được ghi lại và debrief', 'It replaces all automated tests|||Nó thay thế mọi test tự động', 'It can only be done after the release|||Chỉ làm được sau khi phát hành'], 1,
        'In Agile projects exploratory testing is structured by test charters and time-boxed sessions, and its results are recorded and debriefed (lesson 9.7). It complements automated tests during the iteration; it never replaces them.|||Trong dự án Agile, exploratory testing được tổ chức bằng test charter và các phiên có giới hạn thời gian, kết quả được ghi lại và debrief (bài 9.7). Nó bổ sung cho test tự động ngay trong iteration; không bao giờ thay thế chúng.'),
    ],
  },
};
