 ...
 * Slide pictures: images/academy/SWT301/v2/lab25-sample/NNN.webp (scripts/upload-academy-slides.mjs).
 * v2 (22/09/2026): backup defect B8 corrected (the README was fixed upstream; backend/TEST_PLAN.md still
 * says Spring Boot 3.2.0 + Java 17). v1 keys are left untouched on purpose: Cloudflare keeps serving the
 * old bytes of an overwritten key, so every new edition goes to a new prefix.
 * Files: https://media.cuongthai.com/files/academy/SWT301/v2/ (.pptx + .pdf, scripts/upload-academy-file.mjs).
...
registerDeck('lab25-sample', { code: 'Sample deck', en: 'Lab 2.5 — sample slides', vi: 'Lab 2.5 — slide bài mẫu', total: 68, w: 1920, h: 1080, ver: 'v2' });
