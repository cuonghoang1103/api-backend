...
export default {
  ...
  lessons: {
    ...
    'ga-4-3-checkout': { yt: 'nAK3mFRxfFA', credit: 'DevOps Hint — How to use actions/checkout in GitHub Actions | GitHub - jobs : what is : use actions/checkout' },   // How to Use the Checkout Action in Github Actions
