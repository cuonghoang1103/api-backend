...
export default {
  ...
  lessons: {
    ...
    'mp-1-4-exif': { yt: 'dZpmgvLaJNY', credit: 'KMDTech — Exiftool - Protect Your Privacy | Remove Metadata From Photos' },   // Exiftool - Protect Your Privacy | Remove Metadata From Photos
