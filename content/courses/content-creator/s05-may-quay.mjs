...
${slide('cr-05', 5, 'Điện Việt Nam 50Hz → 25/50fps')}
<p>Lưới điện Việt Nam chạy ở 220V/50Hz (trang tra cứu quốc gia của worldstandards.eu xác nhận điều này, và đây cũng là con số dùng chung ở hầu hết Đông Nam Á và châu Âu — Mỹ, Nhật và một phần Brazil là những ngoại lệ đáng kể dùng 60Hz). Đèn LED và đèn huỳnh quang thường KHÔNG sáng đều liên tục; chúng nhấp nháy ở <strong>gấp đôi tần số điện lưới</strong> — 100 lần mỗi giây ở đây — đủ nhanh để mắt bạn không bao giờ nhận ra, nhưng đủ chậm để màn trập máy quay bắt trúng đúng lúc đang nhấp nháy.</p>
...
<div class="callout warn"><p><strong>The course default (already set in Chapter 6): turn HDR Video off on iPhone</strong> whenever cutting against Pocket 3, which never shoots HDR. Starting both cameras from the same SDR baseline removes one entire category of colour-matching mistakes before you ever open an editor. Chapter 21 covers exporting HDR correctly for the rare project that actually calls for it.</p></div>
