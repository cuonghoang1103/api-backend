/**
 * _slides.mjs — nhúng ảnh slide của khoá "Git & GitHub" vào bài học.
 *
 * Slide do khoá tự soạn, dựng bằng
 *   node scripts/_render-slides.mjs --deck scripts/slides-src/git-NN.mjs --out <dir>
 * rồi đẩy lên R2 bằng
 *   node --env-file=.env scripts/upload-academy-slides.mjs --dir <dir> --prefix GIT/v1 --decks git-NN
 * ⇒ images/academy/GIT/v1/<deck>/<NNN>.webp
 *
 ...
 * sang prefix mới (GIT/v2) và ghi deck đó vào VER bên dưới — đừng ghi đè v1.
 *
 * Việc "slide số n có thật không" được kiểm ở bước ghép bằng
 * `node scripts/git-ghep-chuong.mjs <file chương> --render <dir> [--cdn]`.
 */
export const CDN_ROOT = 'https://media.cuongthai.com/images/academy/GIT';
...
export function slide(deck, n, caption) {
  if (!/^git-\d\d$/.test(deck)) throw new Error(`deck lạ: ${deck}`);
