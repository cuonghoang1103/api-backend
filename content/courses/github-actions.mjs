 ...
 * Giáo trình tự soạn: 16 mục (Mục 0 + Chương 1–15), zero → vận hành CI/CD production, song ngữ EN/VI.
...
import s13 from './github-actions/s13-runner.mjs';
import s14 from './github-actions/s14-chat-luong-phat-hanh.mjs';
import s15 from './github-actions/s15-du-an-cuoi-khoa.mjs';
...
export default {
  ...
  course: {
    ...
    description: 'Khoá GitHub Actions từ số 0 tới mức vận hành được một đường ống CI/CD production, do CuongThai tự biên soạn. 16 mục đi từ việc CI thật ra giải quyết vấn đề gì, qua tệp workflow và cái khoá `on` mà YAML đọc thành boolean, job và runner, biểu thức và ngữ cảnh, action và thứ `uses:` thật sự làm, bộ đệm và tạo tác, ma trận và đường tới hạn, bí mật và quyền, tốc độ và chi phí, tới một sách công thức khi CI đỏ, cách tái sử dụng workflow và composite action ở quy mô cả đội, runner tự dựng, cổng chất lượng và bảo mật chuỗi cung ứng, phát hành tự động, rồi khép lại bằng một dự án cuối khoá dựng pipeline CI/CD hoàn chỉnh từ số 0 và bài thi 20 câu. MỌI số đo lấy từ 2.343 lần chạy THẬT của chính kho này.',
