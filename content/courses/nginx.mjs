...
import s06 from './nginx/s06-tls-http2.mjs';
...
import s11 from './nginx/s11-chan-doan.mjs';
...
export default {
  ...
  course: {
    ...
    thumbnailUrl: 'https://media.cuongthai.com/images/course-covers/nginx.png?v=3',
