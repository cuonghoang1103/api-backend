...
<div class="kv-grid">
  ...
  <div class="kv"><span class="k">The application behind you inherits the problem</span><span class="v">Chapter 3 passes <code>Host</code> upstream, and an application that builds password-reset links from it has the poisoning attack from the Authentication course. Nginx is where you can stop it once, for every service behind it.</span></div>
...
<div class="kv-grid">
  ...
  <div class="kv"><span class="k">Ứng dụng đứng sau bạn thừa hưởng luôn cái lỗ</span><span class="v">Chương 3 chuyển tiếp <code>Host</code> lên upstream, và một ứng dụng dựng đường dẫn đặt lại mật khẩu từ đó chính là đòn đầu độc trong khoá Authentication. Nginx là chỗ bạn chặn nó MỘT lần, cho mọi dịch vụ nằm sau.</span></div>
