...
<a class="link-card" href="/courses/github-actions/learn${REF}"><span class="lc-ico">⚙️</span><span class="lc-body"><span class="lc-title">CuongThai course — GitHub Actions (CI/CD)</span><span class="lc-sub">Gating a deploy on a migration step, and making the exit code stop the pipeline</span></span></a>
...
<a class="link-card" href="/courses/github-actions/learn${REF}"><span class="lc-ico">⚙️</span><span class="lc-body"><span class="lc-title">Khoá CuongThai — GitHub Actions (CI/CD)</span><span class="lc-sub">Đặt chốt cho một lần deploy dựa trên bước migration, và làm mã thoát dừng được đường ống</span></span></a>
