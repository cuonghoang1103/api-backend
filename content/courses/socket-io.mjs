...
import s10 from './socket-io/s10-chan-doan.mjs';
import s11 from './socket-io/s11-on-thi.mjs';
...
export default {
  ...
  course: {
    ...
    status: 'PUBLISHED',
    isFeatured: true,
    thumbnailUrl: 'https://media.cuongthai.com/images/course-covers/socket-io.png?v=3',
