        ...
        },
        {
          ...
          "rubric": [
            ...
            },
            {
              ...
              "criterion": "Correctly identifies the critical path (A-B-D-F-H) and project duration (31 weeks).|||Xác định đúng đường găng (A-B-D-F-H) và thời lượng dự án (31 tuần).",
              "weight": 1,
              "maxScore": 0.5
            }
          ]
