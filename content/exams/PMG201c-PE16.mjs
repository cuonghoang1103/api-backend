  ...
  "exams": [
    {
      ...
      "attachmentUrl": null,
      "attachmentName": null,
      "instructions": "<div class=\"ml-en\"><p><strong>PMG201c – Practical Exam 1 (SU2023, FUDA [684]) — New HR Web Application (NHRS)</strong>. This is a written project-management practical exam. There is no code to write; each answer is graded by an AI grader against the rubric shown per question.</p><div class=\"pe-system\"><b>Context:</b><p>You serve as the Project Manager for the New HR Web Application (NHRS) project. This system is being built to bring Digital Transformation to the HR operations of Ronald Company. Its key features are: (1) User registration and password forgot; (2) Import CV from TopCV and LinkedIn system; (3) Job Posting; (4) Apply for job; (5) Interview scheduling &amp; management. You will go through the full development life cycle, following the processes and stages described in PMBOK.</p></div>|||<div class=\"pe-system\"><b>Bối cảnh:</b><p>Bạn là Project Manager của dự án New HR Web Application (NHRS). Hệ thống này xây để mang chuyển đổi số cho vận hành HR của Ronald Company. Tính năng chính: (1) Đăng ký người dùng và quên mật khẩu; (2) Nhập CV từ hệ thống TopCV và LinkedIn; (3) Đăng tin tuyển dụng; (4) Ứng tuyển; (5) Lên lịch &amp; quản lý phỏng vấn. Bạn sẽ đi qua đầy đủ vòng đời phát triển, theo các quy trình và giai đoạn mô tả trong PMBOK.</p></div></div><div class=\"ml-vi\"><p><strong>PMG201c – Thi thực hành 1 (SU2023, FUDA [684]) — New HR Web Application (NHRS)</strong>. Đây là bài thi thực hành quản lý dự án dạng viết. Không có mã nguồn cần viết; mỗi câu trả lời được AI chấm theo tiêu chí ghi ở từng câu.</p><div class=\"pe-system\"><b>Context:</b><p>You serve as the Project Manager for the New HR Web Application (NHRS) project. This system is being built to bring Digital Transformation to the HR operations of Ronald Company. Its key features are: (1) User registration and password forgot; (2) Import CV from TopCV and LinkedIn system; (3) Job Posting; (4) Apply for job; (5) Interview scheduling &amp; management. You will go through the full development life cycle, following the processes and stages described in PMBOK.</p></div>|||<div class=\"pe-system\"><b>Bối cảnh:</b><p>Bạn là Project Manager của dự án New HR Web Application (NHRS). Hệ thống này xây để mang chuyển đổi số cho vận hành HR của Ronald Company. Tính năng chính: (1) Đăng ký người dùng và quên mật khẩu; (2) Nhập CV từ hệ thống TopCV và LinkedIn; (3) Đăng tin tuyển dụng; (4) Ứng tuyển; (5) Lên lịch &amp; quản lý phỏng vấn. Bạn sẽ đi qua đầy đủ vòng đời phát triển, theo các quy trình và giai đoạn mô tả trong PMBOK.</p></div></div>",
      "isPublished": true,
      "questions": [
        {
          "kind": "WRITE",
          "points": 2,
          "prompt": "<p><strong>Request 1 – Work Breakdown Structure:</strong> create a WBS for the project that covers both management and engineering work. Decompose the work/scope down to level 3 or 4, following the given template (1. Initiating / 2. Planning / 3. Execution, Monitoring &amp; Controlling / 4. Closing).</p>|||<p><strong>Yêu cầu 1 – Cấu trúc phân rã công việc (WBS):</strong> xây WBS bao quát cả công việc quản lý lẫn kỹ thuật. Phân rã tới cấp 3 hoặc 4, theo đúng khung đề cho (1. Khởi động / 2. Lập kế hoạch / 3. Thực thi, Giám sát &amp; Kiểm soát / 4. Kết thúc).</p>",
          "sampleSolution": "<p><strong>1. Initiating:</strong> 1.1 Develop project charter (NHRS goals, Ronald Company Director as sponsor); 1.2 Identify stakeholders (HR team, IT department, job candidates, the Director); 1.3 Define the high-level scope of the 5 key features.</p>\n     <p><strong>2. Planning:</strong> 2.1 Requirements specification for each feature (registration/password-reset, CV import, job posting, apply-for-job, interview scheduling); 2.2 System architecture &amp; tech-stack design; 2.3 Database design (users, CVs, job postings, applications, interview schedules); 2.4 UI/UX wireframes; 2.5 Test plan; 2.6 Risk &amp; resource plan.</p>\n     <p><strong>3. Execution, Monitoring &amp; Controlling:</strong> 3.1 Develop the user registration &amp; password-forgot module; 3.2 Develop the CV-import integration with TopCV/LinkedIn; 3.3 Develop the job-posting module; 3.4 Develop the apply-for-job module; 3.5 Develop the interview scheduling &amp; management module; 3.6 Conduct unit/integration testing; 3.7 Conduct UAT with the HR team; 3.8 Monitor schedule/budget progress against the plan.</p>\n     <p><strong>4. Closing:</strong> 4.1 Deploy to production; 4.2 Conduct user training for HR staff; 4.3 Write the project closure report &amp; lessons learned; 4.4 Hand over to the support team.</p>|||<p><strong>1. Khởi động:</strong> 1.1 Xây charter dự án (mục tiêu NHRS, Giám đốc Ronald Company là sponsor); 1.2 Xác định các bên liên quan (nhóm HR, phòng IT, ứng viên, Giám đốc); 1.3 Xác định phạm vi cấp cao của 5 tính năng chính.</p>\n     <p><strong>2. Lập kế hoạch:</strong> 2.1 Đặc tả yêu cầu từng tính năng (đăng ký/quên mật khẩu, nhập CV, đăng tin, ứng tuyển, lên lịch phỏng vấn); 2.2 Thiết kế kiến trúc hệ thống &amp; công nghệ; 2.3 Thiết kế database (người dùng, CV, tin tuyển dụng, đơn ứng tuyển, lịch phỏng vấn); 2.4 Wireframe UI/UX; 2.5 Kế hoạch kiểm thử; 2.6 Kế hoạch rủi ro &amp; nguồn lực.</p>\n     <p><strong>3. Thực thi, Giám sát &amp; Kiểm soát:</strong> 3.1 Phát triển mô-đun đăng ký &amp; quên mật khẩu; 3.2 Phát triển tích hợp nhập CV với TopCV/LinkedIn; 3.3 Phát triển mô-đun đăng tin tuyển dụng; 3.4 Phát triển mô-đun ứng tuyển; 3.5 Phát triển mô-đun lên lịch &amp; quản lý phỏng vấn; 3.6 Kiểm thử đơn vị/tích hợp; 3.7 Thực hiện UAT với nhóm HR; 3.8 Giám sát tiến độ/ngân sách so kế hoạch.</p>\n     <p><strong>4. Kết thúc:</strong> 4.1 Triển khai production; 4.2 Đào tạo nhân sự HR; 4.3 Viết báo cáo kết thúc dự án &amp; bài học kinh nghiệm; 4.4 Bàn giao cho nhóm hỗ trợ.</p>",
          "rubric": [
            {
              "id": "four_phases",
              "criterion": "Covers all 4 top-level phases exactly as templated (Initiating/Planning/Execution-Monitoring&Controlling/Closing).|||Bao quát đủ 4 giai đoạn cấp cao đúng khung đề (Khởi động/Lập kế hoạch/Thực thi-Giám sát&Kiểm soát/Kết thúc).",
              "weight": 1,
              "maxScore": 0.5
            },
            {
              "id": "both_mgmt_and_eng",
              "criterion": "Includes BOTH management work (charter, stakeholders, risk/resource plan) AND engineering work (each of the 5 NHRS features individually), as explicitly required.|||Có cả công việc quản lý (charter, bên liên quan, kế hoạch rủi ro/nguồn lực) LẪN công việc kỹ thuật (từng tính năng NHRS riêng lẻ), đúng yêu cầu rõ ràng của đề.",
              "weight": 1,
              "maxScore": 1.1
            },
            {
              "id": "sufficient_depth",
              "criterion": "Breaks work down to level 3/4 with enough specific detail.|||Phân rã tới cấp 3/4 đủ chi tiết cụ thể.",
              "weight": 1,
              "maxScore": 0.4
            }
          ]
