...
export default {
  ...
  techStack: [
    'Java 21', 'Spring Boot 3.4', 'Spring Data JPA', 'Spring Security', 'PostgreSQL 16',
    'Flyway', 'Postgres Full-Text Search', 'React 18', 'Vite', 'TailwindCSS', 'JWT', 'BCrypt',
    'JUnit 5', 'Mockito', 'MockMvc', 'JaCoCo', 'Docker Compose',
  ],
  ...
  projectUrl: null,
  githubUrl: 'https://github.com/cuonghoang1103/Library-Management-System',
  startDate: null,
  endDate: null,
  isFeatured: false,
  isPublished: true,
