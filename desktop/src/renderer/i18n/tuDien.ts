...
export const TU_DIEN: Record<string, string> = {
  ...
  'Sau tool': 'After tool',
  // ── Lịch hôm nay + quét/nhập nhanh thời khoá biểu ──
  'Lịch hôm nay': "Today's schedule",
  'Cả tuần': 'Whole week',
  'còn {n} buổi': '{n} left',
  'đã học xong hôm nay': 'all done for today',
  'đang học': 'in class',
  'đã xong': 'done',
  'còn {n} phút': '{n} min left',
  'còn {n} giờ': '{n} h left',
  'còn {g} giờ {p} phút': '{g} h {p} min left',
  'Quét ảnh': 'Scan image',
  'Thêm dòng': 'Add row',
  ...
  'Odin đang suy nghĩ…': 'Odin is thinking…',
  'mã': 'code',
  ...
  'Lịch sử': 'History',
  'Mới': 'New',
  'Chờ tớ suy nghĩ xíu nhé…': 'Give me a sec to think…',
  'Đang nghĩ…': 'Thinking…',
  'Đầy đủ': 'Full page',
  'Chưa có cuộc nào.': 'No conversations yet.',
  ...
  'Bỏ ảnh': 'Remove image',
  'Đang đọc — bấm để dừng': 'Speaking — tap to stop',
  'Dừng đọc': 'Stop speaking',
  'Giữ để nói': 'Hold to talk',
  'Bậc này cần gói Pro — đã trả lời bằng {t}.': 'That tier needs Pro — answered with {t}.',
  'Đã trả lời bằng {t}.': 'Answered with {t}.',
  'Tối đa {n} ảnh một lượt.': 'At most {n} images per message.',
  // ── Menu tuỳ chọn tin nhắn ──
  'Tuỳ chọn tin nhắn': 'Message options',
  'Bạn': 'You',
  'Chép chữ': 'Copy text',
  'Chép ảnh': 'Copy image',
  'Lưu ảnh về máy': 'Save image',
  'Chọn nhiều tin': 'Select messages',
  'Đã chép': 'Copied',
  'Đã chép ảnh': 'Image copied',
  'Đã chọn {n} tin': '{n} selected',
  'Bỏ trả lời': 'Cancel reply',
  'Xoá tin nhắn này? Chỉ mình bạn không thấy nó nữa.':
    'Delete this message? Only you will stop seeing it.',
  '[ảnh]': '[image]',
  '{n} dòng còn thiếu, sửa xong mới lưu được': "{n} rows are incomplete — fix them before saving",
  '{n} dòng không đọc được giờ': "{n} lines whose time couldn't be read",
  'tự thêm bằng tay giúp tôi:': 'please add them by hand:',
  'Đang đọc ảnh…': 'Reading image…',
  'Nhập nhanh': 'Quick entry',
  'Dán từ FAP': 'Paste from FAP',
  '{n} buổi': '{n} sessions',
  'Mỗi dòng một buổi:': 'One session per line:',
  'thứ | slot | mã môn | phòng': 'weekday | slot | course code | room',
  'ví dụ': 'e.g.',
  'Thứ 2–8 (8 là Chủ nhật), slot 1–5. Phòng có thể bỏ trống.':
    'Weekday 2–8 (8 is Sunday), slot 1–5. Room may be left out.',
  'CN': 'Sun',
  'Còn {n} dòng chưa đúng': '{n} lines still wrong',
  'Thêm {n} buổi vào bảng': 'Add {n} sessions to the table',
  'Đọc ảnh chưa chắc mấy chỗ này': 'The scan was unsure about these',
  'xem lại giúp tôi:': 'please check them:',
  // Câu lỗi từng dòng của ô nhập nhanh (`docNhapNhanh` trả về nguyên văn).
  'cần ít nhất: thứ | slot | môn': 'need at least: weekday | slot | course',
  'thứ phải từ 2 đến 8': 'weekday must be 2 to 8',
  'slot phải là 1–5': 'slot must be 1–5',
  'thiếu tên môn': 'missing course name',
  ...
  'Terminal: MỞ': 'Terminal: OPEN',
  'Những bài học agent đã tự ghi lại — để lần sau không lặp lại lỗi cũ': 'Lessons the agent saved itself — so it does not repeat old mistakes',
  'Bộ nhớ': 'Memory',
  'Bộ nhớ của agent': "Agent's memory",
  'Agent tự ghi bài học khi sửa được lỗi khó hoặc khi bạn sửa lưng nó. Mỗi lượt nó chỉ đọc mục lục (rẻ); bài loại Lỗi được app tự chèn khi đúng lỗi đó xuất hiện lại. Lưu trên máy này.': 'The agent saves a lesson when it fixes a hard error or when you correct it. Each turn it only reads the index (cheap); Error lessons are inserted automatically when the same error appears again. Stored on this machine.',
  'Chưa có bài học nào. Agent sẽ tự ghi khi gặp và sửa được một lỗi khó.': 'No lessons yet. The agent will save one when it hits and fixes a hard error.',
  'Lỗi': 'Error',
  'Quy ước': 'Convention',
  'Môi trường': 'Environment',
  'Sở thích': 'Preference',
  'mọi dự án': 'all projects',
  'dự án này': 'this project',
  'Dấu hiệu:': 'Signature:',
  'Vì sao:': 'Why:',
  'Áp dụng:': 'Apply:',
  'Xoá bài học này': 'Delete this lesson',
  'Terminal thật trong thư mục dự án — gõ lệnh, ssh, mật khẩu… (agent cũng dùng chung)': 'Real terminal in the project folder — commands, ssh, passwords… (shared with the agent)',
  'Kéo để đổi chiều cao terminal': 'Drag to resize the terminal',
  'đang chờ mật khẩu': 'waiting for a password',
  'Đóng terminal': 'Close terminal',
  'Mở terminal mới': 'Open a new terminal',
  'Ẩn terminal (các phiên vẫn chạy)': 'Hide terminal (sessions keep running)',
  'Terminal đang hỏi mật khẩu — gõ vào đây rồi nhấn Enter. Agent KHÔNG nhìn thấy mật khẩu bạn gõ.': 'The terminal is asking for a password — type it here and press Enter. The agent never sees what you type.',
  'Máy này chưa nạp được terminal đầy đủ (PTY) — đang chạy chế độ đơn giản: gõ lệnh được, nhưng ssh/sudo hỏi mật khẩu sẽ không hiện.': 'A full terminal (PTY) could not be loaded on this machine — running in simple mode: commands work, but ssh/sudo password prompts will not appear.',
  'Chưa có terminal nào. Bấm + để mở.': 'No terminal yet. Press + to open one.',
  ...
  // ── Bảng kế hoạch chi tiết (18/09/2026) ─────────────────
  'Bảng kế hoạch': 'Plan board',
  'Mốc khởi điểm là {n}.': 'Everyone starts at {n}.',
  'Chưa có thay đổi uy tín nào.': 'No reputation changes yet.',
  'Tháng trước': 'Previous month',
  'Tháng sau': 'Next month',
  'Tháng {t}/{n}': '{t}/{n}',
  '{xong}/{tong} xong · còn {con}': '{xong}/{tong} done · {con} left',
  'Chưa có việc nào': 'No tasks yet',
  'đã xếp {t}': '{t} scheduled',
  'Ngày này đã xếp {t} — nhiều hơn một ngày làm việc. Kế hoạch xa thực tế là nguyên nhân trượt phổ biến nhất.':
    'This day has {t} scheduled — more than a full working day. Over-planning is the most common cause of missed tasks.',
  '{n} cặp việc trùng giờ nhau: {ds}': '{n} overlapping pairs: {ds}',
  'Việc cần làm ngày này…': 'Task for this day…',
  'Giờ bắt đầu': 'Start time',
  'Thời lượng (phút)': 'Duration (minutes)',
  'Mức khó': 'Difficulty',
  'Mức quan trọng': 'Importance',
  'Ghi chú chi tiết (không bắt buộc)': 'Detailed note (optional)',
  'Trượt việc này sẽ trừ {n} uy tín.': 'Missing this costs {n} reputation.',
  'Chọn mức khó và mức quan trọng để thêm việc.': 'Pick a difficulty and an importance level to add the task.',
  'Thêm việc': 'Add task',
  'Ngày này chưa có việc nào. Thêm việc đầu tiên ở trên.': 'Nothing planned for this day. Add the first task above.',
  'Bỏ đánh dấu xong': 'Mark as not done',
  'Đánh dấu đã xong': 'Mark as done',
  'Trượt −{n}': 'Missed −{n}',
  'Trượt sẽ −{n}': 'Missing costs −{n}',
  'đã dời {n} lần': 'deferred {n}×',
  'Dời sang ngày mai (không bị trừ điểm)': 'Move to tomorrow (no reputation penalty)',
  'Dời sang ngày mai': 'Move to tomorrow',
  /* ⚠️ Những mục dưới đây được gọi qua BẢNG TRA (`dich(TEN_KHO[v.doKho])`),
     nên bộ dò chuỗi KHÔNG nhìn thấy chúng và phép kiểm "thiếu bản dịch"
     KHÔNG bắt được nếu quên. Thêm hay xoá một mức thì phải sửa TAY ở đây. */
  'T2': 'Mon',
  'Dễ': 'Easy',
  'Khó': 'Hard',
  'Chưa chọn': 'Not set',
  ...
  'phút': 'min',
  'Nhờ AI xem lại ngày này': 'Ask AI to review this day',
  'Đang xem…': 'Reviewing…',
