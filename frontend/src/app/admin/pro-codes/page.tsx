    ...
    <div className="p-4 md:p-6 text-white">
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 mb-6">
        ...
        <div className="flex items-center gap-3 mt-3">
          ...
          <button onClick={create} disabled={creating} className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--a-accent)] text-white text-sm disabled:opacity-50">
