...
export const metadata: Metadata = {
  ...
  description:
    'Hoạt hình hoá vòng đời request REST, tầng đệm CDN/Redis, xác thực JWT, truy vấn CSDL, WebSocket, hàng đợi tin nhắn, Git và hạ tầng VPS/Docker. Có phụ đề bài giảng, tua theo bước và quay video ngay trong trình duyệt.',
  alternates: { canonical: `${SITE_URL}/simulation` },
  openGraph: {
    title: 'Xưởng mô phỏng Code & Mạng',
    description:
      'Hàng chục kịch bản hệ thống chạy thành hoạt hình 1920×1080 — nền tảng web, Node.js, Git và VPS/Docker — tua theo bước và quay thành video bài giảng.',
