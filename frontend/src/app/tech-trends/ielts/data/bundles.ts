...
export const STAGES: StageBundle[] = [STAGE1, STAGE2];

/** Số gộp cả hai chặng — dùng cho phần đầu trang. */
export const TOTAL_STATS = {
  lessons: STAGE1.stats.lessons + STAGE2.stats.lessons,
  words: STAGE1.stats.words + STAGE2.stats.words,
  readings: STAGE1.stats.readings + STAGE2.stats.readings,
  listenings: STAGE1.stats.listenings + STAGE2.stats.listenings,
  writings: STAGE1.stats.writings + STAGE2.stats.writings,
