...
function VerifyOtpContent() {
  ...
  // Start with 5-minute (300s) cooldown for first send
  useEffect(() => {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      // Backend returns ttl (seconds). Use that or default 300s
      ...
      >
        {status === 'otp-form' && (
          <>
            ...
            <p className="text-neon-violet font-medium mb-6 break-all">{email}</p>
