...
export default function ServicesSection() {
  ...
  const services = [
    ...
    // The e-commerce service tab is hidden while commerce is disabled
    // (lib/featureFlags.ts) — it markets "payment & inventory" work.
  ].filter((s) => COMMERCE_ENABLED || s.id !== 'ecommerce');
