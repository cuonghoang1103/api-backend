...
export class Title
{
    ...
    update()
    {
        ...
        if(delta > this.interval && offsetRounded !== this.offsetRounded)
        {
            ...
            // Hoạt hình tiêu đề tab (xe chạy qua hàng cây). Tên ở đây GHI ĐÈ thẻ
            // <title> trong index.html sau khi game khởi động — sửa mỗi index.html
            // là không đủ, tab vẫn hiện tên cũ.
            document.title = 'CuongThai' + title.join('')
        }
    }
}
