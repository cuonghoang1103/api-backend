    ...
    setImages()
    {
        ...
        this.images.getResourceAndLoad = (key) =>
        {
            ...
            if(!resource)
            {
                ...
                // Ảnh module của cuongthai là .png (xem data/) => TextureLoader.
                // Bản gốc gán cứng 'textureKtx' vì danh sách images của họ ghi đuôi
                // .ktx; đây là NGOẠI LỆ, không theo công tắc VITE_COMPRESSED (Game.js:97).
