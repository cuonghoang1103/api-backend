...
const COURSE = 'IOT102';
const R2_PREFIX = 'IOT102';
const BASE = `${process.env.HOME}/Downloads/Đề thi các môn học ở trường/Kì 4/${COURSE}/FE`;
const SCRATCH = '/private/tmp/claude-501/-Users-admin-Downloads-api-backend/38f20845-0710-41f5-b2d4-2c1cef65b0ae/scratchpad/iot102-img';
const folders = JSON.parse(fs.readFileSync('content/exams/_work/iot102-fe-folders.json', 'utf8'));
...
for (const [n, info] of Object.entries(folders)) {
  ...
  const outJson = `content/exams/_work/iot102-fe${n}-image-urls.json`;
  try {
